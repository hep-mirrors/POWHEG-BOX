...
c
      ...
      data Gf_inp    / 1.1663899987193259d-05        /   ! G_F
      data aemmz_inp / 0.0075467722530541421d0 /   ! alpha_EM(m_Z)=1/128.89
      data xw_inp    / 0.2222465330928908d0            /   ! sin^2(theta_W)
...
c---    for Mw=80.398 GeV
      data wwidth,zwidth/2.04759951d0,2.44140351d0/
...
************************************************************************
      ...
      data  Vud  ,  Vus  ,  Vub  ,
     .      Vcd  ,  Vcs  ,  Vcb
     .   /0.974d0,0.227d0,0.000d0,
     .    0.227d0,0.974d0,0.000d0/
      end
************************************************************************
