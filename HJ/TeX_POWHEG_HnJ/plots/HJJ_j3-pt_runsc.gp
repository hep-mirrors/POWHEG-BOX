...
#set label '${\mathrm d}\sigma/{\mathrm d}p_{\scriptscriptstyle T}^{\scriptscriptstyle j_3}$ [pb/GeV]' at screen 0.12 , 0.45 rotate
#set ytics("$0$" 0,"$0.2$" 0.2,"$0.4$" 0.4)
set label '$p_{\scriptscriptstyle T}^{\scriptscriptstyle j_1} > 20$ GeV' at 30,0.00001  
set label '$p_{\scriptscriptstyle T}^{\scriptscriptstyle j_2} > 20$ GeV' at 30,0.0000015  
...
set key at 160, 0.18 spacing 1.4
