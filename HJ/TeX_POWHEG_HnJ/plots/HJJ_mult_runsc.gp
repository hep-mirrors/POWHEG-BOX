...
set label '$p_{\scriptscriptstyle T}^{\scriptscriptstyle j}\hskip -0.15cm >\hskip -0.15cm 50$ GeV' at 1.58,0.004 
...
set label '$p_{\scriptscriptstyle T}^{\scriptscriptstyle j}\hskip -0.15cm >\hskip -0.15cm 100$ GeV' at 1.56,0.008
