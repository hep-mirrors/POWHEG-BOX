...
#set label '${\mathrm d}\sigma/{\mathrm d}p_{\scriptscriptstyle T}^{\scriptscriptstyle {\rm rel},j_2}$ [pb/GeV]' at screen 0.12 , 0.45 rotate
...
set xtics
#set xtics("" 0,"1" 1,"2" 2)
set xlabel '$p_{\scriptscriptstyle T}^{\scriptscriptstyle {\rm rel},j_2}$ [GeV]'
