...
set key at 1.2, 0.03 spacing 1.4

set datafile fortran
#set style data lines
set style data xyerrorbars

set label '${\mathrm d}\sigma/{\mathrm d}y_{\scriptscriptstyle H}$ [pb]' at screen 0.13 , 0.5 rotate 
#set ytics("$0$" 0,"$0.2$" 0.2,"$0.4$" 0.4)
#set label '$p_{\scriptscriptstyle T}^{\scriptscriptstyle j} > 20$ GeV' at 0.7,0.15  
