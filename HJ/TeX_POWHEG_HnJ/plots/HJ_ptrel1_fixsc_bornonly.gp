...
epsfile = "HJ_ptrel1_fixsc_bornonly.eps"
...
set label '${\mathrm d}\sigma/{\mathrm d}p_{\scriptscriptstyle T}^{\scriptscriptstyle {\rm rel},j_1}$ [pb/GeV]' at screen 0.14 , 0.55 rotate
#set ytics("$0$" 0,"$0.2$" 0.2,"$0.4$" 0.4)
set label '$p_{\scriptscriptstyle T}^{\scriptscriptstyle j_1} > 20$ GeV' at 5,10  
...
set label 'ratio to NLO' at screen 0.14 , 0.19 rotate
