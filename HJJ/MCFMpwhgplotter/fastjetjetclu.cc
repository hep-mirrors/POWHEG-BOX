//STARTHEADER
// $Id: fastjetjetclu.cc 939 2007-11-08 12:18:08Z salam $
//
...
// f77 interface to JETCLU (via fastjet)
//
// Corresponds to the following Fortran subroutine
// interface structure:
//
//   SUBROUTINE FASTJETJETCLU(P,NPART,R,F,F77JETS,NJETS)
...
//
void fastjetjetclu_(const double * p, const int & npart,                   
    ...
    //JETCLU
    fj::CDFJetCluPlugin * plugin = new fj::CDFJetCluPlugin(R,f);
    fj::JetDefinition jet_def(plugin);
