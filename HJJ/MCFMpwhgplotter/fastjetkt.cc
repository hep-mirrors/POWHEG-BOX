//STARTHEADER
// $Id: fastjetkt.cc 939 2007-11-08 12:18:08Z salam $
//
...
// f77 interface to kt (via fastjet)
//
// Corresponds to the following Fortran subroutine
// interface structure:
//
//   SUBROUTINE FASTJETKT(P,NPART,R,F,F77JETS,NJETS)
...
//
void fastjetkt_(const double * p, const int & npart,                   
