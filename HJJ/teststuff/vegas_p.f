      ...
      integer maxdim
      parameter (maxdim=20,mmmdim=50*maxdim)
...
c
      ...
      real * 8 d(50,maxdim),di(50,maxdim),xin(50),r(50),
     1     dx(maxdim),dt(maxdim),x(maxdim)
      integer kg(maxdim),ia(maxdim)
      real * 8 rand(maxdim)
