module     p0_dbaru_hepneg_d37h0l1d
   ...
   ! dbaru_hepneg/helicity0/d37h0l1d.f90
...
!---#[ function derivative:
   function derivative(mu2, i1) result(numerator)
      ...
      if(deg.eq.0) then
         numerator = (abb37n9+abb37n10*(spvak5k6(1)*qshift(1)-spvak5k6(2)*qshift&
         &(2)-spvak5k6(3)*qshift(3)-spvak5k6(4)*qshift(4))+abb37n11*(spvak5k4(1)&
         &*qshift(1)-spvak5k4(2)*qshift(2)-spvak5k4(3)*qshift(3)-spvak5k4(4)*qsh&
         &ift(4))+abb37n12*(spvak5k2(1)*qshift(1)-spvak5k2(2)*qshift(2)-spvak5k2&
         &(3)*qshift(3)-spvak5k2(4)*qshift(4))+abb37n13*dotproduct(k1, qshift)+a&
         &bb37n14*dotproduct(k6, qshift)+abb37n15*(spvak1k6(1)*qshift(1)-spvak1k&
         &6(2)*qshift(2)-spvak1k6(3)*qshift(3)-spvak1k6(4)*qshift(4)))
         return
      end if
      if(deg.eq.1) then
         numerator = (k1(iv1)*abb37n13+k6(iv1)*abb37n14+spvak1k6(iv1)*abb37n15+s&
         &pvak5k2(iv1)*abb37n12+spvak5k4(iv1)*abb37n11+spvak5k6(iv1)*abb37n10)
         return
      end if
