module     p0_dbaru_hepneg_d59h0l1
   ...
   ! m/Virtual/p0_dbaru_hepneg/helicity0/d59h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      t7 = (Q(1)*spvak6k2(1)-Q(2)*spvak6k2(2)-Q(3)*spvak6k2(3)-Q(4)*spvak6k2(4))
      t8 = (Q(1)*spvak5k2(1)-Q(2)*spvak5k2(2)-Q(3)*spvak5k2(3)-Q(4)*spvak5k2(4))
      t9 = (Q(1)*spvae6k2(1)-Q(2)*spvae6k2(2)-Q(3)*spvae6k2(3)-Q(4)*spvae6k2(4))
      t10 = (Q(1)*spvak1e6(1)-Q(2)*spvak1e6(2)-Q(3)*spvak1e6(3)-Q(4)*spvak1e6(4)&
      &)
      brack = (abb59n1+t1*abb59n11+t2*abb59n18+t3*abb59n2+t4*abb59n3+t5*abb59n4+&
      &t6*abb59n5+t7*abb59n6+t8*abb59n8+t1*t10*abb59n21+t1*t3*abb59n10+t1*t8*abb&
      &59n27+t1*t9*abb59n14+t10*t2*abb59n20+t10*t4*abb59n22+t10*t5*abb59n23+t2*t&
      &3*abb59n9+t2*t5*abb59n25+t2*t8*abb59n26+t2*t9*abb59n15+t3*t6*abb59n7+t3*t&
      &7*abb59n12+t3*t8*abb59n16+t3*abb59n19*(Q(1)*spvak1k6(1)-Q(2)*spvak1k6(2)-&
      &Q(3)*spvak1k6(3)-Q(4)*spvak1k6(4))+t4*t8*abb59n28+t4*t9*abb59n13+t5*t6*ab&
      &b59n24+t5*t7*abb59n29+t5*t9*abb59n17+t3*t5*t6*abb59n30)
