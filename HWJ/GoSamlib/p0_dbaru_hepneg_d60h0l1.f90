module     p0_dbaru_hepneg_d60h0l1
   ...
   ! dbaru_hepneg/helicity0/d60h0l1.f90
...
!           & sign => diagram60_sign, shift => diagram60_shift
      ...
      t4 = (Q(1)*spvak5k2(1)-Q(2)*spvak5k2(2)-Q(3)*spvak5k2(3)-Q(4)*spvak5k2(4))
      t5 = (Q(1)*spvak1k4(1)-Q(2)*spvak1k4(2)-Q(3)*spvak1k4(3)-Q(4)*spvak1k4(4))
      ...
      t9 = (Q(1)*spvak6k2(1)-Q(2)*spvak6k2(2)-Q(3)*spvak6k2(3)-Q(4)*spvak6k2(4))
      t10 = (Q(1)*spvak1k2(1)-Q(2)*spvak1k2(2)-Q(3)*spvak1k2(3)-Q(4)*spvak1k2(4)&
      &)
      d60 = (abb60n1+t1*abb60n10+t2*abb60n11+t3*abb60n7+t3*t3*abb60n19+t4*abb60n&
      &2+t5*abb60n3+t6*abb60n4+t7*abb60n5+t8*abb60n6+t9*abb60n9+t1*t3*abb60n22+t&
      &1*t4*abb60n14+t1*t5*abb60n24+t10*t2*abb60n17+t2*t3*abb60n18+t2*t4*abb60n2&
      &3+t2*t5*abb60n27+t2*t8*abb60n18+t2*t9*abb60n20+t3*t4*abb60n16+t3*t5*abb60&
      &n26+t3*t6*abb60n21+t3*t7*abb60n13+t4*t6*abb60n15+t5*t6*abb60n25+t6*t7*abb&
      &60n12+t7*abb60n8*(Q(1)*spvak1k6(1)-Q(2)*spvak1k6(2)-Q(3)*spvak1k6(3)-Q(4)&
      &*spvak1k6(4))+t10*t2*t7*abb60n28)
