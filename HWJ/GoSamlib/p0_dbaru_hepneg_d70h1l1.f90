...
!           & sign => diagram70_sign, shift => diagram70_shift
      ...
      &)*k2(2)-Q(3)*k2(3)-Q(4)*k2(4))+abb70n4*(Q(1)*spvak6l3(1)-Q(2)*spvak6l3(2)&
      &-Q(3)*spvak6l3(3)-Q(4)*spvak6l3(4))+abb70n5*(Q(1)*k6(1)-Q(2)*k6(2)-Q(3)*k&
      &6(3)-Q(4)*k6(4))+abb70n6*(Q(1)*Q(1)-Q(2)*Q(2)-Q(3)*Q(3)-Q(4)*Q(4))+abb70n&
      &8*(Q(1)*spvak6k4(1)-Q(2)*spvak6k4(2)-Q(3)*spvak6k4(3)-Q(4)*spvak6k4(4))+a&
      &bb70n9*(Q(1)*spval3k2(1)-Q(2)*spval3k2(2)-Q(3)*spval3k2(3)-Q(4)*spval3k2(&
      &4))+t1*t2*abb70n12+t1*t3*abb70n3+t1*abb70n13*(Q(1)*spvak1k4(1)-Q(2)*spvak&
      &1k4(2)-Q(3)*spvak1k4(3)-Q(4)*spvak1k4(4)))
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p0_dbaru_hepneg_d70h1l1
