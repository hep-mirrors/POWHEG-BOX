module     p0_dbaru_hepneg_d92h0l1d
   ...
   ! m/Virtual/p0_dbaru_hepneg/helicity0/d92h0l1d.f90
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      complex(ki), intent(in) :: mu2
      complex(ki) :: brack
      brack = (e6(iv1)*abb92n22+k2(iv1)*abb92n21+k6(iv1)*abb92n15+spvae6k2(iv1)*&
      &abb92n20+spvak2k6(iv1)*abb92n18+spvak6k2(iv1)*abb92n19)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      t1 = e6(iv1)
      t2 = e6(iv2)
      brack = ((2.0_ki)*d(iv1,iv2)*abb92n16+k2(iv1)*t2*abb92n17+k2(iv2)*t1*abb92&
      &n17+spvak6k2(iv1)*t2*abb92n14+spvak6k2(iv2)*t1*abb92n14)
