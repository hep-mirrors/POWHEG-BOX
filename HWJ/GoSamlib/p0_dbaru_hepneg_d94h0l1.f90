module     p0_dbaru_hepneg_d94h0l1
   ...
   ! dbaru_hepneg/helicity0/d94h0l1.f90
...
!           & sign => diagram94_sign, shift => diagram94_shift
      ...
      d94 = (abb94n2+t1*abb94n3+t2*abb94n4+t3*abb94n5+t4*abb94n6+t5*abb94n8+t6*a&
      &bb94n9+abb94n7*(Q(1)*Q(1)-Q(2)*Q(2)-Q(3)*Q(3)-Q(4)*Q(4))+t1*t4*abb94n12+t&
      &2*t4*abb94n13+t3*t4*abb94n11+t4*t5*abb94n10+t4*t6*abb94n14)
