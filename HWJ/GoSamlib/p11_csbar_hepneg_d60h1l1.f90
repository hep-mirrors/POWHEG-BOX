...
!           & sign => diagram60_sign, shift => diagram60_shift
      ...
      d60 = (abb60n1+t1*abb60n4+t1*t1*abb60n13+t2*abb60n2+t3*abb60n3+t4*abb60n5+&
      &t5*abb60n6+t6*abb60n7+t1*t2*abb60n10+t1*t3*abb60n11+t1*t4*abb60n16+t1*t5*&
      &abb60n17+t1*t6*abb60n9+t2*t4*abb60n14+t2*t5*abb60n19+t3*t4*abb60n15+t3*t5&
      &*abb60n18+t3*t6*abb60n8+t4*t6*abb60n20+t5*t6*abb60n21+t6*t7*abb60n15+t6*a&
      &bb60n12*(Q(1)*spvak2k6(1)-Q(2)*spvak2k6(2)-Q(3)*spvak2k6(3)-Q(4)*spvak2k6&
      &(4))+t6*t7*abb60n22*(Q(1)*spvak5k4(1)-Q(2)*spvak5k4(2)-Q(3)*spvak5k4(3)-Q&
      &(4)*spvak5k4(4)))
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p11_csbar_hepneg_d60h1l1
