module     p11_csbar_hepneg_d70h1l1d
   ! file:      /home/oleari/fortran/POWHEG-BOX/HWJ_CKM/GoSam_POWHEG/Virtual/p11
   ! _csbar_hepneg/helicity1/d70h1l1d.f90
...
!---#[ function derivative:
   function derivative(mu2, i1, i2, i3) result(numerator)
      ...
      t1 = spvak6k2(iv1)
      if(deg.eq.1) then
         numerator = (k2(iv1)*abb70n24+k6(iv1)*abb70n23+spvak5k2(iv1)*abb70n25+s&
         &pvak6k1(iv1)*abb70n28+spvak6k4(iv1)*abb70n21+spvak6l3(iv1)*abb70n22+sp&
         &val3k2(iv1)*abb70n26+t1*abb70n27)
         return
      end if
      t2 = spvak6k2(iv2)
      if(deg.eq.2) then
         numerator = ((2.0_ki)*d(iv1,iv2)*abb70n19+spvak2k1(iv1)*t2*abb70n18+spv&
         &ak2k1(iv2)*t1*abb70n18+spvak2k4(iv1)*t2*abb70n20+spvak2k4(iv2)*t1*abb7&
         &0n20+spvak5k1(iv1)*t2*abb70n17+spvak5k1(iv2)*t1*abb70n17)
         return
      end if
      if(deg.eq.3) then
         numerator = (0.0_ki)
...
!---#] subroutine reconstruct_d70:
end module p11_csbar_hepneg_d70h1l1d
