module     p12_cbbar_hepneg_d94h0l1
   ...
   ! m/Virtual/p12_cbbar_hepneg/helicity0/d94h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (abb94n3+t1*abb94n2+t2*abb94n4+t3*abb94n6+abb94n10*(Q(1)*Q(1)-Q(2)&
      &*Q(2)-Q(3)*Q(3)-Q(4)*Q(4))+abb94n5*(Q(1)*spvae6k1(1)-Q(2)*spvae6k1(2)-Q(3&
      &)*spvae6k1(3)-Q(4)*spvae6k1(4))+abb94n7*(Q(1)*spvak1k6(1)-Q(2)*spvak1k6(2&
      &)-Q(3)*spvak1k6(3)-Q(4)*spvak1k6(4))+abb94n9*(Q(1)*k6(1)-Q(2)*k6(2)-Q(3)*&
      &k6(3)-Q(4)*k6(4))+t1*t2*abb94n8+t1*t3*abb94n11)
