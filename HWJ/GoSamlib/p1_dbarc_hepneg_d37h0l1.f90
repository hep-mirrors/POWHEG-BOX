module     p1_dbarc_hepneg_d37h0l1
   ...
   ! dbarc_hepneg/helicity0/d37h0l1.f90
...
!           & sign => diagram37_sign, shift => diagram37_shift
      ...
      &, ki)
      d37 = 0.0_ki
      d37 = (abb37n1+abb37n2*(Q(1)*spvak5k6(1)-Q(2)*spvak5k6(2)-Q(3)*spvak5k6(3)&
      &-Q(4)*spvak5k6(4))+abb37n3*(Q(1)*spvak5k4(1)-Q(2)*spvak5k4(2)-Q(3)*spvak5&
      &k4(3)-Q(4)*spvak5k4(4))+abb37n4*(Q(1)*spvak5k2(1)-Q(2)*spvak5k2(2)-Q(3)*s&
      &pvak5k2(3)-Q(4)*spvak5k2(4))+abb37n5*(Q(1)*k1(1)-Q(2)*k1(2)-Q(3)*k1(3)-Q(&
      &4)*k1(4))+abb37n6*(Q(1)*k6(1)-Q(2)*k6(2)-Q(3)*k6(3)-Q(4)*k6(4))+abb37n7*(&
      &Q(1)*spvak1k6(1)-Q(2)*spvak1k6(2)-Q(3)*spvak1k6(3)-Q(4)*spvak1k6(4)))
