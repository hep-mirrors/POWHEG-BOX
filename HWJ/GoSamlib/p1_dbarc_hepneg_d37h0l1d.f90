module     p1_dbarc_hepneg_d37h0l1d
   ...
   ! m/Virtual/p1_dbarc_hepneg/helicity0/d37h0l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      complex(ki) :: brack
      brack = (abb37n9+abb37n10*(spvak6k1(1)*qshift(1)-spvak6k1(2)*qshift(2)-spv&
      &ak6k1(3)*qshift(3)-spvak6k1(4)*qshift(4))+abb37n11*(spvak5k4(1)*qshift(1)&
      &-spvak5k4(2)*qshift(2)-spvak5k4(3)*qshift(3)-spvak5k4(4)*qshift(4))+abb37&
      &n12*(spvak5k2(1)*qshift(1)-spvak5k2(2)*qshift(2)-spvak5k2(3)*qshift(3)-sp&
      &vak5k2(4)*qshift(4))+abb37n13*(spvak1k6(1)*qshift(1)-spvak1k6(2)*qshift(2&
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      complex(ki), intent(in) :: mu2
      complex(ki) :: brack
      brack = (k1(iv1)*abb37n15+k6(iv1)*abb37n14+spvak1k6(iv1)*abb37n13+spvak5k2&
      &(iv1)*abb37n12+spvak5k4(iv1)*abb37n11+spvak6k1(iv1)*abb37n10)
