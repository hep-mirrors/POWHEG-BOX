module     p1_dbarc_hepneg_d59h1l1
   ...
   ! dbarc_hepneg/helicity1/d59h1l1.f90
...
!           & sign => diagram59_sign, shift => diagram59_shift
      ...
      d59 = (abb59n1+t1*abb59n5+t1*t1*abb59n10+t2*abb59n11+t3*abb59n2+t4*abb59n3&
      &+t5*abb59n7+t1*t2*abb59n8+t1*t3*abb59n6+t1*t4*abb59n9+t1*t5*abb59n15+t1*t&
      &6*abb59n9+t1*abb59n17*(Q(1)*spvak1k6(1)-Q(2)*spvak1k6(2)-Q(3)*spvak1k6(3)&
      &-Q(4)*spvak1k6(4))+t2*t3*abb59n16+t2*t5*abb59n14+t3*t4*abb59n18+t3*t6*abb&
      &59n19+t3*t7*abb59n4+t4*t5*abb59n13+t5*t6*abb59n12+t1*t3*t7*abb59n20)
