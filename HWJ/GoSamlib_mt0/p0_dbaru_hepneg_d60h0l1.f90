module     p0_dbaru_hepneg_d60h0l1
   ...
   ! m/Virtual/p0_dbaru_hepneg/helicity0/d60h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      t6 = (Q(1)*spvae6k2(1)-Q(2)*spvae6k2(2)-Q(3)*spvae6k2(3)-Q(4)*spvae6k2(4))
      ...
      &)
      t11 = (Q(1)*spvak1k2(1)-Q(2)*spvak1k2(2)-Q(3)*spvak1k2(3)-Q(4)*spvak1k2(4)&
      &)
      t12 = t3*abb60n8
      brack = (abb60n1+t1*t12+t1*abb60n10+t12*t7+t2*abb60n17+t3*abb60n2+t4*abb60&
      &n3+t5*abb60n4+t6*abb60n6+t7*abb60n7+t8*abb60n9+t10*t2*abb60n26+t10*t3*abb&
      &60n18+t10*t4*abb60n27+t10*t7*abb60n25+t11*t3*abb60n5+t2*t5*abb60n20+t2*t6&
      &*abb60n13+t2*t9*abb60n22+t3*t8*abb60n11+t3*t9*abb60n15+t4*t6*abb60n14+t4*&
      &t9*abb60n21+t5*t6*abb60n16+t5*t7*abb60n19+t5*t8*abb60n24+t5*abb60n28*(Q(1&
      &)*spvak1k6(1)-Q(2)*spvak1k6(2)-Q(3)*spvak1k6(3)-Q(4)*spvak1k6(4))+t6*t7*a&
      &bb60n12+t7*t9*abb60n23+t11*t3*t5*abb60n29)
