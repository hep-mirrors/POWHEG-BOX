module     p11_csbar_hepneg_d61h0l1
   ...
   ! m/Virtual/p11_csbar_hepneg/helicity0/d61h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      t7 = (Q(1)*spvae6k1(1)-Q(2)*spvae6k1(2)-Q(3)*spvae6k1(3)-Q(4)*spvae6k1(4))
      ...
      &)
      t11 = t3*abb61n5
      brack = (abb61n1+t1*abb61n16+t11*t5+t11*t6+t2*abb61n17+t3*abb61n2+t4*abb61&
      &n20+t5*abb61n3+t6*abb61n6+t7*abb61n8+t8*abb61n9+t1*t10*abb61n25+t1*t3*abb&
      &61n4+t1*t7*abb61n14+t1*t8*abb61n21+t10*t2*abb61n24+t10*t3*abb61n18+t2*t8*&
      &abb61n22+t3*t4*abb61n12+t3*t8*abb61n10+t3*t9*abb61n11+t3*abb61n7*(Q(1)*sp&
      &vak2k6(1)-Q(2)*spvak2k6(2)-Q(3)*spvak2k6(3)-Q(4)*spvak2k6(4))+t4*t8*abb61&
      &n26+t5*t7*abb61n13+t6*t7*abb61n15+t6*t8*abb61n23+t7*t8*abb61n19+t3*t8*t9*&
      &abb61n27)
