module     p11_csbar_hepneg_d70h0l1d
   ...
   ! m/Virtual/p11_csbar_hepneg/helicity0/d70h0l1d.f90
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      complex(ki), intent(in) :: mu2
      complex(ki) :: brack
      brack = (e6(iv1)*abb70n32+k6(iv1)*abb70n38+spvae6k1(iv1)*abb70n42+spvae6k2&
      &(iv1)*abb70n41+spvae6k4(iv1)*abb70n28+spvae6k6(iv1)*abb70n37+spvae6l3(iv1&
      &)*abb70n36+spvak2e6(iv1)*abb70n31+spvak2k6(iv1)*abb70n35+spvak5e6(iv1)*ab&
      &b70n34+spvak5k6(iv1)*abb70n39+spvak6e6(iv1)*abb70n33+spvak6k1(iv1)*abb70n&
      &40+spvak6k4(iv1)*abb70n29+spval3e6(iv1)*abb70n30)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      t1 = e6(iv1)
      t2 = e6(iv2)
      brack = ((2.0_ki)*d(iv1,iv2)*abb70n25+spvak2k1(iv1)*t2*abb70n26+spvak2k1(i&
      &v2)*t1*abb70n26+spvak2k4(iv1)*t2*abb70n27+spvak2k4(iv2)*t1*abb70n27+spvak&
      &5k1(iv1)*t2*abb70n24+spvak5k1(iv2)*t1*abb70n24)
