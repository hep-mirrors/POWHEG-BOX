module     p0_dbaru_hepneg_d34h0l1
   ...
   ! mlib_New/Virtual/p0_dbaru_hepneg/helicity0/d34h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (abb34n2+t1*abb34n10+t2*abb34n11+t3*abb34n3+abb34n4*(Q(1)*k2(1)-Q(&
      &2)*k2(2)-Q(3)*k2(3)-Q(4)*k2(4))+abb34n5*(Q(1)*Q(1)-Q(2)*Q(2)-Q(3)*Q(3)-Q(&
      &4)*Q(4))+abb34n6*(Q(1)*k1(1)-Q(2)*k1(2)-Q(3)*k1(3)-Q(4)*k1(4))+abb34n7*(Q&
      &(1)*spvak1k4(1)-Q(2)*spvak1k4(2)-Q(3)*spvak1k4(3)-Q(4)*spvak1k4(4))+t1*t3&
      &*abb34n9+t2*t3*abb34n12+t3*abb34n8*(Q(1)*spvak1k6(1)-Q(2)*spvak1k6(2)-Q(3&
