module     p0_dbaru_hepneg_d60h1l1
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p0_dbaru_hepneg/helicity1/d60h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (t1*abb60n2+t1*t1*abb60n1+t2*abb60n3+t3*abb60n7+t1*t3*abb60n6+t1*t&
      &4*abb60n5+t1*t5*abb60n11+t1*t6*abb60n4+t1*abb60n12*(Q(1)*spvak1k4(1)-Q(2)&
      &*spvak1k4(2)-Q(3)*spvak1k4(3)-Q(4)*spvak1k4(4))+t1*abb60n5*(Q(1)*k1(1)-Q(&
      &2)*k1(2)-Q(3)*k1(3)-Q(4)*k1(4))+t2*t5*abb60n8+t3*t5*abb60n9+t4*t5*abb60n1&
      &0+t1*t6*abb60n13*(Q(1)*spvak5k4(1)-Q(2)*spvak5k4(2)-Q(3)*spvak5k4(3)-Q(4)&
      &*spvak5k4(4)))
...
!           & sign => diagram60_sign, shift => diagram60_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p0_dbaru_hepneg_d60h1l1
