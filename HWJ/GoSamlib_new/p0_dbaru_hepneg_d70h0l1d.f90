module     p0_dbaru_hepneg_d70h0l1d
   ...
   ! mlib_New/Virtual/p0_dbaru_hepneg/helicity0/d70h0l1d.f90
...
!---#[ function brack_2:
   pure function brack_2(Q) result(brack)
      ...
      complex(ki), dimension(4), intent(in) :: Q
      complex(ki) :: brack
      brack = (k2(iv1)*abb70n24+k6(iv1)*abb70n23+spvak1k6(iv1)*abb70n28+spvak2k4&
      &(iv1)*abb70n25+spvak2k6(iv1)*abb70n27+spvak2l3(iv1)*abb70n26+spvak5k6(iv1&
      &)*abb70n21+spval3k6(iv1)*abb70n22)
