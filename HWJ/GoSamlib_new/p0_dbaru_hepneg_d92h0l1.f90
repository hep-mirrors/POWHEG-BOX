module     p0_dbaru_hepneg_d92h0l1
   ...
   ! mlib_New/Virtual/p0_dbaru_hepneg/helicity0/d92h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (abb92n2+t1*abb92n3+t2*abb92n4+abb92n5*(Q(1)*Q(1)-Q(2)*Q(2)-Q(3)*Q&
      &(3)-Q(4)*Q(4))+abb92n6*(Q(1)*k6(1)-Q(2)*k6(2)-Q(3)*k6(3)-Q(4)*k6(4))+t1*t&
      &2*abb92n7+t2*abb92n8*(Q(1)*spvak6k2(1)-Q(2)*spvak6k2(2)-Q(3)*spvak6k2(3)-&
      &Q(4)*spvak6k2(4)))
