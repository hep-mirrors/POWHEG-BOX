module     p0_dbaru_hepneg_d94h0l1d
   ...
   ! mlib_New/Virtual/p0_dbaru_hepneg/helicity0/d94h0l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q) result(brack)
      ...
      &vak1k6(4)*qshift(4))
      brack = (abb94n16+t1*abb94n23+t2*abb94n24+t3*abb94n26+t4*abb94n29+t5*abb94&
      &n25+t6*abb94n28+abb94n22*dotproduct(qshift, qshift)+t1*t3*abb94n19+t2*t3*&
      &abb94n18+t3*t4*abb94n17+t3*t5*abb94n20+t3*t6*abb94n21)
...
!---#[ function brack_2:
   pure function brack_2(Q) result(brack)
      ...
      &vak2k6(4)*qshift(4))
      brack = (qshift(iv1)*abb94n27+t1*abb94n25+t2*abb94n28+t3*abb94n29+t4*abb94&
      &n26+t5*abb94n24+t6*abb94n23+t1*t7*abb94n20+t2*t7*abb94n21+t3*t7*abb94n17+&
      &t4*abb94n17*(spvak1k6(1)*qshift(1)-spvak1k6(2)*qshift(2)-spvak1k6(3)*qshi&
      &ft(3)-spvak1k6(4)*qshift(4))+t4*abb94n18*(spvak5k2(1)*qshift(1)-spvak5k2(&
      &2)*qshift(2)-spvak5k2(3)*qshift(3)-spvak5k2(4)*qshift(4))+t4*abb94n19*(sp&
      &vak5k4(1)*qshift(1)-spvak5k4(2)*qshift(2)-spvak5k4(3)*qshift(3)-spvak5k4(&
      &4)*qshift(4))+t4*abb94n20*dotproduct(k1, qshift)+t4*abb94n21*dotproduct(k&
      &6, qshift)+t5*t7*abb94n18+t6*t7*abb94n19)
...
!---#[ function brack_3:
   pure function brack_3(Q) result(brack)
      ...
      t1 = spvak2k6(iv2)
      t2 = spvak2k6(iv1)
      brack = ((2.0_ki)*d(iv1,iv2)*abb94n22+k1(iv1)*t1*abb94n20+k1(iv2)*t2*abb94&
      &n20+k6(iv1)*t1*abb94n21+k6(iv2)*t2*abb94n21+spvak1k6(iv1)*t1*abb94n17+spv&
      &ak1k6(iv2)*t2*abb94n17+spvak5k2(iv1)*t1*abb94n18+spvak5k2(iv2)*t2*abb94n1&
      &8+spvak5k4(iv1)*t1*abb94n19+spvak5k4(iv2)*t2*abb94n19)
