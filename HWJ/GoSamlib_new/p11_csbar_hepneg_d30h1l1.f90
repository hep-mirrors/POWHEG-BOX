module     p11_csbar_hepneg_d30h1l1
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p11_csbar_hepneg/helicity1/d30h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      t2 = (Q(1)*spvak6k1(1)-Q(2)*spvak6k1(2)-Q(3)*spvak6k1(3)-Q(4)*spvak6k1(4))
      ...
      brack = (abb30n5+t1*abb30n10+t2*abb30n13+t3*abb30n14+t4*abb30n2+t5*abb30n9&
      &+abb30n3*(Q(1)*spvak2k4(1)-Q(2)*spvak2k4(2)-Q(3)*spvak2k4(3)-Q(4)*spvak2k&
      &4(4))+abb30n6*(Q(1)*Q(1)-Q(2)*Q(2)-Q(3)*Q(3)-Q(4)*Q(4))+abb30n7*(Q(1)*k2(&
      &1)-Q(2)*k2(2)-Q(3)*k2(3)-Q(4)*k2(4))+t1*t4*abb30n11+t2*t4*abb30n4+t3*t4*a&
      &bb30n15+t4*t5*abb30n12+t4*abb30n8*(Q(1)*spvak2k1(1)-Q(2)*spvak2k1(2)-Q(3)&
      &*spvak2k1(3)-Q(4)*spvak2k1(4)))
...
!           & sign => diagram30_sign, shift => diagram30_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p11_csbar_hepneg_d30h1l1
