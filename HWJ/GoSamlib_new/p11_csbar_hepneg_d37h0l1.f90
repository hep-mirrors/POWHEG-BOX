module     p11_csbar_hepneg_d37h0l1
   ...
   ! mlib_New/Virtual/p11_csbar_hepneg/helicity0/d37h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      complex(ki) :: brack
      brack = (abb37n1+abb37n2*(Q(1)*spvak2k6(1)-Q(2)*spvak2k6(2)-Q(3)*spvak2k6(&
      &3)-Q(4)*spvak2k6(4))+abb37n3*(Q(1)*spvak2k1(1)-Q(2)*spvak2k1(2)-Q(3)*spva&
      &k2k1(3)-Q(4)*spvak2k1(4))+abb37n4*(Q(1)*spvak6k1(1)-Q(2)*spvak6k1(2)-Q(3)&
      &*spvak6k1(3)-Q(4)*spvak6k1(4))+abb37n5*(Q(1)*spvak1k6(1)-Q(2)*spvak1k6(2)&
      &-Q(3)*spvak1k6(3)-Q(4)*spvak1k6(4))+abb37n6*(Q(1)*k6(1)-Q(2)*k6(2)-Q(3)*k&
      &6(3)-Q(4)*k6(4))+abb37n7*(Q(1)*k1(1)-Q(2)*k1(2)-Q(3)*k1(3)-Q(4)*k1(4)))
