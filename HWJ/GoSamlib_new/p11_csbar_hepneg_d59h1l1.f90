module     p11_csbar_hepneg_d59h1l1
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p11_csbar_hepneg/helicity1/d59h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      t8 = (Q(1)*spvak2k4(1)-Q(2)*spvak2k4(2)-Q(3)*spvak2k4(3)-Q(4)*spvak2k4(4))
      t9 = (Q(1)*spvak2k1(1)-Q(2)*spvak2k1(2)-Q(3)*spvak2k1(3)-Q(4)*spvak2k1(4))
      t10 = (Q(1)*spvak5k1(1)-Q(2)*spvak5k1(2)-Q(3)*spvak5k1(3)-Q(4)*spvak5k1(4)&
      &)
      brack = (abb59n1+t1*abb59n2+t2*abb59n3+t3*abb59n5+t4*abb59n6+t5*abb59n7+t6&
      &*abb59n9+t1*t10*abb59n23+t1*t3*abb59n15+t1*t4*abb59n17+t1*t7*abb59n11+t1*&
      &t8*abb59n14+t10*t2*abb59n21+t10*t3*abb59n25+t10*t6*abb59n22+t2*t4*abb59n2&
      &0+t2*t8*abb59n12+t3*t4*abb59n24+t3*t5*abb59n15+t3*t8*abb59n16+t3*t9*abb59&
      &n18+t4*t6*abb59n19+t4*t7*abb59n4+t6*t7*abb59n10+t6*t8*abb59n13+t7*t9*abb5&
      &9n8+t3*t7*t9*abb59n26)
...
!           & sign => diagram59_sign, shift => diagram59_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p11_csbar_hepneg_d59h1l1
