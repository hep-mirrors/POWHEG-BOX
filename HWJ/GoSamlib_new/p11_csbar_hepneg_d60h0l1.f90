module     p11_csbar_hepneg_d60h0l1
   ...
   ! mlib_New/Virtual/p11_csbar_hepneg/helicity0/d60h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (t1*abb60n1+t2*abb60n2+t3*abb60n3+t4*abb60n4+t4*t4*abb60n7+t5*abb6&
      &0n5+t6*abb60n8+t1*t4*abb60n9+t2*t7*abb60n11+t3*t4*abb60n6+t3*t7*abb60n14+&
      &t4*t5*abb60n15+t4*t7*abb60n10+t4*abb60n12*(Q(1)*spvak6k1(1)-Q(2)*spvak6k1&
      &(2)-Q(3)*spvak6k1(3)-Q(4)*spvak6k1(4))+t6*t7*abb60n13+t1*t4*t7*abb60n16)
