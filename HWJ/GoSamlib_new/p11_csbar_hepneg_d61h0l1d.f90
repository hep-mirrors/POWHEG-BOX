module     p11_csbar_hepneg_d61h0l1d
   ...
   ! mlib_New/Virtual/p11_csbar_hepneg/helicity0/d61h0l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q) result(brack)
      ...
      &vak2k1(4)*qshift(4))
      brack = (abb61n20+t1*abb61n40+t1*t1*abb61n31+t2*abb61n41+t3*abb61n47+t4*ab&
      &b61n28+t5*abb61n38+t6*abb61n39+abb61n48*dotproduct(k1, qshift)+t1*t2*abb6&
      &1n27+t1*t3*abb61n26+t1*t4*abb61n43+t1*t5*abb61n32+t1*t6*abb61n32+t1*abb61&
      &n22*(spvak5k1(1)*qshift(1)-spvak5k1(2)*qshift(2)-spvak5k1(3)*qshift(3)-sp&
      &vak5k1(4)*qshift(4))+t1*abb61n25*(spvak6k1(1)*qshift(1)-spvak6k1(2)*qshif&
      &t(2)-spvak6k1(3)*qshift(3)-spvak6k1(4)*qshift(4))+t3*t4*abb61n54+t3*t5*ab&
      &b61n25+t3*t6*abb61n23+t1*t2*t3*abb61n58)
...
!---#[ function brack_2:
   pure function brack_2(Q) result(brack)
      ...
      t5 = spvak2k6(iv1)
      t6 = spvak5k4(iv1)
      t7 = (spvak2k6(1)*qshift(1)-spvak2k6(2)*qshift(2)-spvak2k6(3)*qshift(3)-sp&
      &vak2k6(4)*qshift(4))
      t8 = (spvak2k1(1)*qshift(1)-spvak2k1(2)*qshift(2)-spvak2k1(3)*qshift(3)-sp&
      &vak2k1(4)*qshift(4))
      t11 = dotproduct(qshift, qshift)
      t12 = dotproduct(k2, qshift)
      t13 = dotproduct(k6, qshift)
      t9 = t5*abb61n45
      t10 = (spvak5k4(1)*qshift(1)-spvak5k4(2)*qshift(2)-spvak5k4(3)*qshift(3)-s&
      &pvak5k4(4)*qshift(4))
      brack = (k1(iv1)*abb61n29+t1*abb61n37+t12*t9+t13*t9+t2*abb61n36+t3*abb61n4&
      &9+t4*abb61n30+t5*abb61n35+t6*abb61n34+spvak5k1(iv1)*t7*abb61n57+spvak6k1(&
      &iv1)*t7*abb61n52+t1*t7*abb61n45+t1*t8*abb61n52+t10*t5*abb61n50+t11*t4*abb&
      &61n24+t11*t5*abb61n33+t12*t4*abb61n52+t13*t4*abb61n56+t2*t7*abb61n45+t2*t&
      &8*abb61n56+t3*t7*abb61n42+t3*t8*abb61n53+t4*t7*abb61n51+t5*t7*abb61n46+t5&
      &*t8*abb61n51+t5*abb61n52*(spvak6k1(1)*qshift(1)-spvak6k1(2)*qshift(2)-spv&
      &ak6k1(3)*qshift(3)-spvak6k1(4)*qshift(4))+t5*abb61n57*(spvak5k1(1)*qshift&
      &(1)-spvak5k1(2)*qshift(2)-spvak5k1(3)*qshift(3)-spvak5k1(4)*qshift(4))+t6&
      &*t7*abb61n50+t10*t4*t7*abb61n21+t10*t5*t8*abb61n21+t6*t7*t8*abb61n21)
...
!---#[ function brack_3:
   pure function brack_3(Q) result(brack)
      ...
      &pvak5k4(4)*qshift(4))
      brack = ((2.0_ki)*(t20*abb61n28+t1*t2*abb61n31+t20*t3*abb61n43+t20*t4*abb6&
      &1n54)+t13*abb61n26+t14*abb61n26+t16*abb61n27+t18*abb61n27+spvak5k1(iv1)*t&
      &2*abb61n22+spvak5k1(iv2)*t1*abb61n22+spvak6k1(iv1)*t2*abb61n25+spvak6k1(i&
      &v2)*t1*abb61n25+t1*t10*abb61n32+t1*t12*abb61n44+t1*t7*abb61n32+t10*t8*abb&
      &61n23+t11*t2*abb61n44+t11*t6*abb61n55+t12*t8*abb61n55+t13*t19*abb61n58+t1&
      &4*t19*abb61n58+t16*t4*abb61n58+t18*t4*abb61n58+t2*t5*abb61n32+t2*t9*abb61&
      &n32+t5*t6*abb61n25+t6*t9*abb61n23+t7*t8*abb61n25+t15*t3*t8*abb61n58+t17*t&
      &3*t6*abb61n58)
...
!---#[ function brack_4:
   pure function brack_4(Q) result(brack)
      ...
      t8 = spvak5k4(iv2)
      t9 = spvak5k4(iv1)
      brack = ((2.0_ki)*(t1*t10*abb61n24+t10*t4*abb61n33+t11*t2*abb61n24+t11*t5*&
      &abb61n33+t12*t3*abb61n24+t12*t6*abb61n33)+t1*t5*t7*abb61n21+t1*t6*t8*abb6&
      &1n21+t2*t4*t7*abb61n21+t2*t6*t9*abb61n21+t3*t4*t8*abb61n21+t3*t5*t9*abb61&
      &n21)
