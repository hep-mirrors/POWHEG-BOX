module     p11_csbar_hepneg_d61h1l1
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p11_csbar_hepneg/helicity1/d61h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (abb61n1+t1*abb61n12+t2*abb61n13+t3*abb61n14+t4*abb61n3+t5*abb61n4&
      &+t6*abb61n5+t1*t2*abb61n17+t1*t4*abb61n21+t1*t5*abb61n18+t1*t6*abb61n16+t&
      &1*t7*abb61n2+t2*t4*abb61n9+t2*t7*abb61n6+t2*t9*abb61n19+t3*t7*abb61n7+t3*&
      &t9*abb61n20+t4*t5*abb61n10+t4*t6*abb61n10+t4*t7*abb61n15+t4*t8*abb61n16+t&
      &4*t9*abb61n22+t4*abb61n11*(Q(1)*spvak2k6(1)-Q(2)*spvak2k6(2)-Q(3)*spvak2k&
      &6(3)-Q(4)*spvak2k6(4))+t6*t7*abb61n8+t4*t7*t8*abb61n23)
...
!           & sign => diagram61_sign, shift => diagram61_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p11_csbar_hepneg_d61h1l1
