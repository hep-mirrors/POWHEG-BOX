module     p11_csbar_hepneg_diagramsh1l0
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p11_csbar_hepneg/helicity1/diagramsl0.f90
...
contains
   function     amplitude()
      ...
      &1*gHWW*spbk4k1+t4/t3*es12*gHWW*spbk4k1))*CVSC*c1)
      diagrams(1, :) = spbk4k1*spbk2k1*spak2k5*spak1k6*i_*gHWW*(-4.0_ki)/(t1*t2*&
      &es61*spbk6k2*sqrt2)*t4*CVSC*c1
...
end module p11_csbar_hepneg_diagramsh1l0
