module     p11_csbar_hepneg_matrix
   ...
   use p11_csbar_hepneg_diagramsh1l0, only: amplitude1l0 => amplitude
   use p11_csbar_hepneg_amplitudeh1, only: samplitudeh1l1 => samplitude, &
...
!              write(*,*) "RESCUE FAILED !!"
!              write(*,*) "process: p11_csbar_hepneg"
