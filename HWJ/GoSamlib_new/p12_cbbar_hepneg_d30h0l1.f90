module     p12_cbbar_hepneg_d30h0l1
   ...
   ! mlib_New/Virtual/p12_cbbar_hepneg/helicity0/d30h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (abb30n2+t1*abb30n5+t2*abb30n9+abb30n4*(Q(1)*spvak2k4(1)-Q(2)*spva&
      &k2k4(2)-Q(3)*spvak2k4(3)-Q(4)*spvak2k4(4))+abb30n6*(Q(1)*k2(1)-Q(2)*k2(2)&
      &-Q(3)*k2(3)-Q(4)*k2(4))+abb30n6*(Q(1)*k6(1)-Q(2)*k6(2)-Q(3)*k6(3)-Q(4)*k6&
      &(4))+abb30n7*(Q(1)*Q(1)-Q(2)*Q(2)-Q(3)*Q(3)-Q(4)*Q(4))+abb30n8*(Q(1)*k1(1&
