module     p12_cbbar_hepneg_d37h1l1d
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p12_cbbar_hepneg/helicity1/d37h1l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q) result(brack)
      ...
      complex(ki) :: brack
      brack = (abb37n7+abb37n10*dotproduct(k6, qshift)+abb37n11*(spvak6k1(1)*qsh&
      &ift(1)-spvak6k1(2)*qshift(2)-spvak6k1(3)*qshift(3)-spvak6k1(4)*qshift(4))&
      &+abb37n8*(spvak6k2(1)*qshift(1)-spvak6k2(2)*qshift(2)-spvak6k2(3)*qshift(&
      &3)-spvak6k2(4)*qshift(4))+abb37n9*dotproduct(k1, qshift))
...
!---#[ function brack_2:
   pure function brack_2(Q) result(brack)
      ...
      complex(ki), dimension(4), intent(in) :: Q
      complex(ki) :: brack
      brack = (k1(iv1)*abb37n9+k6(iv1)*abb37n10+spvak6k1(iv1)*abb37n11+spvak6k2(&
      &iv1)*abb37n8)
...
!---#] subroutine reconstruct_d37:
end module p12_cbbar_hepneg_d37h1l1d
