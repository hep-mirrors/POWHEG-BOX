module     p12_cbbar_hepneg_d59h0l1
   ...
   ! m/Virtual/p12_cbbar_hepneg/helicity0/d59h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      complex(ki) :: t11
      complex(ki) :: t12
      t1 = (Q(1)*spvae6k1(1)-Q(2)*spvae6k1(2)-Q(3)*spvae6k1(3)-Q(4)*spvae6k1(4))
      t2 = (Q(1)*k2(1)-Q(2)*k2(2)-Q(3)*k2(3)-Q(4)*k2(4))
      t3 = (Q(1)*e6(1)-Q(2)*e6(2)-Q(3)*e6(3)-Q(4)*e6(4))
      t4 = (Q(1)*k1(1)-Q(2)*k1(2)-Q(3)*k1(3)-Q(4)*k1(4))
      t5 = (Q(1)*k6(1)-Q(2)*k6(2)-Q(3)*k6(3)-Q(4)*k6(4))
      t6 = (Q(1)*spvak5k4(1)-Q(2)*spvak5k4(2)-Q(3)*spvak5k4(3)-Q(4)*spvak5k4(4))
      t7 = (Q(1)*Q(1)-Q(2)*Q(2)-Q(3)*Q(3)-Q(4)*Q(4))
      t8 = (Q(1)*spvak6k1(1)-Q(2)*spvak6k1(2)-Q(3)*spvak6k1(3)-Q(4)*spvak6k1(4))
      ...
      &)
      t11 = (Q(1)*spvak2k4(1)-Q(2)*spvak2k4(2)-Q(3)*spvak2k4(3)-Q(4)*spvak2k4(4)&
      &)
      t12 = t3*abb59n6
      brack = (abb59n1+t1*abb59n10+t12*t2+t12*t4+t2*abb59n11+t3*abb59n2+t4*abb59&
      &n3+t5*abb59n4+t6*abb59n5+t7*abb59n7+t1*t4*abb59n15+t1*t5*abb59n13+t1*t6*a&
      &bb59n17+t1*t7*abb59n14+t10*t3*abb59n9+t10*t6*abb59n18+t11*t3*abb59n8+t11*&
      &t4*abb59n23+t11*t5*abb59n21+t11*t7*abb59n22+t3*t8*abb59n12+t3*t9*abb59n16&
      &+t4*t6*abb59n20+t4*t9*abb59n25+t5*t9*abb59n27+t6*t7*abb59n19+t6*t8*abb59n&
      &28+t6*abb59n24*(Q(1)*spvak2k6(1)-Q(2)*spvak2k6(2)-Q(3)*spvak2k6(3)-Q(4)*s&
      &pvak2k6(4))+t7*t9*abb59n26+t10*t3*t6*abb59n29)
