module     p12_cbbar_hepneg_d59h0l1
   ...
   ! mlib_New/Virtual/p12_cbbar_hepneg/helicity0/d59h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (abb59n1+t1*abb59n10+t2*abb59n2+t3*abb59n3+t4*abb59n4+t5*abb59n5+t&
      &6*abb59n6+t7*abb59n7+t1*t5*abb59n9+t2*t6*abb59n17+t2*t8*abb59n13+t3*t6*ab&
      &b59n18+t3*t8*abb59n12+t4*t5*abb59n9+t4*t6*abb59n20+t4*t8*abb59n11+t5*t6*a&
      &bb59n16+t5*t7*abb59n14+t5*t8*abb59n15+t5*abb59n19*(Q(1)*spvak6k1(1)-Q(2)*&
      &spvak6k1(2)-Q(3)*spvak6k1(3)-Q(4)*spvak6k1(4))+t5*abb59n21*(Q(1)*spvak5k1&
      &(1)-Q(2)*spvak5k1(2)-Q(3)*spvak5k1(3)-Q(4)*spvak5k1(4))+t6*t7*abb59n8+t5*&
      &t6*t7*abb59n22)
