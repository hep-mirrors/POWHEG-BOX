module     p12_cbbar_hepneg_d92h0l1d
   ...
   ! mlib_New/Virtual/p12_cbbar_hepneg/helicity0/d92h0l1d.f90
...
!---#[ function brack_3:
   pure function brack_3(Q) result(brack)
      ...
      t1 = spvak2k6(iv2)
      t2 = spvak2k6(iv1)
      brack = (k2(iv1)*t1*abb92n12+k2(iv2)*t2*abb92n12+k6(iv1)*t1*abb92n11+k6(iv&
      &2)*t2*abb92n11+spvak5k1(iv1)*t1*abb92n9+spvak5k1(iv2)*t2*abb92n9+spvak5k4&
      &(iv1)*t1*abb92n10+spvak5k4(iv2)*t2*abb92n10+(2.0_ki)*t1*t2*abb92n8)
