module     p12_cbbar_hepneg_d92h1l1
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p12_cbbar_hepneg/helicity1/d92h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (abb92n2+t1*abb92n3+t2*abb92n4+t3*abb92n5+t4*abb92n6+t5*abb92n8+ab&
      &b92n7*(Q(1)*Q(1)-Q(2)*Q(2)-Q(3)*Q(3)-Q(4)*Q(4))+t1*t4*abb92n12+t2*t4*abb9&
      &2n9+t3*t4*abb92n13+t4*t5*abb92n10+t4*abb92n11*(Q(1)*spvak2k6(1)-Q(2)*spva&
      &k2k6(2)-Q(3)*spvak2k6(3)-Q(4)*spvak2k6(4)))
...
!           & sign => diagram92_sign, shift => diagram92_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p12_cbbar_hepneg_d92h1l1
