module     p12_cbbar_hepneg_golem95h1
...
subroutine     reconstruct_group0(coeffs)
   ...
   use p12_cbbar_hepneg_d70h1l1, only: numerator_d70 => numerator_golem95
   use p12_cbbar_hepneg_d70h1l1d, only: reconstruct_d70
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p12_cbbar_hepneg_d61h1l1, only: numerator_d61 => numerator_golem95
   use p12_cbbar_hepneg_d61h1l1d, only: reconstruct_d61
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p12_cbbar_hepneg_d34h1l1, only: numerator_d34 => numerator_golem95
   use p12_cbbar_hepneg_d34h1l1d, only: reconstruct_d34
   use p12_cbbar_hepneg_d40h1l1, only: numerator_d40 => numerator_golem95
   use p12_cbbar_hepneg_d40h1l1d, only: reconstruct_d40
   use p12_cbbar_hepneg_d60h1l1, only: numerator_d60 => numerator_golem95
   use p12_cbbar_hepneg_d60h1l1d, only: reconstruct_d60
   use p12_cbbar_hepneg_d92h1l1, only: numerator_d92 => numerator_golem95
   use p12_cbbar_hepneg_d92h1l1d, only: reconstruct_d92
   implicit none
...
subroutine     reconstruct_group3(coeffs)
   ...
   use p12_cbbar_hepneg_d30h1l1, only: numerator_d30 => numerator_golem95
   use p12_cbbar_hepneg_d30h1l1d, only: reconstruct_d30
   use p12_cbbar_hepneg_d37h1l1, only: numerator_d37 => numerator_golem95
   use p12_cbbar_hepneg_d37h1l1d, only: reconstruct_d37
   use p12_cbbar_hepneg_d59h1l1, only: numerator_d59 => numerator_golem95
   use p12_cbbar_hepneg_d59h1l1d, only: reconstruct_d59
   use p12_cbbar_hepneg_d94h1l1, only: numerator_d94 => numerator_golem95
   use p12_cbbar_hepneg_d94h1l1d, only: reconstruct_d94
   implicit none
...
!---#] subroutine reconstruct_group3:
end module p12_cbbar_hepneg_golem95h1
