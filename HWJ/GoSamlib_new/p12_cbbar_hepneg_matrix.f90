module     p12_cbbar_hepneg_matrix
   ...
   use p12_cbbar_hepneg_diagramsh1l0, only: amplitude1l0 => amplitude
   use p12_cbbar_hepneg_amplitudeh1, only: samplitudeh1l1 => samplitude, &
