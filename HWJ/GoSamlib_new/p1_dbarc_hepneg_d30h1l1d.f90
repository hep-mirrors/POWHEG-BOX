module     p1_dbarc_hepneg_d30h1l1d
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p1_dbarc_hepneg/helicity1/d30h1l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q) result(brack)
      ...
      &vak5k4(4)*qshift(4))
      brack = (abb30n14+t1*abb30n21+t2*abb30n25+abb30n16*dotproduct(qshift, qshi&
      &ft)+abb30n18*dotproduct(k1, qshift)+abb30n19*(spvak1k6(1)*qshift(1)-spvak&
      &1k6(2)*qshift(2)-spvak1k6(3)*qshift(3)-spvak1k6(4)*qshift(4))+abb30n20*(s&
      &pvak5k2(1)*qshift(1)-spvak5k2(2)*qshift(2)-spvak5k2(3)*qshift(3)-spvak5k2&
      &(4)*qshift(4))+abb30n22*(spvak6k1(1)*qshift(1)-spvak6k1(2)*qshift(2)-spva&
      &k6k1(3)*qshift(3)-spvak6k1(4)*qshift(4))+abb30n23*dotproduct(k6, qshift)+&
      &t1*t3*abb30n17+t2*t3*abb30n15)
...
!---#[ function brack_2:
   pure function brack_2(Q) result(brack)
      ...
      &vak5k4(4)*qshift(4))
      t4 = spvak5k4(iv1)
      brack = (k1(iv1)*abb30n18+k6(iv1)*abb30n23+qshift(iv1)*abb30n24+spvak1k6(i&
      &v1)*abb30n19+spvak5k2(iv1)*abb30n20+spvak6k1(iv1)*abb30n22+t1*abb30n21+t2&
      &*abb30n25+t1*t3*abb30n17+t2*t3*abb30n15+t4*abb30n15*(spvak6k2(1)*qshift(1&
      &)-spvak6k2(2)*qshift(2)-spvak6k2(3)*qshift(3)-spvak6k2(4)*qshift(4))+t4*a&
      &bb30n17*(spvak1k2(1)*qshift(1)-spvak1k2(2)*qshift(2)-spvak1k2(3)*qshift(3&
      &)-spvak1k2(4)*qshift(4)))
...
!---#[ function brack_3:
   pure function brack_3(Q) result(brack)
      ...
      t1 = spvak5k4(iv2)
      t2 = spvak5k4(iv1)
      brack = ((2.0_ki)*d(iv1,iv2)*abb30n16+spvak1k2(iv1)*t1*abb30n17+spvak1k2(i&
      &v2)*t2*abb30n17+spvak6k2(iv1)*t1*abb30n15+spvak6k2(iv2)*t2*abb30n15)
...
!---#] subroutine reconstruct_d30:
end module p1_dbarc_hepneg_d30h1l1d
