module     p1_dbarc_hepneg_d37h0l1
   ...
   ! mlib_New/Virtual/p1_dbarc_hepneg/helicity0/d37h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      complex(ki) :: brack
      brack = (abb37n1+abb37n2*(Q(1)*spvak5k4(1)-Q(2)*spvak5k4(2)-Q(3)*spvak5k4(&
      &3)-Q(4)*spvak5k4(4))+abb37n3*(Q(1)*spvak5k2(1)-Q(2)*spvak5k2(2)-Q(3)*spva&
      &k5k2(3)-Q(4)*spvak5k2(4))+abb37n4*(Q(1)*k1(1)-Q(2)*k1(2)-Q(3)*k1(3)-Q(4)*&
      &k1(4))+abb37n5*(Q(1)*k6(1)-Q(2)*k6(2)-Q(3)*k6(3)-Q(4)*k6(4))+abb37n6*(Q(1&
      &)*spvak1k6(1)-Q(2)*spvak1k6(2)-Q(3)*spvak1k6(3)-Q(4)*spvak1k6(4)))
