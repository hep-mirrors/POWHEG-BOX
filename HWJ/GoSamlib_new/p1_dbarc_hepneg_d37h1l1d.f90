module     p1_dbarc_hepneg_d37h1l1d
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p1_dbarc_hepneg/helicity1/d37h1l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q) result(brack)
      ...
      &ak5k2(3)*qshift(3)-spvak5k2(4)*qshift(4))+abb37n11*(spvak6k1(1)*qshift(1)&
      &-spvak6k1(2)*qshift(2)-spvak6k1(3)*qshift(3)-spvak6k1(4)*qshift(4))+abb37&
      &n12*dotproduct(k6, qshift)+abb37n13*dotproduct(k1, qshift)+abb37n9*(spvak&
...
!---#[ function brack_2:
   pure function brack_2(Q) result(brack)
      ...
      complex(ki), dimension(4), intent(in) :: Q
      complex(ki) :: brack
      brack = (k1(iv1)*abb37n13+k6(iv1)*abb37n12+spvak1k6(iv1)*abb37n9+spvak5k2(&
      &iv1)*abb37n10+spvak6k1(iv1)*abb37n11)
...
!---#] subroutine reconstruct_d37:
end module p1_dbarc_hepneg_d37h1l1d
