module     p1_dbarc_hepneg_d60h0l1
   ...
   ! mlib_New/Virtual/p1_dbarc_hepneg/helicity0/d60h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      t5 = (Q(1)*spvak6k2(1)-Q(2)*spvak6k2(2)-Q(3)*spvak6k2(3)-Q(4)*spvak6k2(4))
      t6 = (Q(1)*k6(1)-Q(2)*k6(2)-Q(3)*k6(3)-Q(4)*k6(4))
      t7 = (Q(1)*spvak2k6(1)-Q(2)*spvak2k6(2)-Q(3)*spvak2k6(3)-Q(4)*spvak2k6(4))
      ...
      t10 = (Q(1)*spvak1k4(1)-Q(2)*spvak1k4(2)-Q(3)*spvak1k4(3)-Q(4)*spvak1k4(4)&
      &)
      brack = (abb60n1+t1*abb60n5+t1*t1*abb60n17+t2*abb60n2+t3*abb60n3+t4*abb60n&
      &4+t5*abb60n7+t6*abb60n8+t7*abb60n9+t1*t10*abb60n24+t1*t2*abb60n19+t1*t3*a&
      &bb60n11+t1*t6*abb60n20+t1*t7*abb60n16+t1*t8*abb60n14+t10*t2*abb60n23+t10*&
      &t6*abb60n22+t10*t7*abb60n25+t2*t3*abb60n10+t2*t8*abb60n13+t3*abb60n6*(Q(1&
      &)*spvak1k6(1)-Q(2)*spvak1k6(2)-Q(3)*spvak1k6(3)-Q(4)*spvak1k6(4))+t4*t7*a&
      &bb60n16+t5*t7*abb60n18+t6*t8*abb60n12+t7*t8*abb60n21+t7*t9*abb60n15+t3*t7&
      &*t9*abb60n26)
