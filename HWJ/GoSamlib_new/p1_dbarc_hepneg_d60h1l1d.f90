module     p1_dbarc_hepneg_d60h1l1d
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p1_dbarc_hepneg/helicity1/d60h1l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q) result(brack)
      ...
      &vak1k2(4)*qshift(4))
      brack = (t1*abb60n24+t1*t1*abb60n15+t4*abb60n20+t5*abb60n25+t1*t2*abb60n17&
      &+t1*t3*abb60n22+t1*t4*abb60n26+t1*t6*abb60n21+t1*abb60n16*(spvak1k4(1)*qs&
      &hift(1)-spvak1k4(2)*qshift(2)-spvak1k4(3)*qshift(3)-spvak1k4(4)*qshift(4)&
      &)+t1*abb60n21*dotproduct(k1, qshift)+t2*t4*abb60n29+t2*t5*abb60n19+t2*t6*&
      &abb60n18+t1*t3*abb60n31*(spvak5k4(1)*qshift(1)-spvak5k4(2)*qshift(2)-spva&
      &k5k4(3)*qshift(3)-spvak5k4(4)*qshift(4)))
...
!---#[ function brack_2:
   pure function brack_2(Q) result(brack)
      ...
      t13 = dotproduct(qshift, qshift)
      t9 = t3*abb60n21
      t10 = (spvak1k2(1)*qshift(1)-spvak1k2(2)*qshift(2)-spvak1k2(3)*qshift(3)-s&
      &pvak1k2(4)*qshift(4))
      t11 = (spvak5k4(1)*qshift(1)-spvak5k4(2)*qshift(2)-spvak5k4(3)*qshift(3)-s&
      &pvak5k4(4)*qshift(4))
      brack = (t1*abb60n25+t12*t9+t2*abb60n28+t3*abb60n24+t9*dotproduct(k1, qshi&
      &ft)+k1(iv1)*t4*abb60n21+spvak1k4(iv1)*t4*abb60n16+t1*t5*abb60n19+t10*t3*a&
      &bb60n22+t12*t8*abb60n18+t13*t3*abb60n26+t13*t8*abb60n29+t2*t4*abb60n27+t2&
      &*t5*abb60n30+t3*t4*abb60n23+t3*t5*abb60n17+t3*abb60n16*(spvak1k4(1)*qshif&
      &t(1)-spvak1k4(2)*qshift(2)-spvak1k4(3)*qshift(3)-spvak1k4(4)*qshift(4))+t&
      &4*t6*abb60n21+t4*t7*abb60n22+t4*t8*abb60n17+t5*t6*abb60n18+t8*abb60n19*do&
      &tproduct(k2, qshift)+spvak5k4(iv1)*t10*t4*abb60n31+t10*t11*t3*abb60n31+t1&
      &1*t4*t7*abb60n31)
...
!---#[ function brack_3:
   pure function brack_3(Q) result(brack)
      ...
      &pvak1k2(4)*qshift(4))
      brack = ((2.0_ki)*(t18*abb60n20+t1*t2*abb60n15+t18*t3*abb60n26+t18*abb60n2&
      &9*(spvak5k2(1)*qshift(1)-spvak5k2(2)*qshift(2)-spvak5k2(3)*qshift(3)-spva&
      &k5k2(4)*qshift(4)))+t11*abb60n22+t13*abb60n22+k1(iv1)*t2*abb60n21+k1(iv2)&
      &*t1*abb60n21+k2(iv1)*t4*abb60n19+k2(iv2)*t5*abb60n19+spvak1k4(iv1)*t2*abb&
      &60n16+spvak1k4(iv2)*t1*abb60n16+t1*t4*abb60n17+t1*t7*abb60n21+t1*t9*abb60&
      &n27+t11*t15*abb60n31+t13*t15*abb60n31+t2*t5*abb60n17+t2*t6*abb60n21+t2*t8&
      &*abb60n27+t4*t6*abb60n18+t4*t8*abb60n30+t5*t7*abb60n18+t5*t9*abb60n30+t1*&
      &t14*t17*abb60n31+t10*t14*t3*abb60n31+t12*t16*t3*abb60n31+t16*t17*t2*abb60&
      &n31)
...
!---#[ function brack_4:
   pure function brack_4(Q) result(brack)
      ...
      t8 = spvak5k4(iv1)
      t9 = spvak1k2(iv3)
      brack = ((2.0_ki)*(spvak5k2(iv1)*t10*abb60n29+spvak5k2(iv2)*t11*abb60n29+s&
      &pvak5k2(iv3)*t12*abb60n29+t1*t10*abb60n26+t11*t2*abb60n26+t12*t3*abb60n26&
      &)+t1*t5*t9*abb60n31+t1*t6*t7*abb60n31+t2*t4*t6*abb60n31+t2*t8*t9*abb60n31&
      &+t3*t4*t5*abb60n31+t3*t7*t8*abb60n31)
...
!---#] subroutine reconstruct_d60:
end module p1_dbarc_hepneg_d60h1l1d
