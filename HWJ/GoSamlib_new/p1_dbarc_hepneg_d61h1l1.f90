module     p1_dbarc_hepneg_d61h1l1
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p1_dbarc_hepneg/helicity1/d61h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (abb61n1+t1*abb61n2+t2*abb61n7+t2*t2*abb61n6+t3*abb61n8+t4*abb61n9&
      &+t1*t2*abb61n4+t1*t5*abb61n12+t2*t3*abb61n5+t2*t5*abb61n13+t2*t6*abb61n3+&
      &t2*abb61n14*(Q(1)*spvak1k4(1)-Q(2)*spvak1k4(2)-Q(3)*spvak1k4(3)-Q(4)*spva&
      &k1k4(4))+t2*abb61n4*(Q(1)*k1(1)-Q(2)*k1(2)-Q(3)*k1(3)-Q(4)*k1(4))+t3*t5*a&
      &bb61n11+t4*t5*abb61n10+t2*t6*abb61n15*(Q(1)*spvak5k4(1)-Q(2)*spvak5k4(2)-&
      &Q(3)*spvak5k4(3)-Q(4)*spvak5k4(4)))
...
!           & sign => diagram61_sign, shift => diagram61_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_hepneg_d61h1l1
