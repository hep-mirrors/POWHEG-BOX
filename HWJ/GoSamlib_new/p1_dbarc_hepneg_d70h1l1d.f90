module     p1_dbarc_hepneg_d70h1l1d
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p1_dbarc_hepneg/helicity1/d70h1l1d.f90
...
!---#[ function brack_2:
   pure function brack_2(Q) result(brack)
      ...
      complex(ki), dimension(4), intent(in) :: Q
      complex(ki) :: brack
      brack = (k2(iv1)*abb70n27+k6(iv1)*abb70n23+spvak1k2(iv1)*abb70n28+spvak5k2&
      &(iv1)*abb70n21+spvak6k2(iv1)*abb70n26+spvak6k4(iv1)*abb70n24+spvak6l3(iv1&
      &)*abb70n22+spval3k2(iv1)*abb70n25)
...
!---#[ function brack_3:
   pure function brack_3(Q) result(brack)
      ...
      t1 = spvak6k2(iv2)
      t2 = spvak6k2(iv1)
      brack = ((2.0_ki)*d(iv1,iv2)*abb70n19+spvak1k2(iv1)*t1*abb70n18+spvak1k2(i&
      &v2)*t2*abb70n18+spvak1k4(iv1)*t1*abb70n17+spvak1k4(iv2)*t2*abb70n17+spvak&
      &5k2(iv1)*t1*abb70n20+spvak5k2(iv2)*t2*abb70n20)
...
!---#] subroutine reconstruct_d70:
end module p1_dbarc_hepneg_d70h1l1d
