module     p1_dbarc_hepneg_d92h0l1d
   ...
   ! mlib_New/Virtual/p1_dbarc_hepneg/helicity0/d92h0l1d.f90
...
!---#[ function brack_2:
   pure function brack_2(Q) result(brack)
      ...
      complex(ki), dimension(4), intent(in) :: Q
      complex(ki) :: brack
      brack = (k2(iv1)*abb92n16+k6(iv1)*abb92n13+spvak2k6(iv1)*abb92n15)
...
!---#[ function brack_3:
   pure function brack_3(Q) result(brack)
      ...
      t1 = spvak2k6(iv2)
      t2 = spvak2k6(iv1)
      brack = ((2.0_ki)*d(iv1,iv2)*abb92n14+k2(iv1)*t1*abb92n12+k2(iv2)*t2*abb92&
      &n12+spvak6k2(iv1)*t1*abb92n11+spvak6k2(iv2)*t2*abb92n11)
