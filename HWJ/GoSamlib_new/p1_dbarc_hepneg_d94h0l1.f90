module     p1_dbarc_hepneg_d94h0l1
   ...
   ! m/Virtual/p1_dbarc_hepneg/helicity0/d94h0l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (abb94n2+t1*abb94n12+t2*abb94n3+t3*abb94n4+t4*abb94n5+t5*abb94n9+a&
      &bb94n13*(Q(1)*Q(1)-Q(2)*Q(2)-Q(3)*Q(3)-Q(4)*Q(4))+abb94n6*(Q(1)*spvak1e6(&
      &1)-Q(2)*spvak1e6(2)-Q(3)*spvak1e6(3)-Q(4)*spvak1e6(4))+t1*t4*abb94n8+t2*t&
      &4*abb94n10+t3*t4*abb94n11+t4*t5*abb94n7+t4*abb94n14*(Q(1)*spvak1k6(1)-Q(2&
      &)*spvak1k6(2)-Q(3)*spvak1k6(3)-Q(4)*spvak1k6(4)))
