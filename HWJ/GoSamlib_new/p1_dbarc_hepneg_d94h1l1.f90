module     p1_dbarc_hepneg_d94h1l1
   ! file:      /home/pcl305a/luisonig/Documents/GoSamPowheg/POWHEG-BOX/HWJ/GoSa
   ! mlib_New/Virtual/p1_dbarc_hepneg/helicity1/d94h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      brack = (abb94n2+t1*abb94n3+t2*abb94n4+t3*abb94n5+t4*abb94n6+t5*abb94n9+ab&
      &b94n10*(Q(1)*Q(1)-Q(2)*Q(2)-Q(3)*Q(3)-Q(4)*Q(4))+t1*t4*abb94n11+t2*t4*abb&
      &94n12+t3*t4*abb94n8+t4*t5*abb94n7+t4*abb94n13*(Q(1)*spvak1k6(1)-Q(2)*spva&
      &k1k6(2)-Q(3)*spvak1k6(3)-Q(4)*spvak1k6(4)))
...
!           & sign => diagram94_sign, shift => diagram94_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p1_dbarc_hepneg_d94h1l1
