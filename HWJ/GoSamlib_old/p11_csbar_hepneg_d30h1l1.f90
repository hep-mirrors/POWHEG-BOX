module     p11_csbar_hepneg_d30h1l1
   ...
   ! _csbar_hepneg/helicity1/d30h1l1.f90
...
!           & sign => diagram30_sign, shift => diagram30_shift
      ...
      d30 = (abb30n5+t1*abb30n10+t2*abb30n13+t3*abb30n14+t4*abb30n2+t5*abb30n9+a&
      &bb30n3*(Q(1)*spvak2k4(1)-Q(2)*spvak2k4(2)-Q(3)*spvak2k4(3)-Q(4)*spvak2k4(&
      &4))+abb30n6*(Q(1)*Q(1)-Q(2)*Q(2)-Q(3)*Q(3)-Q(4)*Q(4))+abb30n7*(Q(1)*k2(1)&
      &-Q(2)*k2(2)-Q(3)*k2(3)-Q(4)*k2(4))+t1*t4*abb30n11+t2*t4*abb30n4+t3*t4*abb&
      &30n15+t4*t5*abb30n12+t4*abb30n8*(Q(1)*spvak2k1(1)-Q(2)*spvak2k1(2)-Q(3)*s&
      &pvak2k1(3)-Q(4)*spvak2k1(4)))
