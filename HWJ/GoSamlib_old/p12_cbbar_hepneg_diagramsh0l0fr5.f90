module     p12_cbbar_hepneg_diagramsh0l0fr5
   ! file:      /home/oleari/fortran/POWHEG-BOX/HWJ_CKM/GoSam_POWHEG/Virtual/p12
   ! _cbbar_hepneg/helicity0/diagramsl0fr5.f90
...
contains
   function     amplitude()
      ...
      &t3/(t1*spak2k6*sqrt2)*gHWW*spak1k2*spbk4k1*spbk6k1)*CVBC*c1)
...
end module p12_cbbar_hepneg_diagramsh0l0fr5
