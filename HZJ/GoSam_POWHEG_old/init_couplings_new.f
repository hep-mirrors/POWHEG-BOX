...
C     rndiwhichseed=rnd_iwhichseed
C     parallelstage=powheginput('#parallelstage')
...
C     Initialize virtual code
      ...
      call OLP_Start(path,ioerr,-1,-1)
C     call OLP_Start(path,ioerr,parallelstage,rndiwhichseed)
