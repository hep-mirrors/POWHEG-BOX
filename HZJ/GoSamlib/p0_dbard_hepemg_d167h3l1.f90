...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc167(6)=abb167(12)
      acc167(7)=abb167(15)
      acc167(8)=Qspvak6k1*acc167(1)
      acc167(9)=Qspvak4k5*acc167(4)
      acc167(10)=Qspvak2k5*acc167(2)
      acc167(11)=Qspvak1k6*acc167(5)
...
!           & sign => diagram167_sign, shift => diagram167_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p0_dbard_hepemg_d167h3l1
