module     p12_sbars_hepemg_abbrevd154h1
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb154(4)=NC**(-1)
      abb154(5)=spbk6e6*spbk4k1
      abb154(6)=abb154(5)*spak5k6
      abb154(7)=NC-abb154(4)
      abb154(7)=abb154(7)*gSr*gHZZ*c1*i_*TR*gel*abb154(3)*abb154(2)*abb154(1)
      abb154(8)=spak2e6*abb154(7)
      abb154(9)=abb154(6)*abb154(8)
      abb154(10)=spbk2k1*spak2k5
      ...
      abb154(10)=spbk4k2*abb154(10)
      abb154(11)=abb154(11)*abb154(19)
      abb154(19)=-abb154(8)*spak5k6*spbk4k1
      ...
      abb154(8)=spbk4k2*abb154(12)*abb154(8)
      R2d154=abb154(9)
      rat2 = rat2 + R2d154
...
end module p12_sbars_hepemg_abbrevd154h1
