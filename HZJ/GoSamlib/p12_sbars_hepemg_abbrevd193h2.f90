module     p12_sbars_hepemg_abbrevd193h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb193(3)=NC**(-1)
      abb193(4)=es61**(-1)
      abb193(5)=gHZZ*spak1e6*c1*i_*TR*gSl*ger*abb193(2)*abb193(1)
      ...
      abb193(8)=abb193(8)*abb193(11)
      abb193(10)=spbk6k5*abb193(10)
      abb193(6)=-spbk5k1*abb193(6)
...
end module p12_sbars_hepemg_abbrevd193h2
