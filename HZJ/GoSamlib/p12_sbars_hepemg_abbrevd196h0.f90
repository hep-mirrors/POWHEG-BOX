module     p12_sbars_hepemg_abbrevd196h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb196(6)=gHZZ*spak1k5*c1*abb196(1)**2*i_*TR*gSl*gel*abb196(3)*abb196(2)
      abb196(7)=abb196(5)*abb196(6)*spbk6k4*spbe6k2
      abb196(8)=-spae6k6*abb196(7)
      abb196(9)=-es61+es345-es12
      abb196(10)=-2.0_ki*abb196(8)*abb196(9)
      abb196(5)=-spbk4k2*abb196(6)*abb196(5)
...
end module p12_sbars_hepemg_abbrevd196h0
