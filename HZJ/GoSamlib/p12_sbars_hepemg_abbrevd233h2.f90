module     p12_sbars_hepemg_abbrevd233h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb233(4)=NC**(-1)
      abb233(5)=gSl*gHZZ*spak1k4*c1*i_*TR*ger*abb233(3)*abb233(2)*abb233(1)
      abb233(6)=abb233(4)*abb233(5)*spbk6k5
      abb233(7)=spae6k6*spbe6k2
      abb233(8)=abb233(7)*abb233(6)
      abb233(9)=abb233(5)*NC
      abb233(10)=abb233(9)*spbk6k5
...
end module p12_sbars_hepemg_abbrevd233h2
