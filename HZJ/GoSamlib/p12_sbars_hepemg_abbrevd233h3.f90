module     p12_sbars_hepemg_abbrevd233h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb233(4)=NC**(-1)
      abb233(5)=gSr*gHZZ*spbk5k1*c1*i_*TR*ger*abb233(3)*abb233(2)*abb233(1)
      abb233(6)=abb233(4)*abb233(5)*spak4k6
      abb233(7)=spbk6e6*spak2e6
      abb233(8)=abb233(7)*abb233(6)
      abb233(9)=abb233(5)*NC
      abb233(10)=abb233(9)*spak4k6
...
end module p12_sbars_hepemg_abbrevd233h3
