module     p12_sbars_hepemg_abbrevd235h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb235(4)=gHZZ*c1*NC*i_*TR*gSr*ger*abb235(2)*abb235(1)
      abb235(5)=abb235(4)*spbk5k1
      abb235(6)=abb235(5)*spak2k4
      abb235(7)=abb235(6)*abb235(3)
      abb235(8)=-es61+es345-es12
      abb235(9)=abb235(7)*abb235(8)
      abb235(10)=abb235(5)*spak4k6
      ...
      abb235(14)=spbk6k5*spak2k6
      abb235(15)=abb235(4)*spbk6k1
      abb235(16)=spak4k6*abb235(15)
      abb235(17)=-abb235(16)*abb235(14)
      abb235(18)=spbk6k1*spak4k6
      ...
      abb235(18)=spak2e6*spbe6k5*abb235(18)*abb235(17)
      ...
      abb235(11)=spae6k6*spbk6k5
      abb235(25)=-spbk5k2*spak2e6
      abb235(11)=abb235(25)+abb235(11)
      abb235(11)=abb235(16)*abb235(11)
      abb235(25)=abb235(5)*spak4e6
...
end module p12_sbars_hepemg_abbrevd235h3
