module     p12_sbars_hepemg_abbrevd266h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb266(4)=NC**(-1)
      abb266(5)=gSl*gHZZ*spak1k5*c1*i_*TR*gel*abb266(3)*abb266(2)*abb266(1)
      abb266(6)=abb266(4)*abb266(5)*spbk6k4
      abb266(7)=spae6k6*spbe6k2
      abb266(8)=abb266(7)*abb266(6)
      abb266(9)=abb266(5)*NC
      abb266(10)=abb266(9)*spbk6k4
...
end module p12_sbars_hepemg_abbrevd266h0
