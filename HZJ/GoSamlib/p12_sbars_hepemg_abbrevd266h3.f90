module     p12_sbars_hepemg_abbrevd266h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb266(4)=NC**(-1)
      abb266(5)=gSr*gHZZ*spbk5k1*c1*i_*TR*ger*abb266(3)*abb266(2)*abb266(1)
      abb266(6)=abb266(4)*abb266(5)*spak4k6
      abb266(7)=spbk6e6*spak2e6
      abb266(8)=abb266(7)*abb266(6)
      abb266(9)=abb266(5)*NC
      abb266(10)=abb266(9)*spak4k6
...
end module p12_sbars_hepemg_abbrevd266h3
