...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb277(18)=spak2e6*spbk5k1
      abb277(17)=abb277(18)*abb277(17)
      abb277(19)=1.0_ki/2.0_ki*spak4e6
      abb277(20)=spbe6k5*spak2k4
      abb277(21)=spbk4k1*abb277(20)*abb277(19)
      abb277(22)=spak2e6*spbe6k5
      abb277(23)=abb277(11)*abb277(22)
      abb277(24)=spak4e6*spbk5k1
      abb277(25)=spbe6k4*spak2k4*abb277(24)
      ...
      abb277(28)=spbe6k1*spak2k4
      abb277(27)=abb277(28)*abb277(27)
      abb277(16)=spak2k5*abb277(24)*abb277(16)
      abb277(29)=spbe6k1*spak4e6
      abb277(30)=abb277(10)*abb277(29)
      abb277(31)=spak5e6*spbk5k1*abb277(20)
      ...
      abb277(30)=spbk6k5*spak2k4
      abb277(31)=spae6k6*spbe6k1
      abb277(32)=abb277(30)*abb277(31)
      abb277(33)=abb277(27)*abb277(32)
      abb277(34)=spak4k6*spbk5k1
      abb277(35)=spbk6e6*spak2e6
      ...
      abb277(40)=abb277(25)+abb277(23)
      abb277(41)=spbe6k5*abb277(40)*spak4e6
      abb277(42)=spak2k6*abb277(41)
      abb277(26)=2.0_ki/3.0_ki*abb277(42)-1.0_ki/3.0_ki*abb277(39)-1.0_ki/2.0_k&
      &i*abb277(26)
      abb277(26)=spbk6k1*abb277(26)
      abb277(39)=abb277(5)*abb277(38)
      abb277(42)=abb277(37)*abb277(24)
      abb277(43)=abb277(6)*abb277(42)
      abb277(39)=abb277(39)-abb277(43)
      abb277(43)=spbk6e6*abb277(42)
      abb277(44)=abb277(19)*spbe6k1
      abb277(27)=-spbk6k5*abb277(27)*abb277(44)
      abb277(27)=1.0_ki/3.0_ki*abb277(43)+abb277(27)
      abb277(27)=spak2k6*abb277(27)
      abb277(43)=abb277(40)*spbk5k1
      abb277(45)=abb277(43)*spak2k4
      abb277(46)=abb277(4)*abb277(45)
      abb277(47)=abb277(9)*abb277(41)
      abb277(16)=1.0_ki/3.0_ki*abb277(47)-2.0_ki/3.0_ki*abb277(46)+abb277(26)+1&
      &.0_ki/2.0_ki*abb277(33)+abb277(27)+abb277(16)+abb277(17)-1.0_ki/6.0_ki*a&
      &bb277(39)
      abb277(17)=abb277(32)-abb277(36)
      abb277(17)=abb277(37)*abb277(17)
      abb277(26)=spbk2k1*spak2e6
      abb277(27)=-abb277(38)*abb277(26)
      abb277(33)=spak1k2*spbe6k1
      abb277(39)=-abb277(42)*abb277(33)
      ...
      abb277(48)=abb277(15)*abb277(14)*spbk5k2*mH**2*spak2k4*abb277(21)
      ...
      abb277(48)=abb277(30)*spbk2k1
      abb277(49)=abb277(23)*spak2k6*abb277(48)
      abb277(50)=abb277(34)*spak1k2
      ...
      abb277(49)=abb277(23)+3.0_ki*abb277(25)
      abb277(51)=-abb277(49)*abb277(32)
      abb277(52)=2.0_ki*abb277(40)
      abb277(53)=-abb277(36)*abb277(52)
      abb277(51)=abb277(51)+abb277(53)
      abb277(53)=8.0_ki*abb277(45)
      abb277(32)=-abb277(32)*abb277(52)
      abb277(52)=abb277(25)+3.0_ki*abb277(23)
      abb277(36)=-abb277(52)*abb277(36)
      ...
      abb277(58)=1.0_ki/2.0_ki*abb277(49)
      ...
      abb277(39)=-abb277(55)*abb277(39)*spak2k4
      abb277(62)=abb277(37)*abb277(30)
      abb277(47)=abb277(47)*abb277(58)
      abb277(63)=spbk5k1*abb277(47)
      abb277(46)=abb277(46)*abb277(59)
      abb277(26)=-abb277(37)*abb277(26)
      abb277(60)=spbk6k1*abb277(60)
      abb277(26)=abb277(26)+abb277(60)
      abb277(60)=abb277(37)*spbe6k1
      abb277(64)=-spak1k2*abb277(60)
      abb277(61)=-spak2k6*abb277(61)
      abb277(61)=abb277(64)+abb277(61)
      abb277(64)=-abb277(35)*abb277(59)
      abb277(25)=abb277(22)*abb277(25)
      abb277(47)=-spbk6k5*abb277(47)
      abb277(25)=abb277(25)+abb277(47)
      abb277(47)=spak1k2*spbk5k1*abb277(49)
      abb277(65)=spak2k6*spbk6k5*abb277(37)
      ...
      abb277(35)=spak2k4*abb277(52)*spbk2k1
      abb277(68)=-spbk6k1*spak4k6*abb277(37)
      abb277(35)=2.0_ki*abb277(35)+abb277(68)
      abb277(68)=spak4e6*abb277(60)
      abb277(44)=-abb277(52)*abb277(44)
      abb277(29)=spbk5k2*abb277(29)
      abb277(31)=spak1k4*spbk6k5*abb277(31)
      abb277(29)=abb277(31)+abb277(29)
      abb277(29)=abb277(40)*abb277(29)
      abb277(27)=-abb277(27)*abb277(41)
      abb277(31)=abb277(58)*spae6k6
      abb277(30)=spbe6k2*abb277(30)*abb277(31)
      abb277(34)=spak1e6*abb277(55)*abb277(34)*spbk6e6
      abb277(27)=abb277(34)+abb277(30)+abb277(27)+abb277(29)
      abb277(29)=-spak4k6*spbk6k5
      abb277(30)=spbk5k2*spak2k4
      abb277(29)=abb277(29)+abb277(30)
      abb277(29)=abb277(40)*abb277(29)
      abb277(30)=spak1k4*abb277(43)
      abb277(29)=abb277(30)+abb277(29)
      abb277(29)=4.0_ki*abb277(29)
      abb277(30)=4.0_ki*abb277(41)
      abb277(34)=2.0_ki*abb277(41)
      abb277(40)=abb277(52)*spbk6e6
      abb277(41)=spak4k6*abb277(40)
      abb277(43)=spak1k4*abb277(60)
      abb277(52)=spbe6k2*spak2k4*abb277(37)
      abb277(41)=abb277(52)+abb277(41)+abb277(43)
      abb277(41)=1.0_ki/2.0_ki*abb277(41)
      abb277(43)=-spbk5k2*spak2e6
      abb277(52)=-spak1e6*spbk5k1
      abb277(43)=abb277(52)+abb277(43)
      abb277(37)=abb277(37)*abb277(43)
      abb277(43)=spbk6k5*spae6k6*abb277(49)
      abb277(37)=abb277(43)+abb277(37)
      abb277(37)=1.0_ki/2.0_ki*abb277(37)
      abb277(20)=abb277(20)*abb277(59)
      abb277(43)=-spbk5k2*spak4e6*abb277(59)
      abb277(49)=spak1k4*spbe6k5*abb277(59)
      abb277(24)=-abb277(24)*abb277(59)
      abb277(19)=abb277(19)*abb277(40)
      abb277(31)=spbe6k5*abb277(31)
      R2d277=abb277(16)
      rat2 = rat2 + R2d277
