module     p12_sbars_hepemg_abbrevd27h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb27(7)=spak1k4*spbk5k2
      abb27(6)=abb27(7)*abb27(6)
      abb27(8)=abb27(17)*spak1k4
      ...
      abb27(52)=abb27(22)*spbk5k1
      abb27(53)=abb27(29)*spak1k4
      ...
      abb27(37)=spak2k4*spbe6k2
      abb27(52)=spbe6k1*spak1k4
      ...
      abb27(52)=spbe6k5*spak1k4*abb27(12)
      abb27(64)=abb27(8)*spbe6k5
      abb27(65)=2.0_ki*abb27(64)
      abb27(66)=spak4e6*spbk5k2
      ...
      abb27(8)=2.0_ki*spbk6k5*abb27(8)
      abb27(70)=abb27(60)*spae6k6
      abb27(71)=-spbk5k2*abb27(38)*abb27(70)
      ...
      abb27(79)=-spak4k6*spbk5k2*abb27(41)
...
end module p12_sbars_hepemg_abbrevd27h2
