...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
     ...
     & only: init_lo, rat2
      use p12_sbars_hepemg_abbrevd235h0, only: init_abbrevd235 => init_abbrev
      use p12_sbars_hepemg_abbrevd145h0, only: init_abbrevd145 => init_abbrev
      use p12_sbars_hepemg_abbrevd154h0, only: init_abbrevd154 => init_abbrev
      use p12_sbars_hepemg_abbrevd196h0, only: init_abbrevd196 => init_abbrev
      use p12_sbars_hepemg_abbrevd234h0, only: init_abbrevd234 => init_abbrev
      use p12_sbars_hepemg_abbrevd266h0, only: init_abbrevd266 => init_abbrev
      use p12_sbars_hepemg_abbrevd150h0, only: init_abbrevd150 => init_abbrev
      use p12_sbars_hepemg_abbrevd193h0, only: init_abbrevd193 => init_abbrev
      use p12_sbars_hepemg_abbrevd233h0, only: init_abbrevd233 => init_abbrev
      use p12_sbars_hepemg_abbrevd268h0, only: init_abbrevd268 => init_abbrev
      use p12_sbars_hepemg_abbrevd55h0, only: init_abbrevd55 => init_abbrev
      use p12_sbars_hepemg_abbrevd244h0, only: init_abbrevd244 => init_abbrev
      use p12_sbars_hepemg_abbrevd43h0, only: init_abbrevd43 => init_abbrev
      use p12_sbars_hepemg_abbrevd27h0, only: init_abbrevd27 => init_abbrev
      use p12_sbars_hepemg_abbrevd143h0, only: init_abbrevd143 => init_abbrev
      use p12_sbars_hepemg_diagramsh0l0, only: amplitudel0 => amplitude
      use p12_sbars_hepemg_groups
      implicit none
      real(ki), intent(in) :: scale2
