...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p12_sbars_hepemg_abbrevd130h3
      implicit none
...
!---#] subroutine reconstruct_d130:
end module     p12_sbars_hepemg_d130h3l1d
