...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc134(11)=abb134(17)
      acc134(12)=abb134(18)
      acc134(13)=acc134(6)*Qspvak1k6
      acc134(14)=Qspe6*acc134(3)
      acc134(15)=Qspvae6k2*acc134(10)
      ...
      acc134(17)=acc134(4)*Qspvak1k5
      acc134(18)=Qspe6*acc134(2)
      acc134(19)=Qspvae6k2*acc134(5)
...
!           & sign => diagram134_sign, shift => diagram134_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p12_sbars_hepemg_d134h2l1
