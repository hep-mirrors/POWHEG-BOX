...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p12_sbars_hepemg_abbrevd167h1
      implicit none
      ...
      acd167(6)=abb167(9)
      acd167(7)=dotproduct(qshift,spvak2k4)
      acd167(8)=abb167(6)
...
!---#] subroutine reconstruct_d167:
end module     p12_sbars_hepemg_d167h1l1d
