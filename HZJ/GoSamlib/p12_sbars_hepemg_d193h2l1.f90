module     p12_sbars_hepemg_d193h2l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p12_sbars_hepemg/helicity2d193h2l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc193(6)=abb193(12)
      acc193(7)=abb193(15)
      acc193(8)=Qspvak6k1*acc193(5)
      acc193(9)=Qspvak4k5*acc193(4)
      acc193(10)=Qspvak4k2*acc193(2)
      acc193(11)=Qspvak1k6*acc193(1)
...
!           & sign => diagram193_sign, shift => diagram193_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p12_sbars_hepemg_d193h2l1
