module     p12_sbars_hepemg_d196h2l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p12_sbars_hepemg/helicity2d196h2l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc196(5)=abb196(9)
      acc196(6)=abb196(10)
      acc196(7)=Qspvae6k2*acc196(3)
      acc196(8)=Qspvak2k6*acc196(1)
      acc196(9)=Qspe6*acc196(2)
      acc196(10)=Qspk6*acc196(5)
      acc196(11)=Qspk2*acc196(4)
...
!           & sign => diagram196_sign, shift => diagram196_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p12_sbars_hepemg_d196h2l1
