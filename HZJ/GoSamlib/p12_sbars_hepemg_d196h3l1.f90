module     p12_sbars_hepemg_d196h3l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p12_sbars_hepemg/helicity3d196h3l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc196(9)=acc196(3)*Qspvak2e6
      acc196(10)=acc196(2)*Qspe6
      acc196(11)=acc196(1)*Qspvak6k2
...
!           & sign => diagram196_sign, shift => diagram196_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p12_sbars_hepemg_d196h3l1
