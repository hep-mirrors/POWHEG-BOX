...
!           & sign => diagram235_sign, shift => diagram235_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p12_sbars_hepemg_d235h3l1
