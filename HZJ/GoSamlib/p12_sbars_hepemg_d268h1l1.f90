module     p12_sbars_hepemg_d268h1l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p12_sbars_hepemg/helicity1d268h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc268(12)=abb268(19)
      acc268(13)=abb268(20)
      acc268(14)=acc268(4)*Qspk1
      acc268(15)=acc268(7)*Qspvak2k4
      acc268(16)=acc268(10)*Qspvak5k4
      acc268(17)=acc268(13)*Qspk6
      acc268(18)=Qspvak6k1*acc268(11)
      acc268(14)=acc268(18)+acc268(17)+acc268(16)+acc268(15)+acc268(6)+acc268(1&
      &4)
      acc268(14)=Qspe6*acc268(14)
      acc268(15)=acc268(1)*Qspk1
      acc268(16)=acc268(2)*Qspvak2k4
      acc268(17)=acc268(5)*Qspk6
      acc268(18)=acc268(12)*Qspvak5k4
      acc268(19)=Qspvae6k1*acc268(8)
      acc268(20)=QspQ*acc268(3)
...
!           & sign => diagram268_sign, shift => diagram268_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p12_sbars_hepemg_d268h1l1
