module     p12_sbars_hepemg_diagramsh2l0
   ! file: /home/oleari/fortran/POWHEG-BOX-trunk/HZJ/GoSam_POWHEG/Virtual/p12_sbars_hepemg/helicity2diagramsl0.f90 
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(5)=-spbe6k1*spak1k4
      abb(6)=spak4k6*spbk6e6
      abb(5)=abb(6)+abb(5)
      abb(5)=abb(3)*abb(5)*spbk5k2*spak1e6
      abb(6)=-spbk6k5*spbe6k2*spae6k6*abb(4)*spak1k4
      abb(5)=abb(6)+abb(5)
      abb(5)=2.0_ki*abb(2)*abb(1)*abb(5)*i_*gHZZ*gSl*ger
