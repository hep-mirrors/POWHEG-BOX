module     p16_bbarb_hepemg_abbrevd134h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb134(4)=NC**(-1)
      abb134(5)=spbk6e6*spbk5k1
      abb134(6)=abb134(5)*spak4k6
      abb134(7)=NC-abb134(4)
      abb134(7)=abb134(7)*gBr*gHZZ*c1*i_*TR*ger*abb134(3)*abb134(2)*abb134(1)
      abb134(8)=spak2e6*abb134(7)
      abb134(9)=abb134(6)*abb134(8)
      abb134(10)=spbk2k1*spak2k4
      ...
      abb134(10)=spbk5k2*abb134(10)
      abb134(11)=abb134(11)*abb134(19)
      abb134(19)=-abb134(8)*spak4k6*spbk5k1
      ...
      abb134(8)=spbk5k2*abb134(12)*abb134(8)
      R2d134=abb134(9)
      rat2 = rat2 + R2d134
...
end module p16_bbarb_hepemg_abbrevd134h3
