module     p16_bbarb_hepemg_abbrevd193h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb193(3)=NC**(-1)
      abb193(4)=es61**(-1)
      abb193(5)=gHZZ*spbe6k1*c1*i_*TR*gBr*ger*abb193(2)*abb193(1)
      ...
      abb193(8)=abb193(8)*abb193(11)
      abb193(10)=spak4k6*abb193(10)
      abb193(6)=-spak1k4*abb193(6)
...
end module p16_bbarb_hepemg_abbrevd193h3
