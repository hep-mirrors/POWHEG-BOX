module     p16_bbarb_hepemg_abbrevd268h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb268(8)=spbk6e6*spak4k6
      abb268(9)=spak1k4*spbe6k1
      abb268(10)=abb268(8)-abb268(9)
      abb268(7)=abb268(10)*abb268(7)
      abb268(10)=gBl*ger*abb268(1)*abb268(2)*gHZZ*c1*TR*i_
      abb268(11)=abb268(10)*abb268(4)
      abb268(12)=spbk5k2*abb268(11)
      abb268(13)=-abb268(7)*abb268(12)
      abb268(14)=-2.0_ki*abb268(8)+abb268(9)
      abb268(14)=abb268(14)*abb268(6)*abb268(10)*spbk5k2
      abb268(15)=NC*spak1k4
      abb268(16)=abb268(3)*spak1k4
      abb268(15)=abb268(15)+abb268(16)
      abb268(10)=4.0_ki*abb268(10)
      abb268(10)=-spbk5k2*abb268(15)*abb268(10)
      abb268(17)=abb268(9)*spak1e6
      abb268(18)=spbk6e6*spak1k6
      abb268(19)=abb268(18)*spak4e6
...
end module p16_bbarb_hepemg_abbrevd268h2
