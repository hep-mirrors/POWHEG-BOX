...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb277(18)=spak1e6*spbk4k2
      abb277(17)=abb277(18)*abb277(17)
      abb277(19)=1.0_ki/2.0_ki*spak5e6
      abb277(20)=spbe6k4*spak1k5
      abb277(21)=spbk5k2*abb277(20)*abb277(19)
      abb277(22)=spak1e6*spbe6k4
      abb277(23)=abb277(11)*abb277(22)
      abb277(24)=spak5e6*spbk4k2
      abb277(25)=spbe6k5*spak1k5*abb277(24)
      ...
      abb277(27)=spbe6k2*spak1k5
      abb277(19)=abb277(27)*abb277(19)
      abb277(28)=spak1k4*abb277(24)*abb277(16)
      abb277(29)=spbe6k2*spak5e6
      abb277(30)=abb277(10)*abb277(29)
      abb277(31)=spak4e6*spbk4k2*abb277(20)
      ...
      abb277(30)=spak5k6*spbk4k2
      abb277(31)=spbk6e6*spak1e6
      abb277(32)=abb277(30)*abb277(31)
      abb277(33)=abb277(26)*abb277(32)
      abb277(34)=spbk6k4*spak1k5
      abb277(35)=spae6k6*spbe6k2
      ...
      abb277(41)=spak5e6*abb277(40)*spbe6k4
      abb277(42)=spbk6k2*abb277(41)
      abb277(28)=2.0_ki/3.0_ki*abb277(42)+1.0_ki/3.0_ki*abb277(39)-1.0_ki/2.0_k&
      &i*abb277(28)
      abb277(28)=spak1k6*abb277(28)
      abb277(39)=abb277(5)*abb277(38)
      abb277(42)=abb277(37)*abb277(20)
      abb277(43)=abb277(6)*abb277(42)
      abb277(39)=abb277(39)-abb277(43)
      abb277(43)=spae6k6*abb277(42)
      abb277(44)=abb277(16)*spak1e6
      abb277(26)=-spak5k6*abb277(26)*abb277(44)
      abb277(26)=-1.0_ki/3.0_ki*abb277(43)+abb277(26)
      abb277(26)=spbk6k2*abb277(26)
      abb277(43)=abb277(40)*spak1k5
      abb277(45)=abb277(43)*spbk4k2
      abb277(46)=abb277(4)*abb277(45)
      abb277(47)=abb277(9)*abb277(41)
      abb277(17)=1.0_ki/3.0_ki*abb277(47)-2.0_ki/3.0_ki*abb277(46)+abb277(28)+1&
      &.0_ki/2.0_ki*abb277(33)+abb277(26)+abb277(19)+abb277(17)+1.0_ki/6.0_ki*a&
      &bb277(39)
      abb277(19)=-abb277(32)+abb277(36)
      abb277(19)=abb277(37)*abb277(19)
      abb277(26)=spbk2k1*spak1e6
      abb277(28)=abb277(42)*abb277(26)
      ...
      abb277(48)=-abb277(15)*abb277(14)*spak2k5*mH**2*spbk4k2*abb277(21)
      ...
      abb277(48)=abb277(30)*spak1k2
      abb277(49)=spbk6k2*abb277(25)*abb277(48)
      abb277(50)=abb277(34)*spbk2k1
      ...
      abb277(49)=abb277(25)+3.0_ki*abb277(23)
      ...
      abb277(67)=spbk2k1*spak1k5*abb277(49)
      abb277(68)=-spbk6k2*spak5k6*abb277(37)
      abb277(67)=-2.0_ki*abb277(67)+abb277(68)
      abb277(68)=abb277(37)*abb277(29)
      abb277(29)=-abb277(58)*abb277(29)
      abb277(35)=spak2k5*spbk6k4*abb277(35)
      abb277(31)=spbk4k1*abb277(31)
      abb277(31)=abb277(31)+abb277(35)
      abb277(31)=abb277(40)*abb277(31)
      abb277(28)=-abb277(28)*abb277(41)
      abb277(35)=abb277(58)*spbk6e6
      abb277(30)=spak2e6*abb277(30)*abb277(35)
      abb277(34)=spbe6k1*abb277(55)*abb277(34)*spae6k6
      abb277(28)=abb277(34)+abb277(30)+abb277(28)+abb277(31)
      abb277(30)=-spbk6k4*spak5k6
      abb277(31)=spak2k5*spbk4k2
      abb277(30)=abb277(30)+abb277(31)
      abb277(30)=abb277(40)*abb277(30)
      abb277(31)=spbk4k1*abb277(43)
      abb277(30)=abb277(31)+abb277(30)
      abb277(30)=4.0_ki*abb277(30)
      abb277(31)=4.0_ki*abb277(41)
      abb277(34)=2.0_ki*abb277(41)
      abb277(40)=abb277(52)*spae6k6
      abb277(41)=spbk6k4*abb277(40)
      abb277(43)=-spbk4k1*abb277(60)
      abb277(52)=-spak2e6*spbk4k2*abb277(37)
      abb277(41)=abb277(52)+abb277(41)+abb277(43)
      abb277(41)=1.0_ki/2.0_ki*abb277(41)
      abb277(43)=spak2k5*spbe6k2
      abb277(52)=spbe6k1*spak1k5
      abb277(43)=abb277(52)+abb277(43)
      abb277(37)=abb277(37)*abb277(43)
      abb277(43)=spak5k6*spbk6e6*abb277(49)
      abb277(37)=abb277(43)+abb277(37)
      abb277(37)=1.0_ki/2.0_ki*abb277(37)
      abb277(43)=spak2k5*spbe6k4*abb277(59)
      abb277(24)=-abb277(24)*abb277(59)
      abb277(20)=abb277(20)*abb277(59)
      abb277(49)=-spbk4k1*spak5e6*abb277(59)
      abb277(35)=spak5e6*abb277(35)
      abb277(16)=abb277(16)*abb277(40)
      R2d277=abb277(17)
      rat2 = rat2 + R2d277
