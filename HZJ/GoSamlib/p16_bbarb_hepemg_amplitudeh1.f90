...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
     ...
     & only: init_lo, rat2
      use p16_bbarb_hepemg_abbrevd235h1, only: init_abbrevd235 => init_abbrev
      use p16_bbarb_hepemg_abbrevd145h1, only: init_abbrevd145 => init_abbrev
      use p16_bbarb_hepemg_abbrevd154h1, only: init_abbrevd154 => init_abbrev
      use p16_bbarb_hepemg_abbrevd196h1, only: init_abbrevd196 => init_abbrev
      use p16_bbarb_hepemg_abbrevd234h1, only: init_abbrevd234 => init_abbrev
      use p16_bbarb_hepemg_abbrevd266h1, only: init_abbrevd266 => init_abbrev
      use p16_bbarb_hepemg_abbrevd150h1, only: init_abbrevd150 => init_abbrev
      use p16_bbarb_hepemg_abbrevd193h1, only: init_abbrevd193 => init_abbrev
      use p16_bbarb_hepemg_abbrevd233h1, only: init_abbrevd233 => init_abbrev
      use p16_bbarb_hepemg_abbrevd268h1, only: init_abbrevd268 => init_abbrev
      use p16_bbarb_hepemg_abbrevd55h1, only: init_abbrevd55 => init_abbrev
      use p16_bbarb_hepemg_abbrevd244h1, only: init_abbrevd244 => init_abbrev
      use p16_bbarb_hepemg_abbrevd43h1, only: init_abbrevd43 => init_abbrev
      use p16_bbarb_hepemg_abbrevd27h1, only: init_abbrevd27 => init_abbrev
      use p16_bbarb_hepemg_abbrevd143h1, only: init_abbrevd143 => init_abbrev
      use p16_bbarb_hepemg_diagramsh1l0, only: amplitudel0 => amplitude
      use p16_bbarb_hepemg_groups
      implicit none
      real(ki), intent(in) :: scale2
      ...
      call init_abbrevd154()
      call init_abbrevd196()
      call init_abbrevd234()
      call init_abbrevd266()
      call init_abbrevd150()
      call init_abbrevd193()
      call init_abbrevd233()
      call init_abbrevd268()
      call init_abbrevd55()
      call init_abbrevd244()
      call init_abbrevd43()
      call init_abbrevd27()
      call init_abbrevd143()
      epspow=0
      samplitude(-2) = 0.0_ki
      samplitude(-1) = 0.0_ki
