...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p16_bbarb_hepemg_abbrevd167h3
      implicit none
      ...
      acd167(6)=abb167(9)
      acd167(7)=dotproduct(qshift,spvak2k5)
      acd167(8)=abb167(6)
...
!---#] subroutine reconstruct_d167:
end module     p16_bbarb_hepemg_d167h3l1d
