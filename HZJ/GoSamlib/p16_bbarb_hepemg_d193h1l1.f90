module     p16_bbarb_hepemg_d193h1l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p16_bbarb_hepemg/helicity1d193h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p16_bbarb_hepemg_abbrevd193h1
      implicit none
      ...
      acc193(6)=abb193(12)
      acc193(7)=abb193(15)
      acc193(8)=acc193(7)*Qspk1
      acc193(9)=acc193(6)*Qspk6
      acc193(10)=acc193(5)*Qspvak1k6
      acc193(11)=acc193(4)*Qspvak5k4
      acc193(12)=acc193(2)*Qspvak2k4
      acc193(13)=acc193(1)*Qspvak6k1
...
!           & sign => diagram193_sign, shift => diagram193_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p16_bbarb_hepemg_d193h1l1
