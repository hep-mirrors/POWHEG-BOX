...
!           & sign => diagram205_sign, shift => diagram205_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p16_bbarb_hepemg_d205h2l1
