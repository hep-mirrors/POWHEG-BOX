module     p16_bbarb_hepemg_d266h3l1d
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p16_bbarb_hepemg/helicity3d266h3l1d.f90
...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p16_bbarb_hepemg_abbrevd266h3
      implicit none
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd266(10)=abb266(5)
      acd266(11)=spvak2e6(iv1)
      acd266(12)=abb266(18)
      acd266(13)=acd266(2)*acd266(1)
      acd266(14)=acd266(4)*acd266(3)
      acd266(15)=acd266(6)*acd266(5)
      acd266(16)=acd266(8)*acd266(7)
      acd266(17)=acd266(10)*acd266(9)
      acd266(18)=acd266(12)*acd266(11)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      acd266(6)=k2(iv2)
      acd266(7)=e6(iv1)
      acd266(8)=spvak2k6(iv2)
      acd266(9)=abb266(6)
      acd266(10)=spvak2k6(iv1)
...
!---#] subroutine reconstruct_d266:
end module     p16_bbarb_hepemg_d266h3l1d
