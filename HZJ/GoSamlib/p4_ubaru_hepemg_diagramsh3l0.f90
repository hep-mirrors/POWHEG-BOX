module     p4_ubaru_hepemg_diagramsh3l0
   ! file: /home/oleari/fortran/POWHEG-BOX-trunk/HZJ/GoSam_POWHEG/Virtual/p4_ubaru_hepemg/helicity3diagramsl0.f90 
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(5)=abb(6)+abb(5)
      abb(5)=2.0_ki*abb(2)*abb(1)*abb(5)*i_*gHZZ*gUr*ger
