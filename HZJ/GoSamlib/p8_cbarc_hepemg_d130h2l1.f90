...
!           & sign => diagram130_sign, shift => diagram130_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p8_cbarc_hepemg_d130h2l1
