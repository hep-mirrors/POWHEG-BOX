...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc167(10)=acc167(5)*Qspvak6k1
      acc167(11)=acc167(4)*Qspvak4k5
      acc167(12)=acc167(2)*Qspvak4k2
      acc167(13)=acc167(1)*Qspvak1k6
...
!           & sign => diagram167_sign, shift => diagram167_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p8_cbarc_hepemg_d167h2l1
