module     p8_cbarc_hepemg_diagramsh1l0
   ! file: /home/oleari/fortran/POWHEG-BOX-trunk/HZJ/GoSam_POWHEG/Virtual/p8_cbarc_hepemg/helicity1diagramsl0.f90 
...
!      complex(ki), dimension(2,numcs) :: diagrams
      ...
      abb(5)=-spak1e6*spbk4k1
      abb(6)=spbk6k4*spae6k6
      abb(5)=abb(6)+abb(5)
      abb(5)=abb(3)*abb(5)*spak2k5*spbe6k1
      abb(6)=-spak5k6*spak2e6*spbk6e6*abb(4)*spbk4k1
      abb(5)=abb(6)+abb(5)
      abb(5)=2.0_ki*abb(2)*abb(1)*abb(5)*i_*gHZZ*gCr*gel
