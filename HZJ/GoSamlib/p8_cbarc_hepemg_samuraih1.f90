...
function     numeval_group0(icut, Q, mu2) result(num)
   ...
   use p8_cbarc_hepemg_d235h1l1, only: numerator_d235 => numerator_samurai
   implicit none
...
function     numeval_group1(icut, Q, mu2) result(num)
   use p8_cbarc_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p8_cbarc_hepemg_model
   use p8_cbarc_hepemg_d145h1l1, only: numerator_d145 => numerator_samurai
   use p8_cbarc_hepemg_d154h1l1, only: numerator_d154 => numerator_samurai
   use p8_cbarc_hepemg_d196h1l1, only: numerator_d196 => numerator_samurai
   use p8_cbarc_hepemg_d234h1l1, only: numerator_d234 => numerator_samurai
   use p8_cbarc_hepemg_d266h1l1, only: numerator_d266 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group2(icut, Q, mu2) result(num)
   use p8_cbarc_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p8_cbarc_hepemg_model
   use p8_cbarc_hepemg_d150h1l1, only: numerator_d150 => numerator_samurai
   use p8_cbarc_hepemg_d193h1l1, only: numerator_d193 => numerator_samurai
   use p8_cbarc_hepemg_d233h1l1, only: numerator_d233 => numerator_samurai
   use p8_cbarc_hepemg_d268h1l1, only: numerator_d268 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group3(icut, Q, mu2) result(num)
   use p8_cbarc_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p8_cbarc_hepemg_model
   use p8_cbarc_hepemg_d55h1l1, only: numerator_d55 => numerator_samurai
   use p8_cbarc_hepemg_d244h1l1, only: numerator_d244 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group4(icut, Q, mu2) result(num)
   use p8_cbarc_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p8_cbarc_hepemg_model
   use p8_cbarc_hepemg_d43h1l1, only: numerator_d43 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
function     numeval_group5(icut, Q, mu2) result(num)
   use p8_cbarc_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p8_cbarc_hepemg_model
   use p8_cbarc_hepemg_d27h1l1, only: numerator_d27 => numerator_samurai
   use p8_cbarc_hepemg_d143h1l1, only: numerator_d143 => numerator_samurai
   implicit none
   integer, intent(in) :: icut
   complex(ki_sam), dimension(4), intent(in) :: Q
   complex(ki_sam), intent(in) :: mu2
...
subroutine     reduce_group0(scale2,tot,totr,ok)
   ...
   use p8_cbarc_hepemg_model
   use p8_cbarc_hepemg_d235h1l1, only: numerator_diagram235 => numerator_samurai
...
subroutine     reduce_group1(scale2,tot,totr,ok)
   ...
   use p8_cbarc_hepemg_kinematics
   use p8_cbarc_hepemg_model
   use p8_cbarc_hepemg_d145h1l1, only: numerator_diagram145 => numerator_samurai
   use p8_cbarc_hepemg_d154h1l1, only: numerator_diagram154 => numerator_samurai
   use p8_cbarc_hepemg_d196h1l1, only: numerator_diagram196 => numerator_samurai
   use p8_cbarc_hepemg_d234h1l1, only: numerator_diagram234 => numerator_samurai
   use p8_cbarc_hepemg_d266h1l1, only: numerator_diagram266 => numerator_samurai
   use p8_cbarc_hepemg_globalsl1, only: epspow
...
subroutine     reduce_group2(scale2,tot,totr,ok)
   ...
   use p8_cbarc_hepemg_kinematics
   use p8_cbarc_hepemg_model
   use p8_cbarc_hepemg_d150h1l1, only: numerator_diagram150 => numerator_samurai
   use p8_cbarc_hepemg_d193h1l1, only: numerator_diagram193 => numerator_samurai
   use p8_cbarc_hepemg_d233h1l1, only: numerator_diagram233 => numerator_samurai
   use p8_cbarc_hepemg_d268h1l1, only: numerator_diagram268 => numerator_samurai
   use p8_cbarc_hepemg_globalsl1, only: epspow
...
subroutine     reduce_group3(scale2,tot,totr,ok)
   ...
   use p8_cbarc_hepemg_kinematics
   use p8_cbarc_hepemg_model
   use p8_cbarc_hepemg_d55h1l1, only: numerator_diagram55 => numerator_samurai
   use p8_cbarc_hepemg_d244h1l1, only: numerator_diagram244 => numerator_samurai
   use p8_cbarc_hepemg_globalsl1, only: epspow
...
subroutine     reduce_group4(scale2,tot,totr,ok)
   ...
   use p8_cbarc_hepemg_kinematics
   use p8_cbarc_hepemg_model
   use p8_cbarc_hepemg_d43h1l1, only: numerator_diagram43 => numerator_samurai
   use p8_cbarc_hepemg_globalsl1, only: epspow
...
subroutine     reduce_group5(scale2,tot,totr,ok)
   ...
   use p8_cbarc_hepemg_kinematics
   use p8_cbarc_hepemg_model
   use p8_cbarc_hepemg_d27h1l1, only: numerator_diagram27 => numerator_samurai
   use p8_cbarc_hepemg_d143h1l1, only: numerator_diagram143 => numerator_samurai
   use p8_cbarc_hepemg_globalsl1, only: epspow
