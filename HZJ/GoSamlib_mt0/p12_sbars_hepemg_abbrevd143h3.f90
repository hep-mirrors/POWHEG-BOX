module     p12_sbars_hepemg_abbrevd143h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb143(10)=dotproduct(k3,spvak2k5)
      abb143(11)=dotproduct(k3,spvak4k1)
      abb143(12)=sqrt(mT**2)
      abb143(13)=1.0_ki/2.0_ki*spak4e6
      abb143(14)=spbk5k4*abb143(13)
      abb143(14)=abb143(14)+1.0_ki/4.0_ki*abb143(8)
      abb143(15)=spbe6k1*spak2k4
      abb143(14)=abb143(15)*abb143(14)
      abb143(16)=1.0_ki/2.0_ki*spbk5k1
      abb143(17)=spbe6k5*spak2k4
      abb143(16)=-spak5e6*abb143(17)*abb143(16)
      abb143(18)=1.0_ki/2.0_ki*spbe6k5
      abb143(19)=spak4e6*spbk5k1
      abb143(20)=spak2k5*abb143(19)*abb143(18)
      abb143(21)=spbe6k1*spak4e6
      ...
      abb143(24)=spak2e6*spbk5k1
      abb143(23)=abb143(24)*abb143(23)
      abb143(25)=1.0_ki/2.0_ki*spak2k4
      abb143(25)=-spbe6k4*abb143(19)*abb143(25)
      abb143(26)=spbk4k1*abb143(17)*abb143(13)
      abb143(27)=spak2e6*spbe6k5
      ...
      abb143(25)=-spak4k6*spak2e6*abb143(25)*abb143(18)
      ...
      abb143(22)=-spbk6k5*spbe6k1*abb143(22)*abb143(13)
      abb143(22)=-1.0_ki/3.0_ki*abb143(38)+abb143(22)
      abb143(22)=spak2k6*abb143(22)
      abb143(38)=abb143(35)*spbk5k1
      abb143(39)=abb143(38)*spak2k4
      ...
      abb143(40)=spbk2k1*spak2k4
      abb143(41)=abb143(20)*abb143(40)*spak2k6*spbk6k5
      abb143(42)=spak1k2*spbk5k1
      abb143(43)=-abb143(16)*abb143(42)*spbk6k1*spak4k6
      ...
      abb143(28)=abb143(16)+3.0_ki*abb143(20)
      ...
      abb143(48)=-spak2k4*abb143(48)*abb143(55)
      abb143(56)=abb143(32)*spbk6k5
      abb143(57)=-spak2k4*abb143(56)
      abb143(58)=abb143(29)*spae6k6
      abb143(51)=spbk5k1*abb143(51)*abb143(58)
      ...
      abb143(13)=spbk5k2*abb143(32)*abb143(13)
      abb143(18)=-spak1k4*abb143(32)*abb143(18)
      abb143(32)=1.0_ki/2.0_ki*abb143(37)
      abb143(28)=spbk6e6*abb143(28)
...
end module p12_sbars_hepemg_abbrevd143h3
