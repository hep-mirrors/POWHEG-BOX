module     p12_sbars_hepemg_abbrevd145h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb145(10)=dotproduct(k3,spvak2k5)
      abb145(11)=dotproduct(k3,spvak4k1)
      abb145(12)=1.0_ki/2.0_ki*spak2k4
      abb145(13)=spbk5k4*abb145(12)
      abb145(13)=abb145(13)-1.0_ki/4.0_ki*abb145(10)
      abb145(14)=spbe6k1*spak4e6
      abb145(13)=abb145(14)*abb145(13)
      abb145(15)=1.0_ki/2.0_ki*spbe6k5
      abb145(16)=spak4e6*spbk5k1
      abb145(17)=spak2k5*abb145(16)*abb145(15)
      abb145(18)=spbe6k1*spak2k4
      abb145(19)=abb145(8)*abb145(18)
      abb145(20)=spbe6k5*spak2k4
      abb145(21)=1.0_ki/2.0_ki*abb145(20)
      abb145(22)=-spak5e6*spbk5k1*abb145(21)
      ...
      abb145(24)=spak2e6*spbk5k1
      abb145(23)=abb145(24)*abb145(23)
      abb145(25)=-spbe6k4*abb145(16)*abb145(12)
      abb145(26)=abb145(11)*spak2e6*spbe6k5
      abb145(21)=spbk4k1*spak4e6*abb145(21)
      ...
      abb145(30)=abb145(29)*abb145(20)
      abb145(31)=spae6k6*abb145(30)
      abb145(23)=-spak4k6*abb145(23)*abb145(15)*spak2e6
      abb145(32)=abb145(19)+abb145(17)
      abb145(33)=spbe6k5*abb145(32)*spak4e6
      abb145(34)=spak2k6*abb145(33)
      abb145(23)=2.0_ki/3.0_ki*abb145(34)+1.0_ki/3.0_ki*abb145(31)+abb145(23)
      abb145(23)=spbk6k1*abb145(23)
      ...
      abb145(36)=1.0_ki/2.0_ki*spak4e6
      abb145(22)=-abb145(22)*abb145(36)*spbk6k5*spbe6k1
      abb145(22)=-1.0_ki/3.0_ki*abb145(35)+abb145(22)
      abb145(22)=spak2k6*abb145(22)
      abb145(35)=abb145(32)*spak2k4
      abb145(36)=abb145(35)*spbk5k1
      abb145(37)=abb145(4)*abb145(36)
      abb145(38)=abb145(9)*abb145(33)
      abb145(13)=1.0_ki/3.0_ki*abb145(38)-2.0_ki/3.0_ki*abb145(37)+abb145(23)+1&
      &.0_ki/2.0_ki*abb145(26)+abb145(22)+abb145(21)+abb145(13)+1.0_ki/6.0_ki*a&
      &bb145(31)
      abb145(21)=spbk2k1*spak2k4
      abb145(22)=abb145(19)*abb145(21)*spak2k6*spbk6k5
      abb145(23)=spak1k2*spbk5k1
      abb145(26)=-abb145(17)*abb145(23)*spbk6k1*spak4k6
      ...
      abb145(38)=abb145(19)+3.0_ki*abb145(17)
      abb145(39)=abb145(38)*abb145(25)
      abb145(40)=-abb145(18)*abb145(39)
      abb145(28)=abb145(40)-2.0_ki*abb145(28)
      abb145(40)=8.0_ki*abb145(36)
      abb145(41)=abb145(25)*spbe6k1
      abb145(42)=abb145(35)*abb145(41)
      abb145(17)=abb145(17)+3.0_ki*abb145(19)
      abb145(19)=abb145(17)*abb145(27)
      abb145(43)=-abb145(24)*abb145(19)
      abb145(42)=-2.0_ki*abb145(42)+abb145(43)
      abb145(36)=-4.0_ki*abb145(36)
      abb145(18)=abb145(18)*abb145(29)
      abb145(43)=abb145(17)*abb145(12)
      abb145(44)=spbe6k1*abb145(43)
      ...
      abb145(48)=abb145(27)*abb145(47)*abb145(23)
      abb145(43)=-abb145(43)*abb145(26)*spbk6e6
      abb145(49)=abb145(29)*spbk6k5
      abb145(50)=-spak2k4*abb145(49)
      abb145(51)=spae6k6*spbe6k1
      abb145(52)=abb145(51)*abb145(23)*abb145(46)
      abb145(53)=abb145(26)*abb145(29)
      abb145(54)=-spak2k6*spbk6e6*abb145(53)
      abb145(55)=abb145(29)*spbk6k1
      abb145(56)=-spak1k2*abb145(51)*abb145(55)
      abb145(54)=abb145(54)+abb145(56)
      abb145(54)=1.0_ki/2.0_ki*abb145(54)
      abb145(56)=-spbk6k1*spae6k6*abb145(47)
      abb145(53)=abb145(53)+abb145(56)
      abb145(37)=abb145(29)*abb145(37)
      abb145(56)=abb145(47)*spbk6e6
      abb145(57)=spak2k6*abb145(56)
      abb145(37)=abb145(37)+abb145(57)
      abb145(56)=spak2e6*abb145(56)
      abb145(46)=-spak1k2*abb145(41)*abb145(46)
      abb145(23)=abb145(23)*abb145(38)
      abb145(49)=-spak2k6*abb145(49)
      abb145(23)=-2.0_ki*abb145(23)+abb145(49)
      abb145(49)=abb145(29)*spak2e6
      abb145(57)=spbe6k5*abb145(49)
      abb145(38)=abb145(38)*abb145(15)
      abb145(58)=-spak2e6*abb145(38)
      abb145(59)=abb145(29)*spbk5k1
      abb145(60)=spak4k6*abb145(59)
      abb145(51)=-abb145(51)*abb145(47)
      abb145(61)=1.0_ki/2.0_ki*abb145(19)
      abb145(26)=abb145(26)*abb145(61)
      abb145(21)=abb145(17)*abb145(21)
      abb145(55)=spak4k6*abb145(55)
      abb145(21)=2.0_ki*abb145(21)+abb145(55)
      abb145(55)=-abb145(29)*abb145(14)
      abb145(17)=1.0_ki/2.0_ki*abb145(17)
      abb145(14)=-abb145(14)*abb145(17)
      abb145(27)=spbk5k2*spak2e6*abb145(27)
      abb145(41)=spak1k4*abb145(41)
      abb145(27)=abb145(27)+abb145(41)
      abb145(27)=abb145(32)*abb145(27)
      abb145(12)=spbe6k2*abb145(12)*abb145(39)
      abb145(41)=abb145(61)*spak1e6*spbk5k1
      abb145(12)=abb145(41)+abb145(12)+abb145(27)
      abb145(27)=-spak4k6*spbk6k5
      abb145(41)=spak1k4*spbk5k1
      abb145(27)=abb145(41)+abb145(27)
      abb145(27)=abb145(32)*abb145(27)
      abb145(32)=spbk5k2*abb145(35)
      abb145(27)=abb145(32)+abb145(27)
      abb145(27)=4.0_ki*abb145(27)
      abb145(32)=4.0_ki*abb145(33)
      abb145(33)=2.0_ki*abb145(33)
      abb145(35)=-spak1k4*spbe6k1
      abb145(41)=-spbe6k2*spak2k4
      abb145(35)=abb145(41)+abb145(35)
      abb145(35)=abb145(29)*abb145(35)
      abb145(19)=abb145(19)+abb145(35)
      abb145(19)=1.0_ki/2.0_ki*abb145(19)
      abb145(35)=spbk5k2*abb145(49)
      abb145(41)=spak1e6*abb145(59)
      abb145(35)=abb145(41)+abb145(39)+abb145(35)
      abb145(35)=1.0_ki/2.0_ki*abb145(35)
      abb145(20)=-abb145(20)*abb145(47)
      abb145(39)=spbk5k2*spak4e6*abb145(47)
      abb145(15)=-spak1k4*abb145(29)*abb145(15)
      abb145(16)=abb145(16)*abb145(47)
      abb145(17)=spbk6e6*spak4e6*abb145(17)
      abb145(29)=spae6k6*abb145(38)
      R2d145=abb145(13)
      rat2 = rat2 + R2d145
...
end module p12_sbars_hepemg_abbrevd145h3
