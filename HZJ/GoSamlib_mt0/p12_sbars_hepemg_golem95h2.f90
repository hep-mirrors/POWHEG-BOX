...
subroutine     reconstruct_group0(coeffs)
   ...
   use p12_sbars_hepemg_d235h2l1, only: numerator_d235 => numerator_golem95
   use p12_sbars_hepemg_d235h2l1d, only: reconstruct_d235
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p12_sbars_hepemg_d145h2l1, only: numerator_d145 => numerator_golem95
   use p12_sbars_hepemg_d145h2l1d, only: reconstruct_d145
   use p12_sbars_hepemg_d154h2l1, only: numerator_d154 => numerator_golem95
   use p12_sbars_hepemg_d154h2l1d, only: reconstruct_d154
   use p12_sbars_hepemg_d196h2l1, only: numerator_d196 => numerator_golem95
   use p12_sbars_hepemg_d196h2l1d, only: reconstruct_d196
   use p12_sbars_hepemg_d234h2l1, only: numerator_d234 => numerator_golem95
   use p12_sbars_hepemg_d234h2l1d, only: reconstruct_d234
   use p12_sbars_hepemg_d266h2l1, only: numerator_d266 => numerator_golem95
   use p12_sbars_hepemg_d266h2l1d, only: reconstruct_d266
   implicit none
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p12_sbars_hepemg_d150h2l1, only: numerator_d150 => numerator_golem95
   use p12_sbars_hepemg_d150h2l1d, only: reconstruct_d150
   use p12_sbars_hepemg_d193h2l1, only: numerator_d193 => numerator_golem95
   use p12_sbars_hepemg_d193h2l1d, only: reconstruct_d193
   use p12_sbars_hepemg_d233h2l1, only: numerator_d233 => numerator_golem95
   use p12_sbars_hepemg_d233h2l1d, only: reconstruct_d233
   use p12_sbars_hepemg_d268h2l1, only: numerator_d268 => numerator_golem95
   use p12_sbars_hepemg_d268h2l1d, only: reconstruct_d268
   implicit none
...
subroutine     reconstruct_group3(coeffs)
   ...
   use p12_sbars_hepemg_d55h2l1, only: numerator_d55 => numerator_golem95
   use p12_sbars_hepemg_d55h2l1d, only: reconstruct_d55
   use p12_sbars_hepemg_d244h2l1, only: numerator_d244 => numerator_golem95
   use p12_sbars_hepemg_d244h2l1d, only: reconstruct_d244
   implicit none
...
subroutine     reconstruct_group4(coeffs)
   ...
   use p12_sbars_hepemg_d43h2l1, only: numerator_d43 => numerator_golem95
   use p12_sbars_hepemg_d43h2l1d, only: reconstruct_d43
   implicit none
...
subroutine     reconstruct_group5(coeffs)
   ...
   use p12_sbars_hepemg_d27h2l1, only: numerator_d27 => numerator_golem95
   use p12_sbars_hepemg_d27h2l1d, only: reconstruct_d27
   use p12_sbars_hepemg_d143h2l1, only: numerator_d143 => numerator_golem95
   use p12_sbars_hepemg_d143h2l1d, only: reconstruct_d143
   implicit none
