module     p16_bbarb_hepemg_abbrevd235h2
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb235(4)=gHZZ*c1*NC*i_*TR*gBl*ger*abb235(2)*abb235(1)
      abb235(5)=abb235(4)*spak1k4
      abb235(6)=abb235(5)*spbk5k2
      abb235(7)=abb235(6)*abb235(3)
      abb235(8)=-es61+es345-es12
      abb235(9)=abb235(7)*abb235(8)
      abb235(10)=abb235(5)*spbk6k5
      ...
      abb235(14)=spak4k6*spbk6k2
      abb235(15)=abb235(4)*spak1k6
      abb235(16)=spbk6k5*abb235(15)
      abb235(17)=-abb235(16)*abb235(14)
      abb235(18)=spak1k6*spbk6k5
      ...
      abb235(18)=spbe6k2*spak4e6*abb235(18)*abb235(17)
      ...
      abb235(11)=spbk6e6*spak4k6
      abb235(25)=-spak2k4*spbe6k2
      abb235(11)=abb235(25)+abb235(11)
      abb235(11)=abb235(16)*abb235(11)
      abb235(25)=abb235(5)*spbe6k5
      ...
      abb235(27)=spak2k4*abb235(21)*spbk6k2
...
end module p16_bbarb_hepemg_abbrevd235h2
