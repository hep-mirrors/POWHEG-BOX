module     p16_bbarb_hepemg_d196h1l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p16_bbarb_hepemg/helicity1d196h1l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p16_bbarb_hepemg_abbrevd196h1
      implicit none
      ...
      acc196(5)=abb196(9)
      acc196(6)=abb196(10)
      acc196(7)=Qspvak2e6*acc196(3)
      acc196(8)=Qspvak6k2*acc196(1)
...
!           & sign => diagram196_sign, shift => diagram196_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p16_bbarb_hepemg_d196h1l1
