module     p8_cbarc_hepemg_d193h2l1
   ! file: /home/gionata/Documenti/Lavoro/GoSamPowheg/POWHEG-BOX/HZJ_tmp/GoSam_ &
   ! &POWHEG/Virtual/p8_cbarc_hepemg/helicity2d193h2l1.f90
...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc193(10)=acc193(5)*Qspvak6k1
      acc193(11)=acc193(4)*Qspvak4k5
      acc193(12)=acc193(2)*Qspvak4k2
      acc193(13)=acc193(1)*Qspvak1k6
...
!           & sign => diagram193_sign, shift => diagram193_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p8_cbarc_hepemg_d193h2l1
