...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p0_dbard_hepemg_abbrevd204h3
      implicit none
...
!---#] subroutine reconstruct_d204:
end module     p0_dbard_hepemg_d204h3l1d
