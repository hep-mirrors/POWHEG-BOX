...
subroutine     reconstruct_group0(coeffs)
   ...
   use p0_dbard_hepemg_d206h2l1, only: numerator_d206 => numerator_golem95
   use p0_dbard_hepemg_d206h2l1d, only: reconstruct_d206
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p0_dbard_hepemg_d117h2l1, only: numerator_d117 => numerator_golem95
   use p0_dbard_hepemg_d117h2l1d, only: reconstruct_d117
   use p0_dbard_hepemg_d134h2l1, only: numerator_d134 => numerator_golem95
   use p0_dbard_hepemg_d134h2l1d, only: reconstruct_d134
   use p0_dbard_hepemg_d170h2l1, only: numerator_d170 => numerator_golem95
   use p0_dbard_hepemg_d170h2l1d, only: reconstruct_d170
   use p0_dbard_hepemg_d205h2l1, only: numerator_d205 => numerator_golem95
   use p0_dbard_hepemg_d205h2l1d, only: reconstruct_d205
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p0_dbard_hepemg_d130h2l1, only: numerator_d130 => numerator_golem95
   use p0_dbard_hepemg_d130h2l1d, only: reconstruct_d130
   use p0_dbard_hepemg_d167h2l1, only: numerator_d167 => numerator_golem95
   use p0_dbard_hepemg_d167h2l1d, only: reconstruct_d167
   use p0_dbard_hepemg_d204h2l1, only: numerator_d204 => numerator_golem95
   use p0_dbard_hepemg_d204h2l1d, only: reconstruct_d204
