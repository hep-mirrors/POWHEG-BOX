module     p12_sbars_hepemg_abbrevd170h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb170(6)=gHZZ*spak1k5*c1*abb170(1)**2*i_*TR*gSl*gel*abb170(3)*abb170(2)
      abb170(7)=abb170(5)*abb170(6)*spbk6k4*spbe6k2
      abb170(8)=-spae6k6*abb170(7)
      abb170(9)=-es61+es345-es12
      abb170(10)=-2.0_ki*abb170(8)*abb170(9)
      abb170(5)=-spbk4k2*abb170(6)*abb170(5)
...
end module p12_sbars_hepemg_abbrevd170h0
