module     p12_sbars_hepemg_abbrevd170h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb170(6)=gHZZ*spbk5k1*c1*abb170(1)**2*i_*TR*gSr*ger*abb170(3)*abb170(2)
      abb170(7)=abb170(5)*abb170(6)*spak4k6*spak2e6
      abb170(8)=-spbk6e6*abb170(7)
      abb170(9)=-es61+es345-es12
      abb170(10)=-2.0_ki*abb170(8)*abb170(9)
      abb170(5)=-spak2k4*abb170(6)*abb170(5)
...
end module p12_sbars_hepemg_abbrevd170h3
