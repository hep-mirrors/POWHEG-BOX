module     p12_sbars_hepemg_abbrevd206h3
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb206(4)=gHZZ*c1*NC*i_*TR*gSr*ger*abb206(2)*abb206(1)
      abb206(5)=abb206(4)*spbk5k1
      abb206(6)=abb206(5)*spak2k4
      abb206(7)=abb206(6)*abb206(3)
      abb206(8)=-es61+es345-es12
      abb206(9)=abb206(7)*abb206(8)
      abb206(10)=abb206(5)*spak4k6
      ...
      abb206(14)=spbk6k5*spak2k6
      abb206(15)=abb206(4)*spbk6k1
      abb206(16)=spak4k6*abb206(15)
      abb206(17)=-abb206(16)*abb206(14)
      abb206(18)=spbk6k1*spak4k6
      ...
      abb206(18)=spak2e6*spbe6k5*abb206(18)*abb206(17)
      ...
      abb206(11)=spae6k6*spbk6k5
      abb206(25)=-spbk5k2*spak2e6
      abb206(11)=abb206(25)+abb206(11)
      abb206(11)=abb206(16)*abb206(11)
      abb206(25)=abb206(5)*spak4e6
...
end module p12_sbars_hepemg_abbrevd206h3
