...
!---#[ function finite_renormalisation:
   ...
   function     samplitude(scale2,ok,rational2,opt_amp0,opt_perm)
     ...
     & only: init_lo, rat2
      use p12_sbars_hepemg_abbrevd206h3, only: init_abbrevd206 => init_abbrev
      use p12_sbars_hepemg_abbrevd117h3, only: init_abbrevd117 => init_abbrev
      use p12_sbars_hepemg_abbrevd134h3, only: init_abbrevd134 => init_abbrev
      use p12_sbars_hepemg_abbrevd170h3, only: init_abbrevd170 => init_abbrev
      use p12_sbars_hepemg_abbrevd205h3, only: init_abbrevd205 => init_abbrev
      use p12_sbars_hepemg_abbrevd233h3, only: init_abbrevd233 => init_abbrev
      use p12_sbars_hepemg_abbrevd130h3, only: init_abbrevd130 => init_abbrev
      use p12_sbars_hepemg_abbrevd167h3, only: init_abbrevd167 => init_abbrev
      use p12_sbars_hepemg_abbrevd204h3, only: init_abbrevd204 => init_abbrev
