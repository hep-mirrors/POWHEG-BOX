...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      use p12_sbars_hepemg_abbrevd167h0
      implicit none
...
!           & sign => diagram167_sign, shift => diagram167_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p12_sbars_hepemg_d167h0l1
