...
!---#[ function brack_1:
   pure function brack_1(Q,mu2) result(brack)
      ...
      acc206(28)=Qspvak4k5*acc206(28)
      acc206(29)=Qspvak4k2*acc206(19)
      ...
      acc206(34)=Qspvak4k2*acc206(22)*acc206(34)
...
!           & sign => diagram206_sign, shift => diagram206_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p12_sbars_hepemg_d206h2l1
