module     p16_bbarb_hepemg_abbrevd117h0
...
contains
   subroutine     init_abbrev()
     ...
     &    logfile, debug_nlo_diagrams
      ...
      abb117(10)=dotproduct(k3,spvak1k4)
      abb117(11)=dotproduct(k3,spvak5k2)
      abb117(12)=gUr+gDr+gCr+gBr+gSr
      abb117(13)=gUl+gDl+gCl+gBl+gSl
      abb117(14)=abb117(12)+1.0_ki/3.0_ki*abb117(13)
      abb117(15)=spae6k6*spbk6k4
      abb117(16)=1.0_ki/2.0_ki*abb117(7)+abb117(15)
      abb117(17)=1.0_ki/2.0_ki*spbe6k2
      abb117(16)=abb117(17)*abb117(14)*abb117(16)
      abb117(18)=abb117(12)-abb117(13)
      abb117(19)=abb117(18)*spbk6k2
      abb117(20)=abb117(19)*spae6k6
      abb117(21)=abb117(6)*abb117(18)
      abb117(21)=1.0_ki/2.0_ki*abb117(21)+abb117(20)
      abb117(22)=1.0_ki/3.0_ki*spbe6k4
      abb117(21)=abb117(21)*abb117(22)
      abb117(23)=-spbe6k2*spbk5k4*abb117(14)
      abb117(24)=abb117(13)+1.0_ki/3.0_ki*abb117(12)
      abb117(25)=spbe6k4*spbk5k2*abb117(24)
      abb117(23)=abb117(23)+abb117(25)
      abb117(25)=1.0_ki/2.0_ki*spak5e6
      abb117(23)=abb117(23)*abb117(25)
      abb117(16)=abb117(23)+abb117(16)+abb117(21)
      abb117(16)=spak1k5*abb117(16)
      abb117(21)=abb117(12)+abb117(13)
      abb117(23)=-abb117(4)*abb117(21)
      abb117(26)=1.0_ki/2.0_ki*spbe6k4
      abb117(26)=abb117(26)*abb117(14)
      abb117(27)=-spak4e6*abb117(26)
      abb117(25)=-abb117(25)*spbe6k5*abb117(24)
      abb117(23)=abb117(25)+2.0_ki/3.0_ki*abb117(23)+abb117(27)
      abb117(23)=spak1k5*abb117(23)
      abb117(25)=spbk6e6*spak5k6
      abb117(27)=1.0_ki/2.0_ki*abb117(8)+abb117(25)
      abb117(27)=spak1e6*abb117(24)*abb117(27)
      abb117(28)=spbe6k4*spak1e6
      abb117(29)=abb117(28)*spak4k5*abb117(24)
      abb117(27)=abb117(27)+abb117(29)
      abb117(29)=abb117(18)*spak1k6
      abb117(30)=abb117(29)*spbk6e6
      abb117(31)=-abb117(5)*abb117(18)
      abb117(31)=1.0_ki/2.0_ki*abb117(31)-abb117(30)
      abb117(26)=spak1k4*abb117(26)
      abb117(26)=1.0_ki/3.0_ki*abb117(31)+abb117(26)
      abb117(26)=spak5e6*abb117(26)
      abb117(23)=abb117(23)+1.0_ki/2.0_ki*abb117(27)+abb117(26)
      abb117(23)=spbk4k2*abb117(23)
      abb117(26)=-spbk6k4*spak1k6
      abb117(26)=-1.0_ki/2.0_ki*abb117(10)+abb117(26)
      abb117(14)=abb117(17)*abb117(14)*abb117(26)
      abb117(17)=spbk6k2*spak1k6
      abb117(17)=abb117(9)+2.0_ki*abb117(17)
      abb117(17)=abb117(22)*abb117(17)*abb117(21)
      abb117(14)=abb117(14)+abb117(17)
      abb117(14)=spak5e6*abb117(14)
      abb117(17)=-spak5k6*spbk6k2
      abb117(17)=-1.0_ki/2.0_ki*abb117(11)+abb117(17)
      ...
      abb117(17)=abb117(12)*spak1k5
      abb117(22)=spbk2k1*spak1k6
      abb117(23)=-spbk6k4*abb117(22)*abb117(17)
      abb117(24)=abb117(13)*spbk4k2
      abb117(26)=spak1k2*spbk6k2
      abb117(27)=spak5k6*abb117(26)*abb117(24)
      abb117(23)=abb117(23)+abb117(27)
      abb117(27)=4.0_ki*abb117(16)
      abb117(23)=abb117(23)*abb117(27)
      abb117(17)=abb117(28)*spbk2k1*abb117(17)
      abb117(31)=spak5e6*spbe6k2
      abb117(24)=-abb117(31)*spak1k2*abb117(24)
      abb117(17)=abb117(17)+abb117(24)
      abb117(17)=abb117(17)*abb117(27)
      abb117(24)=abb117(21)*spak1k5
      abb117(32)=abb117(15)*spbe6k2
      abb117(33)=abb117(24)*abb117(32)
      abb117(34)=abb117(13)+3.0_ki*abb117(12)
      abb117(35)=abb117(25)*spbk4k2
      ...
      abb117(42)=abb117(37)*spak1e6
      abb117(43)=1.0_ki/2.0_ki*abb117(16)
      abb117(44)=abb117(43)*spak1e6
      abb117(45)=abb117(39)*abb117(44)
      abb117(46)=spbk4k2*abb117(45)
      abb117(47)=abb117(18)*spak1k5
      abb117(48)=abb117(16)*abb117(47)
      abb117(49)=abb117(48)*spbe6k2
      abb117(50)=abb117(43)*spbe6k2
      abb117(51)=abb117(34)*abb117(50)
      abb117(52)=spak1k5*abb117(51)
      abb117(53)=abb117(18)*spak1k2
      abb117(54)=-abb117(53)*abb117(43)*abb117(35)
      abb117(55)=abb117(48)*spbe6k4
      abb117(56)=abb117(18)*spbk2k1
      abb117(40)=-abb117(56)*abb117(43)*abb117(40)
      abb117(57)=abb117(37)*spak5e6
      abb117(58)=3.0_ki*spbk2k1
      abb117(58)=abb117(12)*abb117(58)
      abb117(59)=abb117(13)*spbk2k1
      abb117(58)=abb117(59)+abb117(58)
      abb117(59)=abb117(58)*spak1k5
      abb117(60)=abb117(44)*spbk6e6
      abb117(61)=abb117(60)*abb117(59)
      abb117(48)=-spbk6k4*abb117(48)
      abb117(62)=3.0_ki*spak1k2
      abb117(13)=abb117(13)*abb117(62)
      abb117(12)=abb117(12)*spak1k2
      abb117(12)=abb117(13)+abb117(12)
      abb117(13)=abb117(12)*spbk4k2
      abb117(62)=abb117(50)*spae6k6
      abb117(63)=-abb117(62)*abb117(13)
      abb117(22)=spak1e6*spbk6e6*abb117(22)
      abb117(26)=spbe6k2*spae6k6*abb117(26)
      abb117(22)=abb117(22)+abb117(26)
      abb117(22)=abb117(43)*abb117(18)*abb117(22)
      abb117(26)=-spbe6k2*abb117(53)
      abb117(26)=1.0_ki/2.0_ki*abb117(30)+abb117(26)
      abb117(26)=abb117(26)*abb117(16)
      abb117(30)=-spak1e6*abb117(56)
      abb117(20)=-1.0_ki/2.0_ki*abb117(20)+abb117(30)
      abb117(20)=abb117(20)*abb117(16)
      abb117(30)=abb117(18)*abb117(60)
      abb117(12)=abb117(12)*abb117(15)*abb117(50)
      abb117(29)=-spbk6k4*abb117(29)
      abb117(13)=abb117(29)+2.0_ki*abb117(13)
      abb117(13)=abb117(13)*abb117(16)
      abb117(29)=abb117(18)*abb117(16)
      abb117(28)=abb117(28)*abb117(29)
      abb117(45)=-spbe6k4*abb117(45)
      abb117(37)=spak5k6*abb117(37)
      abb117(50)=-abb117(18)*abb117(62)
      abb117(44)=-abb117(58)*abb117(25)*abb117(44)
      abb117(19)=spak5k6*abb117(19)
      abb117(19)=abb117(19)-2.0_ki*abb117(59)
      abb117(19)=abb117(19)*abb117(16)
      ...
      abb117(41)=abb117(21)*spbk4k1
      abb117(51)=abb117(41)*abb117(25)*spak1e6
      abb117(53)=abb117(21)*spak2k5
      abb117(32)=abb117(53)*abb117(32)
      abb117(32)=abb117(51)+abb117(32)+1.0_ki/2.0_ki*abb117(35)
      abb117(32)=abb117(32)*abb117(16)
      abb117(35)=-spak5k6*spbk6k4*abb117(21)
      abb117(41)=spak1k5*abb117(41)
      abb117(51)=spbk4k2*abb117(53)
      abb117(35)=abb117(51)+abb117(35)+abb117(41)
      abb117(35)=abb117(35)*abb117(27)
      abb117(21)=spbe6k4*abb117(21)*spak5e6
      abb117(27)=abb117(27)*abb117(21)
      abb117(16)=2.0_ki*abb117(16)*abb117(21)
      abb117(15)=abb117(39)*abb117(15)
      abb117(21)=abb117(18)*spbk4k1
      abb117(41)=spak1e6*abb117(21)
      abb117(51)=abb117(18)*spbk4k2
      abb117(53)=spak2e6*abb117(51)
      abb117(15)=abb117(53)+abb117(15)+abb117(41)
      abb117(15)=abb117(15)*abb117(43)
      abb117(25)=abb117(34)*abb117(25)
      abb117(18)=abb117(18)*spak2k5
      abb117(41)=-spbe6k2*abb117(18)
      abb117(53)=-spbe6k1*abb117(47)
      abb117(25)=abb117(53)+abb117(25)+abb117(41)
      abb117(25)=abb117(25)*abb117(43)
      abb117(41)=abb117(43)*spbe6k4
      abb117(18)=-abb117(18)*abb117(41)
      abb117(43)=abb117(43)*spak5e6
      abb117(51)=abb117(43)*abb117(51)
      abb117(47)=-abb117(41)*abb117(47)
      abb117(21)=abb117(21)*abb117(43)
      abb117(34)=spbk6e6*abb117(34)*abb117(43)
      abb117(39)=spae6k6*abb117(39)*abb117(41)
      R2d117=abb117(14)
      rat2 = rat2 + R2d117
...
end module p16_bbarb_hepemg_abbrevd117h0
