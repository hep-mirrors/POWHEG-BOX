...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p16_bbarb_hepemg_abbrevd206h3
      implicit none
      ...
      acd206(3)=abb206(23)
      acd206(4)=dotproduct(qshift,spvak2e6)
      acd206(5)=abb206(26)
      acd206(6)=abb206(12)
      acd206(7)=dotproduct(k2,qshift)
      acd206(8)=dotproduct(qshift,spvak2k5)
      acd206(9)=abb206(24)
      acd206(10)=dotproduct(qshift,spvak4k5)
      acd206(11)=abb206(28)
      acd206(12)=abb206(22)
      ...
      acd206(17)=abb206(6)
      acd206(18)=abb206(4)
      acd206(19)=dotproduct(qshift,spvak2k1)
      acd206(20)=abb206(29)
      acd206(21)=abb206(15)
      acd206(22)=abb206(5)
      acd206(23)=dotproduct(qshift,spvak2k6)
      acd206(24)=abb206(10)
      acd206(25)=dotproduct(qshift,spvak4k1)
      acd206(26)=abb206(14)
      acd206(27)=abb206(13)
      acd206(28)=abb206(25)
      acd206(29)=abb206(21)
      ...
      acd206(36)=abb206(3)
      acd206(37)=abb206(9)
      acd206(38)=acd206(25)*acd206(26)
      acd206(39)=acd206(19)*acd206(22)
      acd206(40)=acd206(23)*acd206(24)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd206(20)=abb206(6)
      acd206(21)=abb206(4)
      acd206(22)=dotproduct(qshift,spvak2k1)
      acd206(23)=abb206(29)
      acd206(24)=abb206(15)
      acd206(25)=abb206(5)
      acd206(26)=dotproduct(qshift,spvak2k6)
      acd206(27)=abb206(10)
      acd206(28)=dotproduct(qshift,spvak4k1)
      acd206(29)=abb206(14)
      acd206(30)=abb206(13)
      ...
      acd206(34)=abb206(27)
      acd206(35)=abb206(7)
      acd206(36)=spvak2e6(iv1)
      acd206(37)=abb206(17)
      acd206(38)=abb206(11)
      acd206(39)=spvak2k5(iv1)
      acd206(40)=dotproduct(k2,qshift)
      acd206(41)=spvak4k5(iv1)
      acd206(42)=abb206(18)
      acd206(43)=abb206(8)
      acd206(44)=spvak2k1(iv1)
      acd206(45)=spvak2k6(iv1)
      acd206(46)=abb206(3)
      acd206(47)=spvak4k1(iv1)
      acd206(48)=-acd206(29)*acd206(28)
      ...
      acd206(50)=-acd206(29)*acd206(47)
      acd206(51)=-acd206(45)*acd206(27)
...
!---#[ function brack_3:
   pure function brack_3(Q, mu2) result(brack)
      ...
      acd206(2)=dotproduct(e6,qshift)
      acd206(3)=abb206(6)
      acd206(4)=dotproduct(qshift,spvak2k5)
      acd206(5)=abb206(21)
      acd206(6)=dotproduct(qshift,spvak4k5)
      acd206(7)=abb206(27)
      acd206(8)=dotproduct(qshift,spvak2e6)
      acd206(9)=abb206(25)
      acd206(10)=abb206(7)
      acd206(11)=k1(iv1)
      acd206(12)=e6(iv2)
      acd206(13)=abb206(23)
      acd206(14)=spvak2e6(iv2)
      acd206(15)=abb206(26)
      acd206(16)=k1(iv2)
      acd206(17)=e6(iv1)
      acd206(18)=spvak2e6(iv1)
      acd206(19)=k2(iv1)
      acd206(20)=spvak2k5(iv2)
      acd206(21)=abb206(24)
      acd206(22)=spvak4k5(iv2)
      acd206(23)=abb206(28)
      acd206(24)=k2(iv2)
      acd206(25)=spvak2k5(iv1)
      acd206(26)=spvak4k5(iv1)
      acd206(27)=k6(iv1)
      acd206(28)=abb206(20)
      acd206(29)=k6(iv2)
      acd206(30)=qshift(iv2)
      acd206(31)=abb206(4)
      acd206(32)=dotproduct(qshift,spvak2k1)
      acd206(33)=abb206(29)
      acd206(34)=abb206(15)
      acd206(35)=spvak2k1(iv2)
      acd206(36)=abb206(5)
      acd206(37)=spvak2k6(iv2)
      acd206(38)=abb206(10)
      acd206(39)=spvak4k1(iv2)
      acd206(40)=abb206(14)
      acd206(41)=qshift(iv1)
      acd206(42)=spvak2k1(iv1)
      acd206(43)=spvak2k6(iv1)
      acd206(44)=spvak4k1(iv1)
      acd206(45)=abb206(17)
      acd206(46)=abb206(18)
      acd206(47)=acd206(33)*acd206(6)
      acd206(47)=acd206(47)+acd206(36)
      acd206(48)=acd206(35)*acd206(47)
      acd206(49)=acd206(40)*acd206(39)
      acd206(50)=acd206(37)*acd206(38)
...
!---#[ function brack_4:
   pure function brack_4(Q, mu2) result(brack)
      ...
      acd206(2)=e6(iv3)
      acd206(3)=abb206(6)
      acd206(4)=spvak2k5(iv3)
      acd206(5)=abb206(21)
      acd206(6)=spvak4k5(iv3)
      acd206(7)=abb206(27)
      acd206(8)=spvak2e6(iv3)
      acd206(9)=abb206(25)
      acd206(10)=d(iv1,iv3)
      acd206(11)=e6(iv2)
      acd206(12)=spvak2k5(iv2)
      acd206(13)=spvak4k5(iv2)
      acd206(14)=spvak2e6(iv2)
      acd206(15)=d(iv2,iv3)
      acd206(16)=e6(iv1)
      acd206(17)=spvak2k5(iv1)
      acd206(18)=spvak4k5(iv1)
      acd206(19)=spvak2e6(iv1)
      acd206(20)=spvak2k1(iv3)
      acd206(21)=abb206(29)
      acd206(22)=spvak2k1(iv2)
      acd206(23)=spvak2k1(iv1)
...
!---#] subroutine reconstruct_d206:
end module     p16_bbarb_hepemg_d206h3l1d
