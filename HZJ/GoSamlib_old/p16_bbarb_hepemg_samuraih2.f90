...
function     numeval_group0(icut, Q, mu2) result(num)
   ...
   use p16_bbarb_hepemg_d206h2l1, only: numerator_d206 => numerator_samurai
   implicit none
...
function     numeval_group1(icut, Q, mu2) result(num)
   use p16_bbarb_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d117h2l1, only: numerator_d117 => numerator_samurai
   use p16_bbarb_hepemg_d134h2l1, only: numerator_d134 => numerator_samurai
   use p16_bbarb_hepemg_d170h2l1, only: numerator_d170 => numerator_samurai
   use p16_bbarb_hepemg_d205h2l1, only: numerator_d205 => numerator_samurai
...
function     numeval_group2(icut, Q, mu2) result(num)
   use p16_bbarb_hepemg_kinematics, only: k1, k2, k3, k4, k5, k6
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d130h2l1, only: numerator_d130 => numerator_samurai
   use p16_bbarb_hepemg_d167h2l1, only: numerator_d167 => numerator_samurai
   use p16_bbarb_hepemg_d204h2l1, only: numerator_d204 => numerator_samurai
...
subroutine     reduce_group0(scale2,tot,totr,ok)
   ...
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d206h2l1, only: numerator_diagram206 => numerator_samur&
   &ai
...
subroutine     reduce_group1(scale2,tot,totr,ok)
   ...
   use p16_bbarb_hepemg_kinematics
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d117h2l1, only: numerator_diagram117 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d134h2l1, only: numerator_diagram134 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d170h2l1, only: numerator_diagram170 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d205h2l1, only: numerator_diagram205 => numerator_samur&
   &ai
...
subroutine     reduce_group2(scale2,tot,totr,ok)
   ...
   use p16_bbarb_hepemg_kinematics
   use p16_bbarb_hepemg_model
   use p16_bbarb_hepemg_d130h2l1, only: numerator_diagram130 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d167h2l1, only: numerator_diagram167 => numerator_samur&
   &ai
   use p16_bbarb_hepemg_d204h2l1, only: numerator_diagram204 => numerator_samur&
   &ai
