...
!           & sign => diagram134_sign, shift => diagram134_shift
   ...
   !------#] function numerator_golem95:
!---#] numerator interfaces:
end module p8_cbarc_hepemg_d134h0l1
