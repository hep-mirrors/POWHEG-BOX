...
!---#[ function brack_1:
   pure function brack_1(Q, mu2) result(brack)
      ...
      use p8_cbarc_hepemg_abbrevd170h3
      implicit none
      ...
      acd170(6)=abb170(6)
      acd170(7)=dotproduct(qshift,spvak6k2)
      acd170(8)=abb170(5)
      acd170(9)=dotproduct(qshift,spvak2e6)
      acd170(10)=abb170(7)
      acd170(11)=abb170(10)
      acd170(12)=-acd170(2)*acd170(1)
      acd170(13)=-acd170(4)*acd170(3)
      acd170(14)=-acd170(6)*acd170(5)
      acd170(15)=-acd170(8)*acd170(7)
      acd170(16)=-acd170(10)*acd170(9)
...
!---#[ function brack_2:
   pure function brack_2(Q, mu2) result(brack)
      ...
      acd170(5)=e6(iv1)
      acd170(6)=abb170(6)
      acd170(7)=spvak6k2(iv1)
      acd170(8)=abb170(5)
      acd170(9)=spvak2e6(iv1)
      acd170(10)=abb170(7)
      acd170(11)=acd170(2)*acd170(1)
      acd170(12)=acd170(4)*acd170(3)
      acd170(13)=acd170(6)*acd170(5)
      acd170(14)=acd170(8)*acd170(7)
      acd170(15)=acd170(10)*acd170(9)
...
!---#] subroutine reconstruct_d170:
end module     p8_cbarc_hepemg_d170h3l1d
