...
subroutine     reconstruct_group0(coeffs)
   ...
   use p8_cbarc_hepemg_d206h0l1, only: numerator_d206 => numerator_golem95
   use p8_cbarc_hepemg_d206h0l1d, only: reconstruct_d206
   implicit none
...
subroutine     reconstruct_group1(coeffs)
   ...
   use p8_cbarc_hepemg_d117h0l1, only: numerator_d117 => numerator_golem95
   use p8_cbarc_hepemg_d117h0l1d, only: reconstruct_d117
   use p8_cbarc_hepemg_d134h0l1, only: numerator_d134 => numerator_golem95
   use p8_cbarc_hepemg_d134h0l1d, only: reconstruct_d134
   use p8_cbarc_hepemg_d170h0l1, only: numerator_d170 => numerator_golem95
   use p8_cbarc_hepemg_d170h0l1d, only: reconstruct_d170
   use p8_cbarc_hepemg_d205h0l1, only: numerator_d205 => numerator_golem95
   use p8_cbarc_hepemg_d205h0l1d, only: reconstruct_d205
...
subroutine     reconstruct_group2(coeffs)
   ...
   use p8_cbarc_hepemg_d130h0l1, only: numerator_d130 => numerator_golem95
   use p8_cbarc_hepemg_d130h0l1d, only: reconstruct_d130
   use p8_cbarc_hepemg_d167h0l1, only: numerator_d167 => numerator_golem95
   use p8_cbarc_hepemg_d167h0l1d, only: reconstruct_d167
   use p8_cbarc_hepemg_d204h0l1, only: numerator_d204 => numerator_golem95
   use p8_cbarc_hepemg_d204h0l1d, only: reconstruct_d204
