...
do 
    ...
    X[$((i))]=`echo ${X[$((i))]} | sed 's/E-/\/10\^/g' `
    X[$((i))]=`echo "scale=20; ${X[$i]}" | bc `
    XL[$((i))]=`echo ${XL[$((i))]} | sed 's/E+/\*10\^/g' `
    XL[$((i))]=`echo ${XL[$((i))]} | sed 's/E-/\/10\^/g' `
    XL[$((i))]=`echo "scale=20; ${XL[$i]}" | bc `
    XH[$((i))]=`echo ${XH[$((i))]} | sed 's/E+/\*10\^/g' `
    XH[$((i))]=`echo ${XH[$((i))]} | sed 's/E-/\/10\^/g' `
    XH[$((i))]=`echo "scale=20; ${XH[$i]}" | bc `
    Y[$((i))]=`echo ${Y[$((i))]} | sed 's/E+/\*10\^/g' `
    Y[$((i))]=`echo ${Y[$((i))]} | sed 's/E-/\/10\^/g' `
    Y[$((i))]=`echo "scale=20; ${Y[$i]}" | bc `
    MEAN[$((i))]=`echo ${MEAN[$((i))]} | sed 's/E+/\*10\^/g' `
    MEAN[$((i))]=`echo ${MEAN[$((i))]} | sed 's/E-/\/10\^/g' `
    MEAN[$((i))]=`echo "scale=20; ${MEAN[$i]}" | bc `
    DYSTATP[$((i))]=`echo ${DYSTATP[$((i))]} | sed 's/E+/\*10\^/g' `
    DYSTATP[$((i))]=`echo ${DYSTATP[$((i))]} | sed 's/E-/\/10\^/g' `
    DYSTATP[$((i))]=`echo "scale=20; ${DYSTATP[$i]}" | bc `
    DYSTATM[$((i))]=`echo ${DYSTATM[$((i))]} | sed 's/E+/\*10\^/g' `
    DYSTATM[$((i))]=`echo ${DYSTATM[$((i))]} | sed 's/E-/\/10\^/g' `
    DYSTATM[$((i))]=`echo "scale=20; ${DYSTATM[$i]}" | bc `
    DYSYSP[$((i))]=`echo ${DYSYSP[$((i))]} | sed 's/E+/\*10\^/g' `
    DYSYSP[$((i))]=`echo ${DYSYSP[$((i))]} | sed 's/E-/\/10\^/g' `
    DYSYSP[$((i))]=`echo "scale=20; ${DYSYSP[$i]}" | bc `
    DYSYSM[$((i))]=`echo ${DYSYSM[$((i))]} | sed 's/E+/\*10\^/g' `
    DYSYSM[$((i))]=`echo ${DYSYSM[$((i))]} | sed 's/E-/\/10\^/g' `
    DYSYSM[$((i))]=`echo "scale=20; ${DYSYSM[$i]}" | bc `
    # Now we actually compute the things topdrawer needs:
    DX[$((i))]=`echo "scale=20; ${XH[$((i))]}-${X[$((i))]} " | bc`
    NDX[$((i))]=`echo "scale=20; ${X[$((i))]}-${XL[$((i))]} " | bc`
    DY[$((i))]=`echo "scale=20; sqrt(${DYSTATP[$((i))]}^2+${DYSYSP[$((i))]}^2)" | bc`
    NDY[$((i))]=`echo "scale=20; sqrt(${DYSTATM[$((i))]}^2+${DYSYSM[$((i))]}^2)" | bc`
