...
C  
C FOR PROCESS : g u~ -> u~ g  
C  
C Crossing   1 is g u~ -> u~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gux_uxg/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gux_uxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,3   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,5   ))     
      CALL VVVXXX(W(1,4   ),W(1,1   ),W(1,5   ),G ,AMP(1   ))              
      CALL FVIXXX(W(1,3   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,6   ))     
      CALL IOVXXX(W(1,6   ),W(1,2   ),W(1,4   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gux_uxg =gux_uxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
