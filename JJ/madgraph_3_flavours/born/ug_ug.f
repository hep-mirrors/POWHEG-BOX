...
C  
      ...
      common/to_amps_ug_ug/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION ug_ug(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,1   ),W(1,3   ),GG ,ZERO    ,ZERO    ,W(1,6   ))     
      CALL VVVXXX(W(1,4   ),W(1,2   ),W(1,6   ),G ,AMP(2   ))              
      CALL FVIXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,7   ),W(1,3   ),W(1,4   ),GG ,AMP(3   ))             
      JAMP(   1) = +AMP(   1)-AMP(   2)
      JAMP(   2) = +AMP(   2)+AMP(   3)
      ug_ug = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          ug_ug =ug_ug+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
