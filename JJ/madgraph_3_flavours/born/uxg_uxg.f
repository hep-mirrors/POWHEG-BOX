...
C  
C FOR PROCESS : u~ g -> u~ g  
C  
C Crossing   1 is u~ g -> u~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_uxg_uxg/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION uxg_uxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,3   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,5   ))     
      CALL IOVXXX(W(1,5   ),W(1,1   ),W(1,4   ),GG ,AMP(1   ))             
      CALL JIOXXX(W(1,3   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,6   ))     
      CALL VVVXXX(W(1,4   ),W(1,2   ),W(1,6   ),G ,AMP(2   ))              
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,3   ),W(1,7   ),W(1,4   ),GG ,AMP(3   ))             
      JAMP(   1) = -AMP(   1)-AMP(   2)
      JAMP(   2) = +AMP(   2)-AMP(   3)
      uxg_uxg = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxg_uxg =uxg_uxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
