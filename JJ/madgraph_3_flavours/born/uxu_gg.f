...
C  
C FOR PROCESS : u~ u -> g g  
C  
C Crossing   1 is u~ u -> g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_uxu_gg/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION uxu_gg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,3   ),GG ,ZERO    ,ZERO    ,W(1,5   ))     
      CALL IOVXXX(W(1,5   ),W(1,1   ),W(1,4   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,1   ),W(1,3   ),GG ,ZERO    ,ZERO    ,W(1,6   ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxu_gg =uxu_gg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
