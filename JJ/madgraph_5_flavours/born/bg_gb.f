...
C  
C FOR PROCESS : b g -> g b  
C  
C Crossing   1 is b g -> g b  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_bg_gb/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bg_gb(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,6   ))     
      CALL IOVXXX(W(1,6   ),W(1,4   ),W(1,2   ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,7   ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bg_gb =bg_gb+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
