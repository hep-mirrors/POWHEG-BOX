...
C  
      ...
      common/to_amps_bxb_bbx/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bxb_bbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,4   ),W(1,3   ),W(1,6   ),GG ,AMP(2   ))             
      JAMP(   1) = -AMP(   1)
      JAMP(   2) = +AMP(   2)
      bxb_bbx = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          bxb_bbx =bxb_bbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
