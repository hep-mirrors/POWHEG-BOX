...
C  
      ...
      common/to_amps_bxg_gbx/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bxg_gbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,1   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,6   ))     
      CALL IOVXXX(W(1,4   ),W(1,6   ),W(1,2   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,1   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,7   ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bxg_gbx =bxg_gbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
