...
C  
      ...
      common/to_amps_gbx_gbx/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gbx_gbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,5   ))     
      CALL IOVXXX(W(1,4   ),W(1,5   ),W(1,1   ),GG ,AMP(1   ))             
      CALL JVVXXX(W(1,1   ),W(1,3   ),G ,ZERO    ,ZERO    ,W(1,6   ))      
      CALL IOVXXX(W(1,4   ),W(1,2   ),W(1,6   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,7   ))     
      CALL IOVXXX(W(1,4   ),W(1,7   ),W(1,3   ),GG ,AMP(3   ))             
      JAMP(   1) = -AMP(   1)+AMP(   2)
      JAMP(   2) = -AMP(   2)-AMP(   3)
      gbx_gbx = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          gbx_gbx =gbx_gbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
