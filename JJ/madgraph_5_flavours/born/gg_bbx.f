...
C  
C FOR PROCESS : g g -> b b~  
C  
C Crossing   1 is g g -> b b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gg_bbx/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gg_bbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,3   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,5   ))     
      CALL IOVXXX(W(1,4   ),W(1,5   ),W(1,1   ),GG ,AMP(1   ))             
      CALL FVOXXX(W(1,3   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,6   ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gg_bbx =gg_bbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
