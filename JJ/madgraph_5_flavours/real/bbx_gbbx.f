...
C  
      ...
      common/to_amps_bbx_gbbx/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bbx_gbbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL VVVXXX(W(1,6   ),W(1,7   ),W(1,3   ),G ,AMP(1   ))              
      CALL FVIXXX(W(1,5   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,8   ))     
      CALL IOVXXX(W(1,8   ),W(1,2   ),W(1,6   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,2   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,5   ),W(1,9   ),W(1,6   ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,1   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL JIOXXX(W(1,10  ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,5   ),W(1,2   ),W(1,11  ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,4   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,1   ),W(1,12  ),W(1,7   ),GG ,AMP(5   ))             
      ...
      CALL JIOXXX(W(1,1   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bbx_gbbx =bbx_gbbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
