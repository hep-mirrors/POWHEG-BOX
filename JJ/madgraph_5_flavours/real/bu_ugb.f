...
C  
      ...
      common/to_amps_bu_ugb/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bu_ugb(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL JIOXXX(W(1,1   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,10  ),W(1,3   ),W(1,11  ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,3   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,2   ),W(1,12  ),W(1,11  ),GG ,AMP(5   ))             
      JAMP(   1) = -AMP(   1)+AMP(   5)
      JAMP(   2) = +AMP(   1)+AMP(   4)
      JAMP(   3) = +AMP(   2)
      JAMP(   4) = +AMP(   3)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bu_ugb =bu_ugb+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
