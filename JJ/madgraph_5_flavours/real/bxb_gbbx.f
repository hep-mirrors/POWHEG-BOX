...
C  
C FOR PROCESS : b~ b -> g b b~  
C  
C Crossing   1 is b~ b -> g b b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_bxb_gbbx/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bxb_gbbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            9/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    24,   -3,   -6,   21,   -8,    1/    
      DATA (CF(i,1  ),i=7  ,8  ) /    10,    1/                            
C               T[ 4, 5]T[ 1, 2, 3]                                        
      DATA Denom(2  )/            9/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -3,   24,   21,   -6,    1,   10/    
      DATA (CF(i,2  ),i=7  ,8  ) /     1,   -8/                            
C               T[ 1, 2]T[ 4, 5, 3]                                        
      DATA Denom(3  )/            9/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    -6,   21,   24,   -3,   10,    1/    
      DATA (CF(i,3  ),i=7  ,8  ) /    -8,    1/                            
C               T[ 4, 5, 3]T[ 1, 2]                                        
      DATA Denom(4  )/            9/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    21,   -6,   -3,   24,    1,   -8/    
...
C               T[ 4, 2, 3]T[ 1, 5]                                        
      DATA Denom(6  )/            9/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /     1,   10,    1,   -8,   -3,   24/    
...
C               T[ 4, 2]T[ 1, 5, 3]                                        
      DATA Denom(8  )/            9/                                       
      DATA (CF(i,8  ),i=1  ,6  ) /     1,   -8,    1,   10,   21,   -6/    
...
C ----------
      ...
      CALL JIOXXX(W(1,6   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,7   ))     
      ...
      CALL VVVXXX(W(1,9   ),W(1,8   ),W(1,3   ),G ,AMP(2   ))              
      CALL FVIXXX(W(1,5   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL IOVXXX(W(1,10  ),W(1,1   ),W(1,8   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,1   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,5   ),W(1,11  ),W(1,8   ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,4   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,2   ),W(1,12  ),W(1,9   ),GG ,AMP(5   ))             
      CALL JIOXXX(W(1,6   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,13  ),GG ,AMP(6   ))             
      CALL JIOXXX(W(1,2   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,14  ))     
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,14  ),GG ,AMP(7   ))             
      CALL JIOXXX(W(1,2   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL FVOXXX(W(1,4   ),W(1,15  ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,5   ),W(1,16  ),W(1,3   ),GG ,AMP(8   ))             
      CALL JVVXXX(W(1,15  ),W(1,3   ),G ,ZERO    ,ZERO    ,W(1,17  ))      
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,17  ),GG ,AMP(9   ))             
      CALL IOVXXX(W(1,5   ),W(1,12  ),W(1,15  ),GG ,AMP(10  ))             
      JAMP(   1) = -AMP(   1)+AMP(   2)
      JAMP(   2) = -AMP(   2)-AMP(   5)
      JAMP(   3) = -AMP(   3)
      JAMP(   4) = -AMP(   4)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bxb_gbbx =bxb_gbbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
