...
C  
      ...
      common/to_amps_bxbx_gbxbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bxbx_gbxbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bxbx_gbxbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,4   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,12  ),W(1,2   ),W(1,9   ),GG ,AMP(5   ))             
      ...
      CALL IOVXXX(W(1,10  ),W(1,2   ),W(1,13  ),GG ,AMP(7   ))             
      CALL IOVXXX(W(1,5   ),W(1,6   ),W(1,13  ),GG ,AMP(8   ))             
      CALL JIOXXX(W(1,4   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,5   ),W(1,2   ),W(1,15  ),GG ,AMP(9   ))             
      CALL IOVXXX(W(1,12  ),W(1,1   ),W(1,14  ),GG ,AMP(10  ))             
      JAMP(   1) = +AMP(   1)+AMP(   2)
      JAMP(   2) = -AMP(   2)+AMP(   5)
      JAMP(   3) = +AMP(   3)
      JAMP(   4) = +AMP(   4)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bxbx_gbxbx =bxbx_gbxbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
