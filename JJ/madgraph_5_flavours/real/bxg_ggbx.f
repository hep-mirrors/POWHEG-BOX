...
C  
C FOR PROCESS : b~ g -> g g b~  
C  
C Crossing   1 is b~ g -> g g b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_bxg_ggbx/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bxg_ggbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL VVVXXX(W(1,13  ),W(1,12  ),W(1,3   ),G ,AMP(6   ))              
      ...
      CALL IOVXXX(W(1,5   ),W(1,14  ),W(1,12  ),GG ,AMP(10  ))             
      ...
      CALL JGGGXX(W(1,4   ),W(1,2   ),W(1,3   ),G ,W(1,21  ))              
      CALL IOVXXX(W(1,5   ),W(1,1   ),W(1,21  ),GG ,AMP(16  ))             
      CALL JGGGXX(W(1,3   ),W(1,4   ),W(1,2   ),G ,W(1,22  ))              
      CALL IOVXXX(W(1,5   ),W(1,1   ),W(1,22  ),GG ,AMP(17  ))             
      CALL JGGGXX(W(1,2   ),W(1,3   ),W(1,4   ),G ,W(1,23  ))              
      CALL IOVXXX(W(1,5   ),W(1,1   ),W(1,23  ),GG ,AMP(18  ))             
      JAMP(   1) = -AMP(   1)+AMP(   4)+AMP(  11)-AMP(  14)+AMP(  15)
     &             -AMP(  17)+AMP(  18)
      JAMP(   2) = +AMP(   1)-AMP(   4)-AMP(   6)-AMP(   9)+AMP(  10)
     &             +AMP(  16)-AMP(  18)
      JAMP(   3) = +AMP(   1)-AMP(   3)+AMP(   5)-AMP(   6)-AMP(   8)
     &             +AMP(  16)-AMP(  18)
      JAMP(   4) = -AMP(   1)-AMP(   2)-AMP(   5)+AMP(  11)-AMP(  12)
     &             -AMP(  17)+AMP(  18)
      JAMP(   5) = +AMP(   6)-AMP(   7)-AMP(  10)-AMP(  11)+AMP(  12)
     &             -AMP(  16)+AMP(  17)
      JAMP(   6) = +AMP(   6)+AMP(   8)-AMP(  11)-AMP(  13)-AMP(  15)
     &             -AMP(  16)+AMP(  17)
      bxg_ggbx = 0.D0 
      DO I = 1, NCOLOR
          ZTEMP = (0.D0,0.D0)
          ...
          ENDDO
          bxg_ggbx =bxg_ggbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
