...
C  
      ...
      common/to_amps_bxux_uxgbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bxux_uxgbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bxux_uxgbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,1   ),W(1,6   ),GG ,BMASS   ,ZERO    ,W(1,8   ))     
      CALL IOVXXX(W(1,5   ),W(1,8   ),W(1,4   ),GG ,AMP(2   ))             
      CALL FVOXXX(W(1,1   ),W(1,4   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,5   ),W(1,9   ),W(1,6   ),GG ,AMP(3   ))             
      CALL FVOXXX(W(1,2   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL JIOXXX(W(1,5   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bxux_uxgbx =bxux_uxgbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
