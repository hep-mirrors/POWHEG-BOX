...
C  
      ...
      common/to_amps_gb_ggb/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gb_ggb(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL JIOXXX(W(1,2   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      CALL VVVXXX(W(1,8   ),W(1,9   ),W(1,3   ),G ,AMP(2   ))              
      CALL FVOXXX(W(1,5   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL IOVXXX(W(1,2   ),W(1,10  ),W(1,8   ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,6   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,11  ),W(1,5   ),W(1,4   ),GG ,AMP(4   ))             
      CALL IOVXXX(W(1,6   ),W(1,5   ),W(1,8   ),GG ,AMP(5   ))             
      ...
      CALL IOVXXX(W(1,2   ),W(1,5   ),W(1,15  ),GG ,AMP(7   ))             
      CALL IOVXXX(W(1,12  ),W(1,10  ),W(1,1   ),GG ,AMP(8   ))             
      CALL FVIXXX(W(1,2   ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL IOVXXX(W(1,16  ),W(1,5   ),W(1,4   ),GG ,AMP(9   ))             
      CALL IOVXXX(W(1,12  ),W(1,5   ),W(1,14  ),GG ,AMP(10  ))             
      ...
      CALL IOVXXX(W(1,19  ),W(1,5   ),W(1,3   ),GG ,AMP(13  ))             
      CALL FVIXXX(W(1,18  ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,20  ),W(1,5   ),W(1,4   ),GG ,AMP(14  ))             
      CALL IOVXXX(W(1,18  ),W(1,5   ),W(1,17  ),GG ,AMP(15  ))             
      CALL JGGGXX(W(1,1   ),W(1,4   ),W(1,3   ),G ,W(1,21  ))              
      CALL IOVXXX(W(1,2   ),W(1,5   ),W(1,21  ),GG ,AMP(16  ))             
      CALL JGGGXX(W(1,3   ),W(1,1   ),W(1,4   ),G ,W(1,22  ))              
      CALL IOVXXX(W(1,2   ),W(1,5   ),W(1,22  ),GG ,AMP(17  ))             
      CALL JGGGXX(W(1,4   ),W(1,3   ),W(1,1   ),G ,W(1,23  ))              
      CALL IOVXXX(W(1,2   ),W(1,5   ),W(1,23  ),GG ,AMP(18  ))             
     ...
     &             +AMP(  16)-AMP(  17)
      JAMP(   4) = +AMP(   2)+AMP(   3)-AMP(  12)+AMP(  13)-AMP(  15)
     &             -AMP(  16)+AMP(  18)
     ...
     &             +AMP(  17)-AMP(  18)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gb_ggb =gb_ggb+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
