...
C  
C FOR PROCESS : g b~ -> g g b~  
C  
C Crossing   1 is g b~ -> g g b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gbx_ggbx/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gbx_ggbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            9/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    64,   10,    1,   -8,   -8,    1/    
C               T[ 2, 5, 3, 4, 1]                                          
      DATA Denom(2  )/            9/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    10,   64,   -8,    1,    1,   -8/    
C               T[ 2, 5, 1, 4, 3]                                          
      DATA Denom(3  )/            9/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /     1,   -8,   64,   10,   -8,    1/    
C               T[ 2, 5, 4, 1, 3]                                          
      DATA Denom(4  )/            9/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /    -8,    1,   10,   64,    1,   -8/    
C               T[ 2, 5, 3, 1, 4]                                          
      DATA Denom(5  )/            9/                                       
...
C ----------
      ...
      CALL JIOXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      ...
      CALL IOVXXX(W(1,5   ),W(1,11  ),W(1,4   ),GG ,AMP(4   ))             
      CALL IOVXXX(W(1,5   ),W(1,6   ),W(1,8   ),GG ,AMP(5   ))             
      ...
      CALL FVOXXX(W(1,18  ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,20  ))     
      CALL IOVXXX(W(1,5   ),W(1,20  ),W(1,4   ),GG ,AMP(14  ))             
      CALL IOVXXX(W(1,5   ),W(1,18  ),W(1,17  ),GG ,AMP(15  ))             
      CALL JGGGXX(W(1,1   ),W(1,4   ),W(1,3   ),G ,W(1,21  ))              
      CALL IOVXXX(W(1,5   ),W(1,2   ),W(1,21  ),GG ,AMP(16  ))             
      CALL JGGGXX(W(1,3   ),W(1,1   ),W(1,4   ),G ,W(1,22  ))              
      CALL IOVXXX(W(1,5   ),W(1,2   ),W(1,22  ),GG ,AMP(17  ))             
      CALL JGGGXX(W(1,4   ),W(1,3   ),W(1,1   ),G ,W(1,23  ))              
      CALL IOVXXX(W(1,5   ),W(1,2   ),W(1,23  ),GG ,AMP(18  ))             
     ...
     &             -AMP(  16)+AMP(  17)
      JAMP(   4) = +AMP(   2)-AMP(   4)+AMP(   5)-AMP(   7)+AMP(   9)
     &             -AMP(  16)+AMP(  17)
      JAMP(   5) = -AMP(   6)+AMP(   7)+AMP(  10)-AMP(  11)-AMP(  12)
     &             -AMP(  17)+AMP(  18)
     ...
     &             -AMP(  17)+AMP(  18)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gbx_ggbx =gbx_ggbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
