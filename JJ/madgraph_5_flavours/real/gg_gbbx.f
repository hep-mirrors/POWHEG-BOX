...
C  
C FOR PROCESS : g g -> g b b~  
C  
C Crossing   1 is g g -> g b b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gg_gbbx/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gg_gbbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C  
      DATA Denom(1  )/            9/                                       
      DATA (CF(i,1  ),i=1  ,6  ) /    64,   -8,   10,    1,    1,   -8/    
C               T[ 4, 5, 2, 3, 1]                                          
      DATA Denom(2  )/            9/                                       
      DATA (CF(i,2  ),i=1  ,6  ) /    -8,   64,    1,   10,   -8,    1/    
C               T[ 4, 5, 3, 2, 1]                                          
      DATA Denom(3  )/            9/                                       
      DATA (CF(i,3  ),i=1  ,6  ) /    10,    1,   64,   -8,   -8,    1/    
C               T[ 4, 5, 1, 3, 2]                                          
      DATA Denom(4  )/            9/                                       
      DATA (CF(i,4  ),i=1  ,6  ) /     1,   10,   -8,   64,    1,   -8/    
C               T[ 4, 5, 1, 2, 3]                                          
      DATA Denom(5  )/            9/                                       
      DATA (CF(i,5  ),i=1  ,6  ) /     1,   -8,   -8,    1,   64,   10/    
C               T[ 4, 5, 3, 1, 2]                                          
      DATA Denom(6  )/            9/                                       
      DATA (CF(i,6  ),i=1  ,6  ) /    -8,    1,    1,   -8,   10,   64/    
C               T[ 4, 5, 2, 1, 3]                                          
C ----------
C BEGIN CODE
C ----------
      ...
      CALL FVOXXX(W(1,4   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,8   ))     
      CALL FVIXXX(W(1,5   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,9   ),W(1,8   ),W(1,3   ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,5   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL IOVXXX(W(1,10  ),W(1,8   ),W(1,2   ),GG ,AMP(3   ))             
      CALL JVVXXX(W(1,6   ),W(1,1   ),G ,ZERO    ,ZERO    ,W(1,11  ))      
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,11  ),GG ,AMP(4   ))             
      CALL IOVXXX(W(1,5   ),W(1,8   ),W(1,6   ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,4   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL FVIXXX(W(1,5   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,13  ),W(1,12  ),W(1,3   ),GG ,AMP(6   ))             
      CALL JVVXXX(W(1,1   ),W(1,3   ),G ,ZERO    ,ZERO    ,W(1,14  ))      
      CALL FVOXXX(W(1,4   ),W(1,14  ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,5   ),W(1,15  ),W(1,2   ),GG ,AMP(7   ))             
      CALL IOVXXX(W(1,10  ),W(1,12  ),W(1,1   ),GG ,AMP(8   ))             
      CALL JVVXXX(W(1,14  ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,16  ))      
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,16  ),GG ,AMP(9   ))             
      CALL IOVXXX(W(1,5   ),W(1,12  ),W(1,14  ),GG ,AMP(10  ))             
      CALL FVOXXX(W(1,4   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,17  ))     
      CALL IOVXXX(W(1,13  ),W(1,17  ),W(1,2   ),GG ,AMP(11  ))             
      CALL IOVXXX(W(1,9   ),W(1,17  ),W(1,1   ),GG ,AMP(12  ))             
      CALL JVVXXX(W(1,1   ),W(1,2   ),G ,ZERO    ,ZERO    ,W(1,18  ))      
      CALL FVOXXX(W(1,4   ),W(1,18  ),GG ,BMASS   ,ZERO    ,W(1,19  ))     
      CALL IOVXXX(W(1,5   ),W(1,19  ),W(1,3   ),GG ,AMP(13  ))             
      CALL JVVXXX(W(1,18  ),W(1,3   ),G ,ZERO    ,ZERO    ,W(1,20  ))      
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,20  ),GG ,AMP(14  ))             
      CALL IOVXXX(W(1,5   ),W(1,17  ),W(1,18  ),GG ,AMP(15  ))             
      CALL JGGGXX(W(1,1   ),W(1,2   ),W(1,3   ),G ,W(1,21  ))              
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,21  ),GG ,AMP(16  ))             
      CALL JGGGXX(W(1,3   ),W(1,1   ),W(1,2   ),G ,W(1,22  ))              
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,22  ),GG ,AMP(17  ))             
      CALL JGGGXX(W(1,2   ),W(1,3   ),W(1,1   ),G ,W(1,23  ))              
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,23  ),GG ,AMP(18  ))             
      JAMP(   1) = +AMP(   1)+AMP(   4)-AMP(   6)-AMP(   9)+AMP(  10)
     &             -AMP(  17)+AMP(  18)
      JAMP(   2) = -AMP(   1)-AMP(   4)-AMP(  11)-AMP(  14)+AMP(  15)
     &             +AMP(  16)-AMP(  18)
      JAMP(   3) = -AMP(   2)+AMP(   4)-AMP(   5)-AMP(   7)-AMP(   9)
     &             -AMP(  17)+AMP(  18)
      JAMP(   4) = -AMP(   3)-AMP(   4)+AMP(   5)-AMP(  13)-AMP(  14)
     &             +AMP(  16)-AMP(  18)
     ...
     &             -AMP(  16)+AMP(  17)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gg_gbbx =gg_gbbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
