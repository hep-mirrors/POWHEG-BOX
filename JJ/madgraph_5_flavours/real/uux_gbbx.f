...
C  
C FOR PROCESS : u u~ -> g b b~  
C  
C Crossing   1 is u u~ -> g b b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_uux_gbbx/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION uux_gbbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,3   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
      ...
      CALL IOVXXX(W(1,5   ),W(1,11  ),W(1,3   ),GG ,AMP(3   ))             
      CALL JVVXXX(W(1,10  ),W(1,3   ),G ,ZERO    ,ZERO    ,W(1,12  ))      
      CALL IOVXXX(W(1,5   ),W(1,4   ),W(1,12  ),GG ,AMP(4   ))             
      CALL FVOXXX(W(1,4   ),W(1,3   ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,5   ),W(1,13  ),W(1,10  ),GG ,AMP(5   ))             
      JAMP(   1) = -AMP(   1)-AMP(   4)
      JAMP(   2) = -AMP(   2)+AMP(   4)
      JAMP(   3) = -AMP(   3)
      JAMP(   4) = -AMP(   5)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uux_gbbx =uux_gbbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
