...
C  
C FOR PROCESS : u~ b -> u~ g b  
C  
C Crossing   1 is u~ b -> u~ g b  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_uxb_uxgb/  amp2,       jamp2
...
C ----------
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION uxb_uxgb(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,3   ),W(1,6   ),W(1,7   ),GG ,AMP(1   ))             
      CALL JIOXXX(W(1,3   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,8   ))     
      CALL JVVXXX(W(1,4   ),W(1,8   ),G ,ZERO    ,ZERO    ,W(1,9   ))      
      CALL IOVXXX(W(1,2   ),W(1,5   ),W(1,9   ),GG ,AMP(2   ))             
      CALL FVIXXX(W(1,2   ),W(1,8   ),GG ,BMASS   ,ZERO    ,W(1,10  ))     
      CALL IOVXXX(W(1,10  ),W(1,5   ),W(1,4   ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,2   ),W(1,4   ),GG ,BMASS   ,ZERO    ,W(1,11  ))     
      CALL IOVXXX(W(1,11  ),W(1,5   ),W(1,8   ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,3   ),W(1,4   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,12  ),W(1,1   ),W(1,7   ),GG ,AMP(5   ))             
      JAMP(   1) = +AMP(   1)-AMP(   2)
      JAMP(   2) = +AMP(   2)+AMP(   5)
      JAMP(   3) = +AMP(   3)
      JAMP(   4) = +AMP(   4)
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxb_uxgb =uxb_uxgb+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
