...
c$$$         call fborn(s,t,2,matout)
      ...
      if(ME_check) then
         if(dabs(amp2_udx/matout(1,1)-1d0).gt.1d-6) then
            write(*,*) 'udx: exact/MCNLO----> ',amp2_udx,matout(2,2)
         endif
         if(dabs(amp2_dxu/matout(3,1)-1d0).gt.1d-6) then
            write(*,*) 'dxu: exact/MCNLO----> ',amp2_dxu,matout(4,2)
         endif
      endif
