...
c      call  bookupeqbins('dS/deta4',0.2d0,-4d0,4d0)
c      call  bookupeqbins('dS/dpt4a',0.5d0,25d0,50d0)
c      call  bookupeqbins('dS/dpt4b',5d0,0d0,150d0)
c      call  bookupeqbins('dS/dpt4c',20d0,0d0,600d0)
c      call  bookupeqbins('dS/deta34',0.4d0,-4d0,4d0)
      call  bookupeqbins('dS/deta35',0.4d0,-4d0,4d0)
c      call  bookupeqbins('dS/dy34',0.4d0,-4d0,4d0)
      call  bookupeqbins('dS/dy35',0.4d0,-4d0,4d0)
c      call  bookupeqbins('dS/dpt34',2d0,0d0,100d0)
      call  bookupeqbins('dS/dpt35',2d0,0d0,100d0)

      call  bookupeqbins('dS/dm34a',5d0,0d0,200d0)
      call  bookupeqbins('dS/dm35a',5d0,0d0,200d0)
      call  bookupeqbins('dS/dm34b',10d0,0d0,500d0)
      call  bookupeqbins('dS/dm35b',10d0,0d0,500d0)
...
c      call  bookupeqbins('dS/dpt345',5d0,0d0,200d0)
c      call  bookupeqbins('dS/deta345',0.2d0,-4d0,4d0)
c      call  bookupeqbins('dS/dy345',0.2d0,-4d0,4d0)
c      call  bookupeqbins('dS/dm345',2d0,108d0,308d0)
c      call  bookupeqbins('dS/deta6',0.2d0,-4d0,4d0)
c      call  bookupeqbins('dS/dpt6',10d0,0d0,500d0)
c      call  bookupeqbins('dS/deta56',0.2d0,-4d0,4d0)
c      call  bookupeqbins('dS/dpt56',10d0,10d0,150d0)
c      call  bookupeqbins('dS/dm56a',5d0,0d0,200d0)
c      call  bookupeqbins('dS/dm56b',50d0,0d0,2000d0)
c      call  bookupeqbins('dS/dr56',0.1d0,0d0,4d0)
c      call  bookupeqbins('dS/dphi56',0.314d0,0d0,3.14d0)
c      call  bookupeqbins('dS/deta5-eta6',0.2d0,-6d0,6d0)
      call  bookupeqbins('dS/deta46',0.2d0,-4d0,4d0)
      call  bookupeqbins('dS/dy46',0.4d0,-4d0,4d0)
      call  bookupeqbins('dS/dpt46',10d0,10d0,150d0)
      call  bookupeqbins('dS/dm56a',5d0,0d0,200d0)
      call  bookupeqbins('dS/dm46a',5d0,0d0,200d0)
      call  bookupeqbins('dS/dm56b',50d0,0d0,2000d0)
      call  bookupeqbins('dS/dm46b',50d0,0d0,2000d0)
      call  bookupeqbins('dS/dm3456a',5d0,0d0,200d0)
      call  bookupeqbins('dS/dm3456b',50d0,0d0,2000d0)
      call  bookupeqbins('dS/dr35',0.1d0,0d0,4d0)
      call  bookupeqbins('dS/dphi35',0.314d0,0d0,3.14d0)
      call  bookupeqbins('dS/deta3-eta5',0.2d0,-6d0,6d0)
...
c      call  bookupeqbins('dS/dr67',0.1d0,0d0,4d0)
c      call  bookupeqbins('dS/dm567',2d0,108d0,308d0)
      call  bookupeqbins('dS/dr37',0.1d0,0d0,4d0)
      call  bookupeqbins('dS/dm357',2d0,108d0,308d0)
...
c     we need to tell to this analysis file which program is running it
     ...
     1    phij(maxjet),pj(4,maxjet),rr
      ...
      real * 8 httot,y,eta,pt,mass,dy,deta,dphi,dr,eta5,eta3,eta7,etadif
...
!         vdecaytemp=lprup(1)-10000 ! Z decay product, with positive id
         vdecaytemp=11 ! W decay product, with positive id
...
c --- i4 is neutrino, so this is pointless ???
c         call getyetaptmass(phep(:,i4),y,eta,pt,mass)
c         call filld('dS/deta4',eta,dsig)
c         call filld('dS/dpt4a',pt,dsig)
c         call filld('dS/dpt4b',pt,dsig)
c         call filld('dS/dpt4c',pt,dsig)
         call getyetaptmass(phep(:,i3)+phep(:,i4),y,eta,pt,mass)
c         call filld('dS/deta34',eta,dsig)
c         call filld('dS/dy34',y,dsig)
c         call filld('dS/dpt34',pt,dsig)
...
c         call getyetaptmass(phep(:,i3)+phep(:,i4)+phep(:,i5),
c     1        y,eta,pt,mass)
c         call filld('dS/dpt345',pt,dsig)
c         call filld('dS/deta345',eta,dsig)
c         call filld('dS/dy345',y,dsig)
c         call filld('dS/dm345',mass,dsig)
c --- i6 also neutrino
c         call getyetaptmass(phep(:,i6),y,eta,pt,mass)
c         eta6 = eta 
c         call filld('dS/deta6',eta,dsig)
c         call filld('dS/dpt6',pt,dsig)
         call getyetaptmass(phep(:,i5)+phep(:,i6),y,eta,pt,mass)
c         call filld('dS/deta56',eta,dsig)
c         call filld('dS/dpt56',pt,dsig)
         call filld('dS/dm56a',mass,dsig)
         call filld('dS/dm56b',mass,dsig)
         call getyetaptmass(phep(:,i3)+phep(:,i4)+phep(:,i5)+phep(:,i6),
     &        y,eta,pt,mass)
         call filld('dS/dm3456a',mass,dsig)
         call filld('dS/dm3456b',mass,dsig)
c         call getdydetadphidr(phep(:,i5),phep(:,i6),dy,deta,dphi,dr)
c         call filld('dS/dr56',dr,dsig)
c         call filld('dS/dphi56',dphi,dsig)
c         call filld('dS/deta5-eta6',deta,dsig)

c -- so this should be m_ll, eta_ll, etc
         call getyetaptmass(phep(:,i3)+phep(:,i5),y,eta,pt,mass)
         call filld('dS/deta35',eta,dsig)
         call filld('dS/dy35',y,dsig)
         call filld('dS/dpt35',pt,dsig)
         call filld('dS/dm35a',mass,dsig)
         call filld('dS/dm35b',mass,dsig)
c --- differences in eta of leptons?
         call getdydetadphidr(phep(:,i3),phep(:,i5),dy,deta,dphi,dr)
         call filld('dS/dr35',dr,dsig)
         call filld('dS/dphi35',dphi,dsig)
         call filld('dS/deta3-eta5',deta,dsig)
c -- and this should be missing pt (neutrinos)
         call getyetaptmass(phep(:,i4)+phep(:,i6),y,eta,pt,mass)
         call filld('dS/deta46',eta,dsig)
         call filld('dS/dy46',y,dsig)
         call filld('dS/dpt46',pt,dsig)
         call filld('dS/dm46a',mass,dsig)
         call filld('dS/dm46b',mass,dsig)
...
c --- again, use i3 rather than i6
c           call getdydetadphidr(phep(:,i6),pj(1:4,1),dy,deta,dphi,dr)
c           call filld('dS/dr67',dr,dsig)
           call getdydetadphidr(phep(:,i3),pj(1:4,1),dy,deta,dphi,dr)
           call filld('dS/dr37',dr,dsig)
c           call getyetaptmass(phep(1:4,i5)+phep(1:4,i6)+pj(:,1),
c     .     y,eta,pt,mass)
c           call filld('dS/dm567',mass,dsig
           call getyetaptmass(phep(1:4,i3)+phep(1:4,i5)+pj(:,1),
     .     y,eta,pt,mass)
           call filld('dS/dm357',mass,dsig)

c           etadif = eta7-(eta6+eta5)/2d0 
c           call filld('dS/deta diff',etadif,dsig)

c           call getyetaptmass(phep(1:4,i3)+phep(1:4,i5)+pj(:,1),
c     .     y,eta,pt,mass)
c           call filld('dS/dm356',mass,dsig)
           etadif = eta7-(eta3+eta5)/2d0 
