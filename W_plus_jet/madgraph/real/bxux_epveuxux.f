      SUBROUTINE Sbxux_epveuxux(P1,ANS)
C  
...
C  
C FOR PROCESS : b~ u~ -> e+ ve u~ u~  
C  
C Crossing   1 is b~ u~ -> e+ ve u~ u~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_bxux_epveuxux/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=bxux_epveuxux(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION bxux_epveuxux(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,1   ),W(1,7   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     8   ))                                                          
     ...
     &     10  ))                                                          
      ...
      CALL FVOXXX(W(1,1   ),W(1,12  ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          bxux_epveuxux =bxux_epveuxux+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
