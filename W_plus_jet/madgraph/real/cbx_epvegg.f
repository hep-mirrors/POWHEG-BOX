...
C  
      ...
      common/to_amps_cbx_epvegg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=cbx_epvegg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION cbx_epvegg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     11  ))                                                          
      ...
      CALL FVOXXX(W(1,13  ),W(1,7   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,1   ),W(1,14  ),W(1,6   ),GG ,AMP(5   ))             
      CALL FVIXXX(W(1,1   ),W(1,7   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     15  ))                                                          
      CALL FVIXXX(W(1,15  ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          cbx_epvegg =cbx_epvegg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
