...
C  
      ...
      common/to_amps_cc_epvecs/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=cc_epvecs(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION cc_epvecs(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,9   ),W(1,6   ),W(1,7   ),GWFCS ,AMP(1   ))          
      CALL FVIXXX(W(1,2   ),W(1,7   ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     10  ))                                                          
      CALL IOVXXX(W(1,10  ),W(1,6   ),W(1,8   ),GG ,AMP(2   ))             
      CALL JIOXXX(W(1,2   ),W(1,5   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL FVIXXX(W(1,1   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,12  ),W(1,6   ),W(1,7   ),GWFCS ,AMP(3   ))          
      CALL FVIXXX(W(1,1   ),W(1,7   ),GWFCS ,ZERO    ,ZERO    ,W(1,        
     &     13  ))                                                          
      CALL IOVXXX(W(1,13  ),W(1,6   ),W(1,11  ),GG ,AMP(4   ))             
      JAMP(   1) = -AMP(   1)-AMP(   2)
      JAMP(   2) = +AMP(   3)+AMP(   4)
      cc_epvecs = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          cc_epvecs =cc_epvecs+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
