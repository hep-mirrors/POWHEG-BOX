      SUBROUTINE Sccx_epvecxb(P1,ANS)
C  
...
C  
      ...
      common/to_amps_ccx_epvecxb/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=ccx_epvecxb(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION ccx_epvecxb(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,1   ),W(1,8   ),GG ,ZERO    ,ZERO    ,W(1,9   ))     
      CALL IOVXXX(W(1,9   ),W(1,6   ),W(1,7   ),GWFCB ,AMP(1   ))          
     ...
     &     12  ))                                                          
      CALL IOVXXX(W(1,12  ),W(1,6   ),W(1,11  ),GG ,AMP(3   ))             
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          ccx_epvecxb =ccx_epvecxb+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
