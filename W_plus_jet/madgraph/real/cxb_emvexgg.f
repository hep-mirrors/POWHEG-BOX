      SUBROUTINE Scxb_emvexgg(P1,ANS)
C  
...
C  
C FOR PROCESS : c~ b -> e- ve~ g g  
C  
C Crossing   1 is c~ b -> e- ve~ g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_cxb_emvexgg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=cxb_emvexgg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION cxb_emvexgg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,7   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     8   ))                                                          
      ...
      CALL FVOXXX(W(1,10  ),W(1,7   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     11  ))                                                          
      ...
      CALL FVIXXX(W(1,13  ),W(1,7   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     14  ))                                                          
     ...
     &     15  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          cxb_emvexgg =cxb_emvexgg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
