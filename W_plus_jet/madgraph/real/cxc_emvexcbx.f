      SUBROUTINE Scxc_emvexcbx(P1,ANS)
C  
...
C  
C FOR PROCESS : c~ c -> e- ve~ c b~  
C  
C Crossing   1 is c~ c -> e- ve~ c b~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_cxc_emvexcbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=cxc_emvexcbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION cxc_emvexcbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL IOVXXX(W(1,6   ),W(1,9   ),W(1,7   ),GWFCB ,AMP(1   ))          
      CALL FVOXXX(W(1,1   ),W(1,7   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     10  ))                                                          
     ...
     &     12  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          cxc_emvexcbx =cxc_emvexcbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
