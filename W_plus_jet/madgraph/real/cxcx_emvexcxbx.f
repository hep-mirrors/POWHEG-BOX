      SUBROUTINE Scxcx_emvexcxbx(P1,ANS)
C  
...
C  
      ...
      common/to_amps_cxcx_emvexcxbx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=cxcx_emvexcxbx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION cxcx_emvexcxbx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,7   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     10  ))                                                          
      CALL IOVXXX(W(1,6   ),W(1,10  ),W(1,8   ),GG ,AMP(2   ))             
      CALL JIOXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL FVOXXX(W(1,1   ),W(1,11  ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,6   ),W(1,12  ),W(1,7   ),GWFCB ,AMP(3   ))          
     ...
     &     13  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          cxcx_emvexcxbx =cxcx_emvexcxbx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
