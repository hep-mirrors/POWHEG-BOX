      SUBROUTINE Scxg_emvexbxg(P1,ANS)
C  
...
C  
C FOR PROCESS : c~ g -> e- ve~ b~ g  
C  
C Crossing   1 is c~ g -> e- ve~ b~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_cxg_emvexbxg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=cxg_emvexbxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION cxg_emvexbxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,5   ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,8   ))     
      CALL FVIXXX(W(1,8   ),W(1,7   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     9   ))                                                          
     ...
     &     10  ))                                                          
      ...
      CALL FVOXXX(W(1,10  ),W(1,2   ),GG ,BMASS   ,ZERO    ,W(1,12  ))     
      CALL IOVXXX(W(1,5   ),W(1,12  ),W(1,6   ),GG ,AMP(3   ))             
      CALL IOVXXX(W(1,8   ),W(1,10  ),W(1,6   ),GG ,AMP(4   ))             
      CALL FVIXXX(W(1,5   ),W(1,7   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     13  ))                                                          
      ...
      CALL FVOXXX(W(1,16  ),W(1,7   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     17  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          cxg_emvexbxg =cxg_emvexbxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
