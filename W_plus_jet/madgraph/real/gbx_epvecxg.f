      SUBROUTINE Sgbx_epvecxg(P1,ANS)
C  
...
C  
C FOR PROCESS : g b~ -> e+ ve c~ g  
C  
C Crossing   1 is g b~ -> e+ ve c~ g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_gbx_epvecxg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gbx_epvecxg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gbx_epvecxg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL FVIXXX(W(1,10  ),W(1,7   ),GWFCB ,BMASS   ,ZERO    ,W(1,        
     &     11  ))                                                          
     ...
     &     13  ))                                                          
      ...
      CALL FVIXXX(W(1,13  ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,15  ))     
      CALL IOVXXX(W(1,15  ),W(1,2   ),W(1,6   ),GG ,AMP(6   ))             
      CALL FVOXXX(W(1,2   ),W(1,1   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      CALL FVOXXX(W(1,16  ),W(1,7   ),GWFCB ,ZERO    ,ZERO    ,W(1,        
     &     17  ))                                                          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gbx_epvecxg =gbx_epvecxg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
