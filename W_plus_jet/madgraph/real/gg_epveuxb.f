...
C  
      ...
      common/to_amps_gg_epveuxb/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=gg_epveuxb(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION gg_epveuxb(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,8   ),W(1,7   ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     9   ))                                                          
      CALL IOVXXX(W(1,9   ),W(1,6   ),W(1,2   ),GG ,AMP(1   ))             
      CALL FVIXXX(W(1,8   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,10  ))     
      CALL IOVXXX(W(1,10  ),W(1,6   ),W(1,7   ),GWFUB ,AMP(2   ))          
      CALL FVIXXX(W(1,5   ),W(1,2   ),GG ,ZERO    ,ZERO    ,W(1,11  ))     
      CALL FVIXXX(W(1,11  ),W(1,7   ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     12  ))                                                          
      CALL IOVXXX(W(1,12  ),W(1,6   ),W(1,1   ),GG ,AMP(3   ))             
      CALL FVIXXX(W(1,11  ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,13  ),W(1,6   ),W(1,7   ),GWFUB ,AMP(4   ))          
      CALL FVIXXX(W(1,5   ),W(1,7   ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     14  ))                                                          
      ...
      CALL IOVXXX(W(1,18  ),W(1,6   ),W(1,7   ),GWFUB ,AMP(8   ))          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          gg_epveuxb =gg_epveuxb+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
