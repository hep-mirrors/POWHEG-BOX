      SUBROUTINE Ssxux_emvexsxsx(P1,ANS)
C  
...
C  
C FOR PROCESS : s~ u~ -> e- ve~ s~ s~  
C  
C Crossing   1 is s~ u~ -> e- ve~ s~ s~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_sxux_emvexsxsx/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=sxux_emvexsxsx(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION sxux_emvexsxsx(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
     ...
     &     8   ))                                                          
      ...
      CALL FVIXXX(W(1,5   ),W(1,7   ),GWFUS ,ZERO    ,ZERO    ,W(1,        
     &     10  ))                                                          
      ...
      CALL IOVXXX(W(1,6   ),W(1,13  ),W(1,7   ),GWFUS ,AMP(3   ))          
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          sxux_emvexsxsx =sxux_emvexsxsx+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
