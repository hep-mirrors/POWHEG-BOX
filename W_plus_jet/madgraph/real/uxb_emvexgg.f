      SUBROUTINE Suxb_emvexgg(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ b -> e- ve~ g g  
C  
C Crossing   1 is u~ b -> e- ve~ g g  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_uxb_emvexgg/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uxb_emvexgg(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION uxb_emvexgg(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVIXXX(W(1,2   ),W(1,7   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     8   ))                                                          
      ...
      CALL FVOXXX(W(1,10  ),W(1,7   ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     11  ))                                                          
      ...
      CALL FVIXXX(W(1,2   ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      CALL FVIXXX(W(1,13  ),W(1,7   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     14  ))                                                          
      CALL IOVXXX(W(1,14  ),W(1,1   ),W(1,6   ),GG ,AMP(5   ))             
      CALL FVOXXX(W(1,1   ),W(1,7   ),GWFUB ,BMASS   ,ZERO    ,W(1,        
     &     15  ))                                                          
      CALL FVOXXX(W(1,15  ),W(1,5   ),GG ,BMASS   ,ZERO    ,W(1,16  ))     
      ...
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxb_emvexgg =uxb_emvexgg+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
