      SUBROUTINE Suxbx_epveuxux(P1,ANS)
C  
...
C  
C FOR PROCESS : u~ b~ -> e+ ve u~ u~  
C  
C Crossing   1 is u~ b~ -> e+ ve u~ u~  
      IMPLICIT NONE
C  
C CONSTANTS
C  
...
C  
      ...
      common/to_amps_uxbx_epveuxux/  amp2,       jamp2
...
C ----------
      ...
      IF (ISUM_HEL .EQ. 0 .OR. NTRY .LT. 10) THEN
          DO IHEL=1,NCOMB
             IF (GOODHEL(IHEL,IPROC) .OR. NTRY .LT. 2) THEN
                 T=uxbx_epveuxux(P ,NHEL(1,IHEL),JC(1))            
               DO JJ=1,nincoming
     ...
     &             NHEL(JJ,IHEL).EQ.INT(SIGN(1d0,POL(JJ)))) THEN
      ...
      REAL*8 FUNCTION uxbx_epveuxux(P,NHEL,IC)
C  
C Generated by MadGraph II                                              
C RETURNS AMPLITUDE SQUARED SUMMED/AVG OVER COLORS
...
C ----------
      ...
      CALL FVOXXX(W(1,2   ),W(1,7   ),GWFUB ,ZERO    ,ZERO    ,W(1,        
     &     8   ))                                                          
     ...
     &     10  ))                                                          
      ...
      CALL JIOXXX(W(1,5   ),W(1,1   ),GG ,ZERO    ,ZERO    ,W(1,12  ))     
      CALL FVOXXX(W(1,2   ),W(1,12  ),GG ,BMASS   ,ZERO    ,W(1,13  ))     
      CALL IOVXXX(W(1,6   ),W(1,13  ),W(1,7   ),GWFUB ,AMP(3   ))          
      CALL IOVXXX(W(1,6   ),W(1,8   ),W(1,12  ),GG ,AMP(4   ))             
      JAMP(   1) = +AMP(   1)+AMP(   2)
      JAMP(   2) = -AMP(   3)-AMP(   4)
      uxbx_epveuxux = 0.D0 
      DO I = 1, NCOLOR
          ...
          ENDDO
          uxbx_epveuxux =uxbx_epveuxux+ZTEMP*DCONJG(JAMP(I))/DENOM(I)   
      ENDDO
      Do I = 1, NGRAPHS
