...
c  pwhgfill  :  fills the histograms with data
     ...
     #0.4d0,-10d0,10d0)
      ...
      call pwhgbookup(32,'pt e- ptZ>'//cut,'LOG',20d0,0d0,800d0)
      call pwhgbookup(33,'pt e+ ptZ>'//cut,'LOG',20d0,0d0,800d0)
      call pwhgbookup(34,'y e-, pt e->10 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)
      call pwhgbookup(35,'y e-, pt e->20 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)
      call pwhgbookup(36,'y e-, pt e->40 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)
      call pwhgbookup(37,'y e-, pt e->60 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)
      call pwhgbookup(38,'y e-, pt e->80 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)
      call pwhgbookup(39,'y e-, pt e->100 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)
      call pwhgbookup(40,'y e+, pt e+>10 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)
      call pwhgbookup(41,'y e+, pt e+>20 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)
      call pwhgbookup(42,'y e+, pt e+>40 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)
      call pwhgbookup(43,'y e+, pt e+>60 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)
      call pwhgbookup(44,'y e+, pt e+>80 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)
      call pwhgbookup(45,'y e+, pt e+>100 ptZ>'//cut,'LOG',
     1     0.4d0,-5d0,5d0)     

      call pwhgbookup(46,'y e-,ptZ>'//cut,'LOG',0.4d0,-5d0,5d0)
      call pwhgbookup(47,'y e+,ptZ>'//cut,'LOG',0.4d0,-5d0,5d0)
      call pwhgbookup(48,'pt e-, zoom ptZ>'//cut,'LOG',4d0,0d0,100d0)
      call pwhgbookup(49,'pt e+, zoom ptZ>'//cut,'LOG',4d0,0d0,100d0)
